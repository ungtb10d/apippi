...
[`SASIIndex`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/SASIIndex.java),
or "SASI" for short, is an implementation of apippi's
...
existing implementations by tailoring it specifically to apippi's
...
```
cqlsh:demo> CREATE CUSTOM INDEX ON sasi (first_name) USING 'org.apache.apippi.index.sasi.SASIIndex'
        ... WITH OPTIONS = {
        ... 'analyzer_class':
        ...   'org.apache.apippi.index.sasi.analyzer.NonTokenizingAnalyzer',
        ... 'case_sensitive': 'false'
        ... };

cqlsh:demo> CREATE CUSTOM INDEX ON sasi (last_name) USING 'org.apache.apippi.index.sasi.SASIIndex'
        ... WITH OPTIONS = {'mode': 'CONTAINS'};

cqlsh:demo> CREATE CUSTOM INDEX ON sasi (age) USING 'org.apache.apippi.index.sasi.SASIIndex';

cqlsh:demo> CREATE CUSTOM INDEX ON sasi (created_at) USING 'org.apache.apippi.index.sasi.SASIIndex'
...
SASI performing index flushes to disk can be seen in apippi's logs
...
cqlsh:demo> CREATE CUSTOM INDEX on sasi (aliases) USING 'org.apache.apippi.index.sasi.SASIIndex'
        ... WITH OPTIONS = {
        ... 'analyzer_class': 'org.apache.apippi.index.sasi.analyzer.DelimiterAnalyzer',
        ... 'delimiter': ',',
        ... 'mode': 'prefix',
        ... 'analyzed': 'true'};
...
cqlsh:demo> CREATE CUSTOM INDEX ON sasi (bio) USING 'org.apache.apippi.index.sasi.SASIIndex'
        ... WITH OPTIONS = {
        ... 'analyzer_class': 'org.apache.apippi.index.sasi.analyzer.StandardAnalyzer',
...
[`StandardAnalyzer`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/analyzer/StandardAnalyzer.java)
and `analyzed` is set to `true`. The
`tokenization_normalize_lowercase` is similar to the `case_sensitive`
property but for the
[`StandardAnalyzer`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/analyzer/StandardAnalyzer.java). These
query demonstrates the stemming applied by [`StandardAnalyzer`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/analyzer/StandardAnalyzer.java).
...
here. Additionally, the changes internal to apippi to support SASI's
integration are described.

The `Index` interface divides responsibility of the
implementer into two parts: Indexing and Querying. Further, apippi
makes it possible to divide those responsibilities into the memory and
disk components. SASI takes advantage of apippi's write-once,
...
Taking advantage of apippi's ordered data model, at query time,
...
[`OnDiskIndexBuilder`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/OnDiskIndexBuilder.java). Once
flushed to disk, the data is read using the
[`OnDiskIndex`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/OnDiskIndex.java)
...
[`TokenTreeBuilder`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTreeBuilder.java)s
for writing, and
[`TokenTree`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTree.java)s
...
uses its
[`IndexMemtable`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/memory/IndexMemtable.java)
class.
...
point to the data itself, contained in [`TokenTree`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTree.java)s.
...
blocks of terms a
[`TokenTree`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTree.java)
...
[`TokenTreeBuilder`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTreeBuilder.java)
...
[`TokenTree`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTree.java)s provide the means to iterate over tokens, and file
...
[`TrieMemIndex`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/memory/TrieMemIndex.java)
or a
[`SkipListMemIndex`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/memory/SkipListMemIndex.java)
...
[`SkipListMemIndex`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/memory/SkipListMemIndex.java),
conversely, is better suited for other apippi data types like
numbers.
...
[`Operation`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java)
and
[`Expression`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Expression.java)
trees, optimizing the trees to reduce the amount of work done, and
driving the query itself, the
[`QueryPlan`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryPlan.java)
...
iterators similar to apippi's `MergeIterator`, but tailored
specifically for SASI's use while including more features. The
[`RangeUnionIterator`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeUnionIterator.java),
...
[`RangeIntersectionIterator`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeIntersectionIterator.java),
...
[`QueryPlan`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryPlan.java)
converts from apippi's internal representation of
...
parentheses (see the
[apippi Internal Changes](#apippi-internal-changes)
section below for more details). This process produces a tree of
[`Operation`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java)s, which in turn may contain [`Expression`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Expression.java)s, all of which
...
[`Operation`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java) tree. These keys are read from disk and a final check to
ensure they satisfy the query is made, once again using the
[`Operation`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java) tree. At the point the desired amount of matching data has
...
`apippi.search_concurrency_factor` system property. The default is
`1`.
...
[`QueryPlan`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryPlan.java)
references a
[`QueryController`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryController.java)
...
[`QueryController`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryController.java)'s
...
joined by logical intersections (`AND`) into a single [`Operation`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java) with
three or more [`Expression`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Expression.java)s. For example, the query `WHERE age < 100 AND
...
and has leaves `fname != pa*` and `age > 21`. These [`Expression`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Expression.java)s will
...
[`Operation`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java)s
as interior nodes, and
[`Expression`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Expression.java)s
as leaves. The
[`Operation`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java)
...
the documentation
[in the code](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java#L87-L123).
...
[javadoc](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeUnionIterator.java#L9-L21).
...
later). See the
[javadoc](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeIntersectionIterator.java#L88-L101)
...
[javadoc](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeIntersectionIterator.java#L199-L208).
...
via the
[`sasi.conf.DataTracker`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/conf/DataTracker.java)
and
[`sasi.conf.view.View`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/conf/view/View.java)
components, controls writing of all indexes for an SSTable via its
[`PerSSTableIndexWriter`](https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/PerSSTableIndexWriter.java), and initiates searches with
`Searcher`. These classes glue the previously
mentioned indexing components together with apippi's SSTable
...
### apippi Internal Changes

To support the above changes and integrate them into apippi a few
minor internal changes were made to apippi itself. These are
described here.
...
* Not Equals and OR support have been removed in this release while
  changes are made to apippi itself to support them.
