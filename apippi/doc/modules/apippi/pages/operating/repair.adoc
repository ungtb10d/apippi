...
apippi is designed to remain available if one of it's nodes is down
...
disk corruption, data loss by operator error, or bugs in apippi. For
...
automatically by apippi. It is run by the operator via nodetool.
...
(https://issues.apache.org/jira/browse/apippi-13079[apippi-13079]):
