...
Metrics in apippi are managed using the
...
All metrics reported by apippi fit into one of the following types.
...
Each table in apippi has metrics responsible for tracking its state
and performance.
...
*Metric Name*::
  `org.apache.apippi.metrics.Table.<MetricName>.<Keyspace>.<Table>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Table keyspace=<Keyspace> scope=<Table> name=<MetricName>`
...
Each keyspace in apippi has metrics responsible for tracking its
...
*Metric Name*::
  `org.apache.apippi.metrics.keyspace.<MetricName>.<Keyspace>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Keyspace scope=<Keyspace> name=<MetricName>`
...
apippi splits work of a particular type into its own thread pool.
...
*Metric Name*::
  `org.apache.apippi.metrics.ThreadPools.<MetricName>.<Path>.<ThreadPoolName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=ThreadPools path=<Path> scope=<ThreadPoolName> name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.ClientRequest.<MetricName>.<RequestType>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=ClientRequest scope=<RequestType> name=<MetricName>`
...
apippi caches have metrics to track the effectivness of the caches.
Though the `Table Metrics` might be more useful.

Reported name format:

*Metric Name*::
  `org.apache.apippi.metrics.Cache.<MetricName>.<CacheName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Cache scope=<CacheName> name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.CQL.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=CQL name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.DroppedMessage.<MetricName>.<Type>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=DroppedMessage scope=<Type> name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.Streaming.<MetricName>.<PeerIP>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Streaming scope=<PeerIP> name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.Compaction.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Compaction name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.CommitLog.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=CommitLog name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.Storage.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Storage name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.HintedHandOffManager.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=HintedHandOffManager name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.HintsService.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=HintsService name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.Index.<MetricName>.RowIndexEntry`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Index scope=RowIndexEntry name=<MetricName>`
...
Metrics specific to the internal recycled buffer pool apippi manages.
...
*Metric Name*::
  `org.apache.apippi.metrics.BufferPool.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=BufferPool name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.Client.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Client name=<MetricName>`
...
*Metric Name*::
  `org.apache.apippi.metrics.Batch.<MetricName>`
*JMX MBean*::
  `org.apache.apippi.metrics:type=Batch name=<MetricName>`
...
Any JMX based client can access metrics from apippi.
...
address (0.0.0.0 is not the default) edit `conf/apippi-env.sh` and
uncomment:
...
As mentioned at the top of this section on monitoring the apippi
...
Once configured, you simply start apippi with the flag
