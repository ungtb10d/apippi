...
apippi cannot guarantee that large amounts of data won't have to scanned amount of data, even if the result is small. 
...
apippi's conflict resolution procedure in the case of
