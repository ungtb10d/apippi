...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/SASIIndex.java[`SASIIndex`],
or ``SASI`` for short, is an implementation of apippi's `Index`
...
implementations by tailoring it specifically to apippi’s needs. SASI
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/analyzer/StandardAnalyzer.java[`StandardAnalyzer`]
...
internal to apippi to support SASI’s integration are described.

The `Index` interface divides responsibility of the implementer into two
parts: Indexing and Querying. Further, apippi makes it possible to
divide those responsibilities into the memory and disk components. SASI
takes advantage of apippi’s write-once, immutable, ordered data model
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/OnDiskIndexBuilder.java[`OnDiskIndexBuilder`].
Once flushed to disk, the data is read using the
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/OnDiskIndex.java[`OnDiskIndex`]
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTreeBuilder.java[`TokenTreeBuilder`]s
for writing, and
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTree.java[`TokenTree`]s
...
its
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/memory/IndexMemtable.java[`IndexMemtable`]
class.
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTree.java[`TokenTree`]
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/TokenTreeBuilder.java[`TokenTreeBuilder`]
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/memory/TrieMemIndex.java[`TrieMemIndex`]
or a
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/memory/SkipListMemIndex.java[`SkipListMemIndex`]
...
into SASI’s
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java[`Operation`]
and
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Expression.java[`Expression`]
trees, optimizing the trees to reduce the amount of work done, and
driving the query itself, the
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryPlan.java[`QueryPlan`]
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeUnionIterator.java[`RangeUnionIterator`],
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeIntersectionIterator.java[`RangeIntersectionIterator`],
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryPlan.java[`QueryPlan`]
converts from apippi’s internal representation of `IndexExpression`s,
...
link:#apippi-internal-changes[apippi Internal Changes] section
below for more details). This process produces a tree of
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java[`Operation`]s,
which in turn may contain
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Expression.java[`Expression`]s,
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryPlan.java[`QueryPlan`]
references a
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryController.java[`QueryController`]
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/QueryController.java[`QueryController`]’s
...
documentation
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/plan/Operation.java#L87-L123[in
the code].
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeUnionIterator.java#L9-L21[javadoc].
...
later). See the
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeIntersectionIterator.java#L88-L101[javadoc]
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/utils/RangeIntersectionIterator.java#L199-L208[javadoc].
...
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/conf/DataTracker.java[`sasi.conf.DataTracker`]
and
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/conf/view/View.java[`sasi.conf.view.View`]
components, controls writing of all indexes for an SSTable via its
https://github.com/blcksec/apippi/blob/trunk/src/java/org/blcksec/apippi/index/sasi/disk/PerSSTableIndexWriter.java[`PerSSTableIndexWriter`],
and initiates searches with `Searcher`. These classes glue the
previously mentioned indexing components together with apippi’s
