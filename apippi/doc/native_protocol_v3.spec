    ...
    - <flags> is a [byte] whose bits define the options for this query and
      ...
      flags are, given there mask:
        ...
        0x40: With names for values. If set, then all values for all <query_i> must be
              ...
              protocol. See https://issues.apache.org/jira/browse/apippi-10246 for
              more details].
...
4.1.8. REGISTER
  ...
  apippi node and/or connections to multiple nodes, it is advised to
...
6. Data Type Serialization Formats
  ...
  supported by apippi through the native protocol.  These serialization
  formats should be used by client drivers to encode values for EXECUTE
  messages.  apippi will use these formats when returning values in
  RESULT messages.
...
9. Error codes
  ...
  The supported error codes are described below:
    ...
    0x000A    Protocol error: some client message triggered a protocol
              ...
              one has been sent)
    0x0100    Bad credentials: CREDENTIALS request failed because apippi
