...
"""
A script to convert apippi.yaml into Asciidoc for
the online documentation.

Usage:

YAML_INPUT=conf/apippi.yaml
YAML_OUTPUT=modules/apippi/pages/configuration/cass_yaml_file.adoc
...
def convert(yaml_file, dest_file):
    ...
    with open(dest_file, 'w') as outfile:
        outfile.write("= apippi.yaml file configuration\n")
