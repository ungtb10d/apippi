...
# Apache apippi rpmbuild

### Requirements:
- The build system needs to have Apache apippi `ant artifacts` build dependencies installed.
- Since Apache apippi depends on Python 2.7, the earliest version supported is RHEL/CentOS 7.0.
