...
import static org.apache.apippi.security.KubernetesSecretsSslContextFactory.ConfigKeys.KEYSTORE_PASSWORD_ENV_VAR;
import static org.apache.apippi.security.KubernetesSecretsSslContextFactory.ConfigKeys.KEYSTORE_UPDATED_TIMESTAMP_PATH;
import static org.apache.apippi.security.KubernetesSecretsSslContextFactory.ConfigKeys.TRUSTSTORE_PASSWORD_ENV_VAR;
...
public class KubernetesSecretsSslContextFactoryTest
{
    ...
    private final static String truststoreUpdatedTimestampFilepath = "build/test/conf/apippi_truststore_last_updatedtime";
    private final static String keystoreUpdatedTimestampFilepath = "build/test/conf/apippi_keystore_last_updatedtime";
    ...
    public void setup()
    {
        commonConfig.put(TRUSTSTORE_PATH, "build/test/conf/apippi_ssl_test.truststore");
         ...
         */
        commonConfig.put("MY_TRUSTSTORE_PASSWORD", "apippi");
    ...
    {
        config.put(KEYSTORE_PATH, "build/test/conf/apippi_ssl_test.keystore");
         ...
         *  done to avoid having a dependency on env in the unit test.
         */
        config.put("MY_KEYSTORE_PASSWORD", "apippi");
    }
    ...
    public void buildTrustManagerFactoryWithEmptyPassword() throws IOException
    {
        Map<String, Object> config = new HashMap<>();
        config.putAll(commonConfig);
        config.put(TRUSTSTORE_PATH, "build/test/conf/apippi_ssl_test.truststore-without-password");
        config.remove(TRUSTSTORE_PASSWORD_ENV_VAR);
