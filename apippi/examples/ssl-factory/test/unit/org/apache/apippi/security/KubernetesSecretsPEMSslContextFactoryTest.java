...
import static org.apache.apippi.security.KubernetesSecretsPEMSslContextFactory.DEFAULT_PRIVATE_KEY_ENV_VAR_NAME;
import static org.apache.apippi.security.KubernetesSecretsPEMSslContextFactory.DEFAULT_PRIVATE_KEY_PASSWORD_ENV_VAR_NAME;
import static org.apache.apippi.security.KubernetesSecretsPEMSslContextFactory.PEMConfigKey.PRIVATE_KEY_PASSWORD_ENV_VAR;
import static org.apache.apippi.security.KubernetesSecretsPEMSslContextFactory.PEMConfigKey.TRUSTED_CERTIFICATE_ENV_VAR;
import static org.apache.apippi.security.KubernetesSecretsSslContextFactory.ConfigKeys.KEYSTORE_UPDATED_TIMESTAMP_PATH;
import static org.apache.apippi.security.KubernetesSecretsSslContextFactory.ConfigKeys.TRUSTSTORE_UPDATED_TIMESTAMP_PATH;
...
public class KubernetesSecretsPEMSslContextFactoryTest
{
    ...
    private static final String ENCRYPTED_PRIVATE_KEY_FILEPATH = "build/test/conf/apippi_encrypted_private_key.pem";
    private static final String ENCRYPTED_PRIVATE_KEY_WITH_MULTIPLE_CERTS_IN_CERTCHAIN_FILEPATH = "build/test/conf" +
                                                                                                  "/apippi_encrypted_private_key_multiplecerts.pem";
    private static final String UNENCRYPTED_PRIVATE_KEY_FILEPATH = "build/test/conf/apippi_unencrypted_private_key.pem";
    private static final String TRUSTED_CERTIFICATES_FILEPATH = "build/test/conf/apippi_trusted_certificates.pem";
    private final static String TRUSTSTORE_UPDATED_TIMESTAMP_FILEPATH = "build/test/conf/apippi_truststore_last_updatedtime";
    private final static String KEYSTORE_UPDATED_TIMESTAMP_FILEPATH = "build/test/conf/apippi_keystore_last_updatedtime";
    ...
    private void addKeystoreOptions(Map<String, Object> config)
    {
         ...
         *  done to avoid having a dependency on env in the unit test.
         */
        config.put("MY_KEY_PASSWORD", "apippi");
    }
