...
public enum ApplicationState
{
     ...
     * run.
     *
     * <p>The value (a set of sstable {@link org.apache.apippi.io.sstable.format.VersionAndType}) is serialized as
     * a comma-separated list.
     **/
    SSTABLE_VERSIONS,
    DISK_USAGE,
    // DO NOT EDIT OR REMOVE PADDING STATES BELOW - only add new states above.  See apippi-16484
    X1,
    X2,
    X3,
    X4,
