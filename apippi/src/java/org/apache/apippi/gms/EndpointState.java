...
import org.apache.apippi.utils.NullableSerializer;
...
public class EndpointState
{
    ...
    static volatile boolean LOOSE_DEF_OF_EMPTY_ENABLED = apippiRelevantProperties.LOOSE_DEF_OF_EMPTY_ENABLED.getBoolean();
    ...
    public boolean isEmptyWithoutStatus()
    {
        ...
        return hbState.isEmpty() && !hasStatus
               ...
               // For these cases allow an external actor to verify and inform apippi that it is safe - this is done by
