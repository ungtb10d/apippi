...
import static org.apache.apippi.config.DatabaseDescriptor.newFailureDetector;
...
public class FailureDetector implements IFailureDetector, FailureDetectorMBean
{
    ...
    public static final String MBEAN_NAME = "org.apache.apippi.net:type=FailureDetector";
    ...
    {
        if (System.getProperty("apippi.max_local_pause_in_ms") != null)
        {
            long pause = Long.parseLong(System.getProperty("apippi.max_local_pause_in_ms"));
    ...
    {
        String newvalue = System.getProperty("apippi.fd_initial_value_ms");
        if (newvalue == null)
        {
    ...
    public boolean isAlive(InetAddressAndPort ep)
    {
        ...
        // badness.  (See apippi-1463 for an example).
        if (epState == null)
...
class ArrivalWindow
{
    ...
    {
        String newvalue = System.getProperty("apippi.fd_max_interval_ms");
        if (newvalue == null)
        {
    ...
    // see apippi-2597 for an explanation of the math at work here.
