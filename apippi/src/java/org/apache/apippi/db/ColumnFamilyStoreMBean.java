...
public interface ColumnFamilyStoreMBean
{
     ...
     */
    @BreaksJMX("This API was released in 3.10 using a parameter that takes Range of Token, which can only be done IFF client has apippi binaries in the classpath")
    @Deprecated
