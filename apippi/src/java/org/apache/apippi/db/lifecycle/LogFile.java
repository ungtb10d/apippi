...
import org.apache.apippi.db.lifecycle.LogRecord.Type;
...
final class LogFile implements AutoCloseable
{
    ...
    private final Set<LogRecord> records = Collections.synchronizedSet(new LinkedHashSet<>()); // TODO: Hack until we fix apippi-14554
    ...
    Throwable removeUnfinishedLeftovers(Throwable accumulate)
    {
        try
        {
            ...
            // deleteRecordFiles(), see apippi-12261
