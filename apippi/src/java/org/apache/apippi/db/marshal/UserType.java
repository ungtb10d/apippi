...
import static org.apache.apippi.cql3.ColumnIdentifier.maybeQuote;
...
public class UserType extends TupleType implements SchemaElement
{
    ...
    private enum ConflictBehavior
    {
        ...
        private static final String UDT_CONFLICT_BEHAVIOR = "apippi.type.udt.conflict_behavior";
