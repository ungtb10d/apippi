...
import org.apache.apippi.cql3.AssignmentTestable;
...
import static org.apache.apippi.db.marshal.AbstractType.ComparisonType.CUSTOM;
...
public abstract class AbstractType<T> implements Comparator<ByteBuffer>, AssignmentTestable
{
    ...
    public enum ComparisonType
    {
         ...
         * Support for this may be removed in a major release of apippi, however upgrade facilities will be
     ...
     * explicitly frozen.
     *
     * This is only necessary for {@code 2.x -> 3.x} schema migrations, and can be removed in apippi 4.0.
     *
     * See apippi-11609 and apippi-11613.
     */
        ...
        else
        {
            ...
            if (l > maxValueSize)
                throw new IOException(String.format("Corrupt value length %d encountered, as it exceeds the maximum of %d, " +
                                                    "which is set via max_value_size in apippi.yaml",
                                                    l, maxValueSize));
