...
public class InMemoryTrie<T> extends InMemoryReadTrie<T>
{
    ...
    static
    {
        ...
        int limitInMB = apippiRelevantProperties.MEMTABLE_OVERHEAD_SIZE.getInt(2048 * 10 / 11);
        if (limitInMB < 1 || limitInMB > 2047)
            throw new AssertionError(apippiRelevantProperties.MEMTABLE_OVERHEAD_SIZE.getKey() +
