...
import org.apache.apippi.db.filter.RowIndexEntryReadSizeTooLargeException;
import org.apache.apippi.io.ISerializer;
import org.apache.apippi.io.sstable.IndexInfo;
...
import org.apache.apippi.io.util.FileDataInput;
import org.apache.apippi.io.util.FileHandle;
import org.apache.apippi.io.util.RandomAccessReader;
import org.apache.apippi.io.util.TrackedDataInputPlus;
import org.apache.apippi.metrics.DefaultNameFactory;
import org.apache.apippi.metrics.MetricNameFactory;
import org.apache.apippi.net.ParamType;
...
import org.apache.apippi.utils.vint.VIntCoding;
import org.github.jamm.Unmetered;

import static org.apache.apippi.metrics.apippiMetricsRegistry.Metrics;
 ...
 *     by {@link org.apache.apippi.config.Config#column_index_size}.
 * </p>
 * <p>
 ...
 *     objects). These are those sstables created on apippi versions
 *     earlier than 3.0.
 * </p>
 * <p>
 ...
 *     will "pollute" the heap and cause huge GC pressure, apippi 3.6
 *     (apippi-11206) distinguishes between index entries with an
 ...
 *     {@link org.apache.apippi.config.Config#column_index_cache_size}.
 ...
 *     {@link org.apache.apippi.config.Config#column_index_cache_size}.</li>
 *     <li>{@link ShallowIndexedEntry} is for index entries with index samples
 *     that exceed {@link org.apache.apippi.config.Config#column_index_cache_size}
 ...
 * </p>
 * <p>
 *     Until now (apippi 3.x), we still support reading from <i>legacy</i> sstables -
 *     i.e. sstables created by apippi &lt; 3.0 (see {@link org.apache.apippi.io.sstable.format.big.BigFormat}.
 * </p>
 *
 */
public class RowIndexEntry<T> implements IMeasurableMemory
{
    ...
    /**
     * @param dataFilePosition  position of the partition in the {@link org.apache.apippi.io.sstable.Component.Type#DATA} file
     * @param indexFilePosition position in the {@link org.apache.apippi.io.sstable.Component.Type#PRIMARY_INDEX} of the {@link RowIndexEntry}
     ...
     * @param indexSamples      list with IndexInfo offsets (if total serialized size is less than {@link org.apache.apippi.config.Config#column_index_cache_size}
    ...
    private static final class IndexedEntry extends RowIndexEntry<IndexInfo>
    {
        ...
        /**
         * Constructor called from {@link Serializer#deserializeForCache(org.apache.apippi.io.util.DataInputPlus)}.
         */
