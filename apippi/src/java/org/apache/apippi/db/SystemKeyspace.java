...
import org.apache.apippi.cql3.UntypedResultSet;
import org.apache.apippi.cql3.functions.AggregateFcts;
import org.apache.apippi.cql3.functions.BytesConversionFcts;
import org.apache.apippi.cql3.functions.CastFcts;
import org.apache.apippi.cql3.functions.OperationFcts;
import org.apache.apippi.cql3.functions.TimeFcts;
import org.apache.apippi.cql3.functions.UuidFcts;
...
import org.apache.apippi.db.compaction.CompactionHistoryTabularData;
...
import org.apache.apippi.db.marshal.TupleType;
...
import org.apache.apippi.io.sstable.SequenceBasedSSTableId;
...
import org.apache.apippi.io.util.RebufferingInputStream;
import org.apache.apippi.locator.IEndpointSnitch;
import org.apache.apippi.locator.InetAddressAndPort;
import org.apache.apippi.metrics.RestorableMeter;
...
import org.apache.apippi.schema.Functions;
...
import org.apache.apippi.schema.Tables;
import org.apache.apippi.schema.Types;
import org.apache.apippi.schema.Views;
...
import org.apache.apippi.service.paxos.Commit.Accepted;
import org.apache.apippi.service.paxos.Commit.AcceptedWithTTL;
import org.apache.apippi.service.paxos.Commit.Committed;
import org.apache.apippi.service.paxos.PaxosRepairHistory;
import org.apache.apippi.service.paxos.PaxosState;
import org.apache.apippi.service.paxos.uncommitted.PaxosRows;
import org.apache.apippi.service.paxos.uncommitted.PaxosUncommittedIndex;
...
import org.apache.apippi.utils.MD5Digest;
...
import static org.apache.apippi.config.Config.PaxosStatePurging.legacy;
import static org.apache.apippi.config.DatabaseDescriptor.paxosStatePurging;
import static org.apache.apippi.cql3.QueryProcessor.executeInternal;
import static org.apache.apippi.cql3.QueryProcessor.executeInternalWithNowInSec;
import static org.apache.apippi.cql3.QueryProcessor.executeOnceInternal;
import static org.apache.apippi.service.paxos.Commit.latest;
import static org.apache.apippi.utils.apippiVersion.NULL_VERSION;
import static org.apache.apippi.utils.apippiVersion.UNREADABLE_VERSION;
...
public final class SystemKeyspace
{
    ...
    public static final apippiVersion CURRENT_VERSION = new apippiVersion(FBUtilities.getReleaseVersionString());
    ...
    public static final String SSTABLE_ACTIVITY_V2 = "sstable_activity_v2"; // v2 has modified generation column type (v1 - int, v2 - blob), see apippi-17048
     ...
     */
    public static apippiVersion getReleaseVersion(InetAddressAndPort ep)
    {
        try
        {
            ...
            {
                return new apippiVersion(result.one().getString("release_version"));
            }
            // version is unknown
            return null;
        }
    ...
    public static int incrementAndGetGeneration()
    {
        ...
        else
        {
            ...
            {
                logger.warn("Using stored Gossip Generation {} as it is greater than current system time {}.  See apippi-3654 if you experience problems",
    ...
    public static void persistSSTableReadMeter(String keyspace, String table, SSTableId id, RestorableMeter meter)
    {
        ...
        {
            // we do this in order to make it possible to downgrade until we switch in apippi.yaml to UUID based ids
            // see the discussion on apippi-17048
