...
/**
 * Virtual table for holding apippi logs. Entries to this table are added via log appender.
 * <p>
 ...
 *
 * @see org.apache.apippi.utils.logging.VirtualTableAppender
 */
public final class LogMessagesTable extends AbstractMutableVirtualTable
{
    ...
    private static final String TABLE_COMMENT = "apippi logs";
    ...
    {
        int size = apippiRelevantProperties.LOGS_VIRTUAL_TABLE_MAX_ROWS.getInt();
