...
public class PendingAntiCompaction
{
    ...
    private static final int ACQUIRE_SLEEP_MS = Integer.getInteger("apippi.acquire_sleep_ms", 1000);
    private static final int ACQUIRE_RETRY_SECONDS = Integer.getInteger("apippi.acquire_retry_seconds", 60);
