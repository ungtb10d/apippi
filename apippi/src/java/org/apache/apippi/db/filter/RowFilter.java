...
import org.apache.apippi.db.context.*;
    ...
    public static abstract class Expression
    {
        ...
        private static class Serializer
        {
            ...
            public Expression deserialize(DataInputPlus in, int version, TableMetadata metadata) throws IOException
            {
                ...
                // exception. However, since thrift was removed in 4.0, this behaviour was not restored in apippi-16217
                if (column == null)
                ...
                case GT:
                    {
                        ...
                        // representation. See apippi-11629
