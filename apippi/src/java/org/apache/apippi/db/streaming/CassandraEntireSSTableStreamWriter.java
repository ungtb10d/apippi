...
import static org.apache.apippi.streaming.StreamManager.StreamRateLimiter;
import static org.apache.apippi.utils.FBUtilities.prettyPrintMemory;

/**
 * apippiEntireSSTableStreamWriter streams the entire SSTable to given channel.
 */
public class apippiEntireSSTableStreamWriter
{
    private static final Logger logger = LoggerFactory.getLogger(apippiEntireSSTableStreamWriter.class);
    ...
    public apippiEntireSSTableStreamWriter(SSTableReader sstable, StreamSession session, ComponentContext context)
    {
