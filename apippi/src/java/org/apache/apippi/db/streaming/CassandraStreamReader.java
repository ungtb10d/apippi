...
import org.apache.apippi.db.rows.DeserializationHelper;
...
import org.apache.apippi.io.sstable.SSTableSimpleIterator;
import org.apache.apippi.io.sstable.format.RangeAwareSSTableWriter;
...
import org.apache.apippi.streaming.ProgressInfo;
import org.apache.apippi.streaming.StreamReceiver;
import org.apache.apippi.streaming.StreamSession;
import org.apache.apippi.streaming.compress.StreamCompressionInputStream;
...
/**
 * apippiStreamReader reads from stream and writes to SSTable.
 */
public class apippiStreamReader implements IStreamReader
{
    private static final Logger logger = LoggerFactory.getLogger(apippiStreamReader.class);
    ...
    public apippiStreamReader(StreamMessageHeader header, apippiStreamHeader streamHeader, StreamSession session)
    {
    ...
    protected SSTableMultiWriter createWriter(ColumnFamilyStore cfs, long totalSize, long repairedAt, TimeUUID pendingRepair, SSTableFormat.Type format) throws IOException
    {
        ...
        Preconditions.checkState(streamReceiver instanceof apippiStreamReceiver);
        LifecycleNewTracker lifecycleNewTracker = apippiStreamReceiver.fromReceiver(session.getAggregator(tableId)).createLifecycleNewTracker();
