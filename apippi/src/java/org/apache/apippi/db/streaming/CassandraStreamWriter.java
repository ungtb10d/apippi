...
import org.apache.apippi.io.util.DataIntegrityMetadata;
import org.apache.apippi.io.util.DataIntegrityMetadata.ChecksumValidator;
...
import org.apache.apippi.streaming.StreamManager.StreamRateLimiter;
import org.apache.apippi.streaming.StreamSession;
import org.apache.apippi.streaming.async.StreamCompressionSerializer;
...
/**
 * apippiStreamWriter writes given section of the SSTable to given channel.
 */
public class apippiStreamWriter
{
    private static final int DEFAULT_CHUNK_SIZE = 64 * 1024;

    private static final Logger logger = LoggerFactory.getLogger(apippiStreamWriter.class);
    ...
    public apippiStreamWriter(SSTableReader sstable, apippiStreamHeader header, StreamSession session)
    {
     ...
     *
     * apippiStreamWriter uses LZF compression on wire to decrease size to transfer.
     *
