...
/**
 * apippiStreamReader that reads from streamed compressed SSTable
 */
public class apippiCompressedStreamReader extends apippiStreamReader
{
    private static final Logger logger = LoggerFactory.getLogger(apippiCompressedStreamReader.class);

    protected final CompressionInfo compressionInfo;

    public apippiCompressedStreamReader(StreamMessageHeader header, apippiStreamHeader streamHeader, StreamSession session)
    {
