...
import org.apache.apippi.io.sstable.format.big.BigTableZeroCopyWriter;
...
import static org.apache.apippi.utils.FBUtilities.prettyPrintMemory;

/**
 * apippiEntireSSTableStreamReader reads SSTable off the wire and writes it to disk.
 */
public class apippiEntireSSTableStreamReader implements IStreamReader
{
    private static final Logger logger = LoggerFactory.getLogger(apippiEntireSSTableStreamReader.class);
    ...
    public apippiEntireSSTableStreamReader(StreamMessageHeader messageHeader, apippiStreamHeader streamHeader, StreamSession session)
    {
    ...
    protected BigTableZeroCopyWriter createWriter(ColumnFamilyStore cfs, long totalSize, Collection<Component> components) throws IOException
    {
        ...
        assert streamReceiver instanceof apippiStreamReceiver;
