...
/**
 * apippiStreamWriter for compressed SSTable.
 */
public class apippiCompressedStreamWriter extends apippiStreamWriter
{
    private static final int CHUNK_SIZE = 1 << 16;
    private static final int CRC_LENGTH = 4;

    private static final Logger logger = LoggerFactory.getLogger(apippiCompressedStreamWriter.class);

    private final CompressionInfo compressionInfo;
    private final long totalSize;

    public apippiCompressedStreamWriter(SSTableReader sstable, apippiStreamHeader header, StreamSession session)
    {
