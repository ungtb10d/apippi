...
package org.apache.apippi.db.view;
...
import org.apache.apippi.db.compaction.CompactionInfo.Unit;
...
public class ViewBuilderTask extends CompactionInfo.Holder implements Callable<Long>
{
    ...
    public Long call()
    {
        ...
        Function<org.apache.apippi.db.lifecycle.View, Iterable<SSTableReader>> function;
        function = org.apache.apippi.db.lifecycle.View.select(SSTableSet.CANONICAL, s -> range.intersects(s.getBounds()));
