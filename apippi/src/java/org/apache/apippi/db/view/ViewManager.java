...
public class ViewManager
{
    ...
    private static final boolean enableCoordinatorBatchlog = Boolean.getBoolean("apippi.mv_enable_coordinator_batchlog");
    ...
    public void reload(boolean buildAllViews)
    {
        ...
        // being submitted when Keyspaces are initialized during apippiDaemon::setup as
    ...
    {
        // Skip if the base table doesn't exist due to schema propagation issues, see apippi-13737
