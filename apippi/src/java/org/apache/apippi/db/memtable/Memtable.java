...
public interface Memtable extends Comparable<Memtable>, UnfilteredSource
{
     ...
     * under {@code memtable_configurations} in apippi.yaml). To make that possible, implementations must provide
     ...
     * and those in {@code update}. See apippi-7979.
     */
     ...
     * (see {@link org.apache.apippi.db.ColumnFamilyStore#setCommitLogUpperBound} and {@link AbstractMemtable#accepts})
     */
