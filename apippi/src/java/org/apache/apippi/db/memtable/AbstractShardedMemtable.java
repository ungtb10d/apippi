...
public abstract class AbstractShardedMemtable extends AbstractAllocatorMemtable
{
    ...
    @VisibleForTesting
    public static final String DEFAULT_SHARD_COUNT_PROPERTY = "apippi.memtable.shard.count";

    public static final String SHARDED_MEMTABLE_CONFIG_OBJECT_NAME = "org.apache.apippi.db:type=ShardedMemtableConfig";
    static
    {
