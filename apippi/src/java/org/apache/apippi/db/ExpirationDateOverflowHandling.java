...
public class ExpirationDateOverflowHandling
{
    ...
    private static final int EXPIRATION_OVERFLOW_WARNING_INTERVAL_MINUTES = Integer.getInteger("apippi.expiration_overflow_warning_interval_minutes", 5);
    ...
    static {
        String policyAsString = System.getProperty("apippi.expiration_date_overflow_policy", ExpirationDateOverflowPolicy.REJECT.name());
        try
        {
    ...
    public static final String MAXIMUM_EXPIRATION_DATE_EXCEEDED_WARNING = "Request on table {}.{} with {}ttl of {} seconds exceeds maximum supported expiration " +
                                                                          ...
                                                                          "is fixed. See apippi-14092 for more details.";
    ...
    public static void maybeApplyExpirationDateOverflowPolicy(TableMetadata metadata, int ttl, boolean isDefaultTTL) throws InvalidRequestException
    {
        ...
        // Check for localExpirationTime overflow (apippi-14092)
        ...
        if (ttl + nowInSecs < 0)
        {
            switch (policy)
            {
                ...
                case CAP_NOWARN:
                     ...
                     * to {@link org.apache.apippi.db.BufferExpiringCell#MAX_DELETION_TIME}
                     */
     ...
     * during {@link ExpirationDateOverflowHandling#maybeApplyExpirationDateOverflowPolicy(org.apache.apippi.schema.TableMetadata, int, boolean)},
