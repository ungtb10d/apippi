...
import org.apache.apippi.db.commitlog.CommitLogReadHandler.CommitLogReadErrorReason;
import org.apache.apippi.db.commitlog.CommitLogReadHandler.CommitLogReadException;
                             ...
                             CommitLogDescriptor desc) throws IOException
    {
        ...
        while (statusTracker.shouldContinue() && reader.getFilePointer() < end && !reader.isEOF())
        {
            ...
            try
            {
                ...
                // This prevents CRC by being fooled by special-case garbage in the file; see apippi-2128
