...
{
    @VisibleForTesting
    public static long MAX_OUTSTANDING_REPLAY_BYTES = Long.getLong("apippi.commitlog_max_outstanding_replay_bytes", 1024 * 1024 * 64);
    @VisibleForTesting
    ...
    abstract static class ReplayFilter
    {
        ...
        public static ReplayFilter create()
        {
            ...
            if (System.getProperty("apippi.replayList") == null)
                return new AlwaysReplayFilter();

            Multimap<String, String> toReplay = HashMultimap.create();
            for (String rawPair : System.getProperty("apippi.replayList").split(","))
            {
