...
public class CommitLogArchiver
{
     ...
     *
     * Used to archive files present in the commit log directory at startup (apippi-6904).
    ...
    public boolean maybeWaitForArchiving(String name)
    {
        ...
        catch (ExecutionException e)
        {
            if (e.getCause() instanceof RuntimeException)
            {
                ...
                {
                    logger.error("Looks like the archiving of file {} failed earlier, apippi is going to ignore this segment for now.", name, e.getCause().getCause());
                    return false;
                }
            }
