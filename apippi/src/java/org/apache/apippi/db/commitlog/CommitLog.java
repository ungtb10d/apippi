...
import org.apache.apippi.exceptions.CDCWriteException;
import org.apache.apippi.io.FSWriteError;
import org.apache.apippi.io.compress.ICompressor;
import org.apache.apippi.io.util.BufferedDataOutputStreamPlus;
...
import org.apache.apippi.metrics.CommitLogMetrics;
...
import static org.apache.apippi.db.commitlog.CommitLogSegment.Allocation;
import static org.apache.apippi.db.commitlog.CommitLogSegment.CommitLogSegmentFileComparator;
import static org.apache.apippi.db.commitlog.CommitLogSegment.ENTRY_OVERHEAD_SIZE;
import static org.apache.apippi.utils.FBUtilities.updateChecksum;
import static org.apache.apippi.utils.FBUtilities.updateChecksumInt;
...
public class CommitLog implements CommitLogMBean
{
    ...
    private static CommitLog construct()
    {
        ...
        MBeanWrapper.instance.registerMBean(log, "org.apache.apippi.db:type=Commitlog");
        return log;
    }
    ...
    public int recoverSegmentsOnDisk() throws IOException
    {
        ...
        // submit all files for this segment manager for archiving prior to recovery - apippi-6904
