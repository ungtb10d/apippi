...
public class SystemKeyspaceMigrator41
{
    ...
    static void migrateSSTableActivity()
    {
        ...
        apippiVersion prevVersion = prevVersionString != null ? new apippiVersion(prevVersionString) : apippiVersion.NULL_VERSION;
        ...
        migrateTable(apippiVersion.apippi_4_1.compareTo(prevVersion) > 0,
