...
import static org.apache.apippi.io.sstable.Component.DATA;
...
public abstract class AbstractCompactionStrategy
{
    ...
    // disable range overlap check when deciding if an SSTable is candidate for tombstone compaction (apippi-6563)
    ...
    protected boolean worthDroppingTombstones(SSTableReader sstable, int gcBefore)
    {
        ...
        //sstable range overlap check is disabled. See apippi-6563.
