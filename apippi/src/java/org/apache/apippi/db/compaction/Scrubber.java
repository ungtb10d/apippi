...
import org.apache.apippi.utils.memory.HeapCloner;
...
public class Scrubber implements Closeable
{
    ...
    private void throwIfCannotContinue(DecoratedKey key, Throwable th)
    {
        ...
        if (isCommutative && !skipCorrupted)
        {
            outputHandler.warn(String.format("An error occurred while scrubbing the partition with key '%s'.  Skipping corrupt " +
                                             ...
                                             "counters (see apippi-2759 for more details), so by default the scrub will " +
     ...
     *
     * For more details, refer to apippi-12144.
     */
    ...
    /**
     * In some case like apippi-12127 the cells might have been stored in the wrong order. This decorator check the
     ...
     *
     * This is to recover entries with overflowed localExpirationTime due to apippi-14092
     */
