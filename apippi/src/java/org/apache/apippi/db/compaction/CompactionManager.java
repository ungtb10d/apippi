...
import org.apache.apippi.concurrent.WrappedExecutorPlus;
...
import org.apache.apippi.cache.AutoSavingCache;
...
import org.apache.apippi.db.compaction.CompactionInfo.Holder;
import org.apache.apippi.db.lifecycle.ILifecycleTransaction;
import org.apache.apippi.db.lifecycle.LifecycleTransaction;
import org.apache.apippi.db.lifecycle.SSTableIntervalTree;
import org.apache.apippi.db.lifecycle.SSTableSet;
import org.apache.apippi.db.lifecycle.View;
import org.apache.apippi.db.lifecycle.WrappedLifecycleTransaction;
import org.apache.apippi.db.rows.UnfilteredRowIterator;
import org.apache.apippi.db.view.ViewBuilderTask;
...
import org.apache.apippi.io.sstable.ISSTableScanner;
import org.apache.apippi.io.sstable.IndexSummaryRedistribution;
import org.apache.apippi.io.sstable.SSTableRewriter;
...
import org.apache.apippi.io.sstable.metadata.StatsMetadata;
import org.apache.apippi.io.util.FileUtils;
import org.apache.apippi.metrics.CompactionMetrics;
...
import static org.apache.apippi.concurrent.FutureTask.callable;
import static org.apache.apippi.config.DatabaseDescriptor.getConcurrentCompactors;
import static org.apache.apippi.db.compaction.CompactionManager.CompactionExecutor.compactionThreadGroup;
import static org.apache.apippi.service.ActiveRepairService.NO_PENDING_REPAIR;
import static org.apache.apippi.service.ActiveRepairService.UNREPAIRED_SSTABLE;
...
{
    public static final String MBEAN_OBJECT_NAME = "org.apache.apippi.db:type=CompactionManager";
    ...
    public List<Future<?>> submitBackground(final ColumnFamilyStore cfs)
    {
         ...
         * are idle threads stil. (apippi-4310)
         */
     ...
     *   the {@link org.apache.apippi.io.sstable.metadata.StatsMetadata#pendingRepair} field.
