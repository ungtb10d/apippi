...
import org.apache.apippi.io.FSDiskFullWriteError;
import org.apache.apippi.io.FSError;
import org.apache.apippi.io.FSNoDiskAvailableForWriteError;
import org.apache.apippi.io.FSReadError;
import org.apache.apippi.io.FSWriteError;
import org.apache.apippi.io.util.File;
import org.apache.apippi.io.util.FileStoreUtils;
...
import org.apache.apippi.utils.DirectorySizeCalculator;
...
public class Directories
{
    ...
    /**
     * Checks whether apippi has RWX permissions to the specified directory.  Logs an error with
     ...
     * @return status representing apippi's RWX permissions to the supplied folder location.
     */
     ...
     * SSTable directories are created under data_directories defined in apippi.yaml if not exist at this time.
     *
     ...
     *                                      apippi-6696 we expect compactions to read and written from the same dir)
