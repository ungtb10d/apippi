...
import org.apache.apippi.db.transform.RTBoundCloser;
import org.apache.apippi.db.transform.RTBoundValidator;
import org.apache.apippi.db.transform.RTBoundValidator.Stage;
import org.apache.apippi.db.transform.StoppingTransformation;
import org.apache.apippi.db.transform.Transformation;
import org.apache.apippi.exceptions.UnknownIndexException;
import org.apache.apippi.index.Index;
import org.apache.apippi.index.IndexNotAvailableException;
...
import static org.apache.apippi.db.partitions.UnfilteredPartitionIterators.MergeListener.NOOP;
...
{
    private static final int TEST_ITERATION_DELAY_MILLIS = Integer.parseInt(System.getProperty("apippi.test.read_iteration_delay_ms", "0"));
    ...
    private class QueryCancellationChecker extends StoppingTransformation<UnfilteredRowIterator>
    {
        ...
        private void maybeCancel()
        {
             ...
             * {@link org.apache.apippi.utils.MonotonicClock.SampledClock.CHECK_INTERVAL_MS}, by default 2 millis.
