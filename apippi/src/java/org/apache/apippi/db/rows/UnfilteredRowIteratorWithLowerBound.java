...
import org.apache.apippi.utils.IteratorWithLowerBound;
 ...
 * then we will not. See apippi-8180 for examples of why this is useful.
 */
public class UnfilteredRowIteratorWithLowerBound extends LazilyInitializedUnfilteredRowIterator implements IteratorWithLowerBound<Unfiltered>
{
    ...
    {
        // NOTE: apippi-11206 removed the lookup against the key-cache as the IndexInfo objects are no longer
        // in memory for not heap backed IndexInfo objects (so, these are on disk).
        // apippi-11369 is there to fix this afterwards.
