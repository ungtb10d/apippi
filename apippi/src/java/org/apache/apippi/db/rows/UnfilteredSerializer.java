...
import org.apache.apippi.db.marshal.ByteArrayAccessor;
import org.apache.apippi.schema.ColumnMetadata;
import org.apache.apippi.db.*;
import org.apache.apippi.db.rows.Row.Deletion;
...
import org.apache.apippi.utils.WrappedException;
 ...
 *           {@link org.apache.apippi.db.Clustering.Serializer} (note that static row are an
 ...
 *           {@link org.apache.apippi.db.Columns.Serializer#serializeSubset}. It is absent if the row
 ...
 *     the marker bound as serialized by {@link org.apache.apippi.db.ClusteringBoundOrBoundary.Serializer}
...
public class UnfilteredSerializer
{
     ...
     * previously deleted cell not updated by a subsequent update, SEE apippi-11500
     */
    @Deprecated
     ...
     * contains data for dropped columns, see apippi-13337. But as most code expect rows to not be empty, this isn't
