...
import org.apache.apippi.db.transform.FilteredRows;
...
import org.apache.apippi.utils.IMergeIterator;
...
public abstract class UnfilteredRowIterators
{
    ...
    public static void digest(UnfilteredRowIterator iterator, Digest digest, int version)
    {
        ...
        // is computed on an iterator that has been serialized or not (see apippi-12090)
