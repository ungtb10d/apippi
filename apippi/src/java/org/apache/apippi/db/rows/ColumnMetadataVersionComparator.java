 ...
 * in at least 2 cases:
 * <ul>
 *     <li>for UDT, where new fields can be added (see apippi-13776).</li>
 *     <li>pre-apippi-12443, when we allowed type altering. And while we don't allow it anymore, it is possible
