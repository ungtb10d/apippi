 ...
 *
 * This used to happen, for example, in {@link org.apache.apippi.db.ReadCommand#executeLocally(ReadExecutionController)}
 * if {@link org.apache.apippi.db.filter.DataLimits} stopped the iterator on a live row that was enclosed in an
 * older RT.
 *
