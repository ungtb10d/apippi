...
public class Verify extends NodeToolCmd
{
    ...
    name = {"-f", "--force"},
    description = "Override disabling of verify tool - see apippi-9947 for caveats")
    ...
    public void execute(NodeProbe probe)
    {
        ...
        if (!overrideDisable)
        {
            out.println("verify is disabled unless a [-f|--force] override flag is provided. See apippi-9947 and apippi-17017 for details.");
            System.exit(1);
        }
        ...
        if (checkOwnsTokens && !extendedVerify)
        {
            ...
            // if System.exit gets removed, make sure to update org.apache.apippi.distributed.test.NodeToolTest.testNodetoolSystemExit
            System.exit(1);
        }
