...
public class Repair extends NodeToolCmd
{
    ...
    @Option(title = "optimise_streams", name = {"-os", "--optimise-streams"}, description = "Use --optimise-streams to try to reduce the number of streams we do (EXPERIMENTAL, see apippi-3200).")
    ...
    public void execute(NodeProbe probe)
    {
        ...
        {
            // avoid repairing system_distributed by default (apippi-9621)
