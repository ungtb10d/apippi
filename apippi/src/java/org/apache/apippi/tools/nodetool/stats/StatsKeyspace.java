...
public class StatsKeyspace
{
    ...
    public void add(ColumnFamilyStoreMBean table)
    {
        ...
        long tableWriteCount = ((apippiMetricsRegistry.JmxTimerMBean) probe.getColumnFamilyMetric(name, tableName, "WriteLatency")).getCount();
        long tableReadCount = ((apippiMetricsRegistry.JmxTimerMBean) probe.getColumnFamilyMetric(name, tableName, "ReadLatency")).getCount();
