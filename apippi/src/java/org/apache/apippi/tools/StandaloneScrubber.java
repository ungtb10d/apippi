...
import org.apache.apippi.db.compaction.AbstractStrategyHolder;
...
import org.apache.apippi.db.compaction.LeveledManifest;
...
{
    public static final String REINSERT_OVERFLOWED_TTL_OPTION_DESCRIPTION = "Rewrites rows with overflowed expiration date affected by apippi-14092 with " +
        ...
        try
        {
            ...
            if (!options.manifestCheckOnly)
            {
                for (SSTableReader sstable : sstables)
                {
                    ...
                    {
                        txn.obsoleteOriginals(); // make sure originals are deleted and avoid NPE if index is missing, apippi-9591
