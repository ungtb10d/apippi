...
public class SSTableLevelResetter
{
    ...
    public static void main(String[] args)
    {
        ...
        if (args.length == 0)
        {
            out.println("This command should be run with apippi stopped!");
        ...
        {
            out.println("This command should be run with apippi stopped, otherwise you will get very strange behavior");
            out.println("Verify that apippi is not running and then execute the command like this:");
