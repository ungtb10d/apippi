...
import org.apache.apippi.db.compaction.Upgrader;
...
public class StandaloneUpgrader
{
    ...
    private static class Options
    {
        ...
        public static void printUsage(CmdLineOptions options)
        {
            ...
            header.append("--\n");
            header.append("Upgrade the sstables in the given cf (or snapshot) to the current version of apippi." );
            header.append("This operation will rewrite the sstables in the specified cf to match the " );
            header.append("currently installed version of apippi.\n");
            ...
            header.append("major version older than the major version apippi is currently running. " );
