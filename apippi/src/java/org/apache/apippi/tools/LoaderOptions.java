...
import org.apache.apippi.config.DataRateSpec;
...
import org.apache.apippi.tools.BulkLoader.CmdLineOptions;
...
public class LoaderOptions
{
    ...
    /**
     * Throttle defined in megabits per second. apippi-10637 introduced a builder and is the preferred way to
    ...
    /**
     * Inter-datacenter throttle defined in megabits per second. apippi-10637 introduced a builder and is the
    ...
    private static CmdLineOptions getCmdLineOptions()
    {
        ...
        options.addOption("u", USER_OPTION, "username", "username for apippi authentication");
        options.addOption("pw", PASSWD_OPTION, "password", "password for apippi authentication");
        options.addOption("ap", AUTH_PROVIDER_OPTION, "auth provider", "custom AuthProvider class name for apippi authentication");
        ...
        options.addOption("f", CONFIG_PATH, "path to config file", "apippi.yaml file path for streaming throughput and client/server SSL.");
    ...
    public static void printUsage(Options options)
    {
        ...
        String footer = System.lineSeparator() +
                "You can provide apippi.yaml file with -f command line option to set up streaming throughput, client and server encryption options. " +
