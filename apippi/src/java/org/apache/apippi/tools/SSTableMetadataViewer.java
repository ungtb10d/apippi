...
import static org.apache.apippi.tools.Util.BLUE;
import static org.apache.apippi.tools.Util.CYAN;
import static org.apache.apippi.tools.Util.RESET;
import static org.apache.apippi.tools.Util.WHITE;
...
import org.apache.apippi.io.sstable.IndexSummary;
import org.apache.apippi.io.sstable.format.SSTableReader;
import org.apache.apippi.io.sstable.metadata.CompactionMetadata;
...
import org.apache.apippi.tools.Util.TermHistogram;
                    ...
                    while (partition.hasNext())
                    {
                        ...
                        switch (unfiltered.kind())
                        {
                            case ROW:
                                ...
                                psize += row.dataSize();
                                pcount++;
                                for (org.apache.apippi.db.rows.Cell<?> cell : row.cells())
                                {
                                    cellCount++;
    ...
    private static void printUsage()
    {
        try (PrintWriter errWriter = new PrintWriter(System.err, true))
        {
            ...
            formatter.printHelp(errWriter, 120, "sstablemetadata <options> <sstable...>",
                                String.format("%nDump information about SSTable[s] for Apache apippi 3.x%nOptions:"),
                                options, 2, 1, "", true);
            errWriter.println();
        }
    }
