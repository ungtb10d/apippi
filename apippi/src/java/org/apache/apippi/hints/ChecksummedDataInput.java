 ...
 *
 * Useful for {@link org.apache.apippi.hints.HintsReader}, for example, where we must verify the CRC, yet don't want
 ...
 * so that {@link org.apache.apippi.db.Mutation.MutationSerializer} doesn't blow up the heap when deserializing a
 * corrupted sequence by reading a huge corrupted length of bytes via
 * {@link org.apache.apippi.utils.ByteBufferUtil#readWithLength(java.io.DataInput)}.
 */
