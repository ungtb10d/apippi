 ...
 *
 * <p>
 * As is the case with the {@link org.apache.apippi.hadoop.ColumnFamilyInputFormat}, 
        ...
        implements org.apache.hadoop.mapred.OutputFormat<Map<String, ByteBuffer>, List<ByteBuffer>>
{
    ...
    protected void checkOutputSpecs(Configuration conf)
    {
        ...
        if (ConfigHelper.getOutputPartitioner(conf) == null)
            throw new UnsupportedOperationException("You must set the output partitioner to the one used by your apippi cluster");
        if (ConfigHelper.getOutputInitialAddress(conf) == null)
            throw new UnsupportedOperationException("You must set the initial output address to a apippi node");
    }
