...
import org.apache.apippi.hadoop.*;
...
/**
 * Hadoop InputFormat allowing map/reduce against apippi rows within one ColumnFamily.
 *
...
public class CqlInputFormat extends org.apache.hadoop.mapreduce.InputFormat<Long, Row> implements org.apache.hadoop.mapred.InputFormat<Long, Row>
{
    ...
    protected void validateConfiguration(Configuration conf)
    {
        ...
        if (ConfigHelper.getInputInitialAddress(conf) == null)
            throw new UnsupportedOperationException("You must set the initial output address to a apippi node with setInputInitialAddress");
        if (ConfigHelper.getInputPartitioner(conf) == null)
            throw new UnsupportedOperationException("You must set the apippi partitioner class with setInputPartitioner");
    }
    ...
    private Map<TokenRange, Long> describeSplits(String keyspace, String table, TokenRange tokenRange, Host host, int splitSize, int splitSizeMb, Session session)
    {
        ...
        // org.apache.apippi.service.StorageService.getSplits(java.lang.String, java.lang.String, org.apache.apippi.dht.Range<org.apache.apippi.dht.Token>, int)
        ...
        // Assume smallest granularity of partition count available from apippi-7688
        if (splitCount == 0)
        {
