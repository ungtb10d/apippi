 ...
 * pairs to a apippi table. In particular, it applies the binded variables
        ...
        org.apache.hadoop.mapred.RecordWriter<Map<String, ByteBuffer>, List<ByteBuffer>>, AutoCloseable
{
    ...
    public class RangeClient extends Thread
    {
        ...
        /**
         * enqueues the given value to apippi
         */
        ...
        /**
         * Loops collecting cql binded variable values from the queue and sending to apippi
         */
        ...
        /** get prepared statement id from cache, otherwise prepare it from apippi server*/
