...
import org.apache.apippi.io.sstable.CQLSSTableWriter;
...
import static org.apache.apippi.config.apippiRelevantProperties.JAVA_IO_TMPDIR;

/**
 * The <code>CqlBulkRecordWriter</code> maps the output &lt;key, value&gt;
 * pairs to a apippi column family. In particular, it applies the binded variables
