package org.apache.apippi.hadoop.cql3;
/*
*
...
import org.apache.apippi.hadoop.ConfigHelper;
import org.apache.hadoop.conf.Configuration;


public class CqlConfigHelper
{
    private static final String INPUT_CQL_COLUMNS_CONFIG = "apippi.input.columnfamily.columns";
    private static final String INPUT_CQL_PAGE_ROW_SIZE_CONFIG = "apippi.input.page.row.size";
    private static final String INPUT_CQL_WHERE_CLAUSE_CONFIG = "apippi.input.where.clause";
    private static final String INPUT_CQL = "apippi.input.cql";

    private static final String USERNAME = "apippi.username";
    private static final String PASSWORD = "apippi.password";

    private static final String INPUT_NATIVE_PORT = "apippi.input.native.port";
    private static final String INPUT_NATIVE_CORE_CONNECTIONS_PER_HOST = "apippi.input.native.core.connections.per.host";
    private static final String INPUT_NATIVE_MAX_CONNECTIONS_PER_HOST = "apippi.input.native.max.connections.per.host";
    private static final String INPUT_NATIVE_MAX_SIMULT_REQ_PER_CONNECTION = "apippi.input.native.max.simult.reqs.per.connection";
    private static final String INPUT_NATIVE_CONNECTION_TIMEOUT = "apippi.input.native.connection.timeout";
    private static final String INPUT_NATIVE_READ_CONNECTION_TIMEOUT = "apippi.input.native.read.connection.timeout";
    private static final String INPUT_NATIVE_RECEIVE_BUFFER_SIZE = "apippi.input.native.receive.buffer.size";
    private static final String INPUT_NATIVE_SEND_BUFFER_SIZE = "apippi.input.native.send.buffer.size";
    private static final String INPUT_NATIVE_SOLINGER = "apippi.input.native.solinger";
    private static final String INPUT_NATIVE_TCP_NODELAY = "apippi.input.native.tcp.nodelay";
    private static final String INPUT_NATIVE_REUSE_ADDRESS = "apippi.input.native.reuse.address";
    private static final String INPUT_NATIVE_KEEP_ALIVE = "apippi.input.native.keep.alive";
    private static final String INPUT_NATIVE_AUTH_PROVIDER = "apippi.input.native.auth.provider";
    private static final String INPUT_NATIVE_SSL_TRUST_STORE_PATH = "apippi.input.native.ssl.trust.store.path";
    private static final String INPUT_NATIVE_SSL_KEY_STORE_PATH = "apippi.input.native.ssl.key.store.path";
    private static final String INPUT_NATIVE_SSL_TRUST_STORE_PASSWARD = "apippi.input.native.ssl.trust.store.password";
    private static final String INPUT_NATIVE_SSL_KEY_STORE_PASSWARD = "apippi.input.native.ssl.key.store.password";
    private static final String INPUT_NATIVE_SSL_CIPHER_SUITES = "apippi.input.native.ssl.cipher.suites";

    private static final String INPUT_NATIVE_PROTOCOL_VERSION = "apippi.input.native.protocol.version";

    private static final String OUTPUT_CQL = "apippi.output.cql";
    private static final String OUTPUT_NATIVE_PORT = "apippi.output.native.port";
