...
import org.apache.apippi.hadoop.HadoopCompat;
 ...
 *
 * <p>
 * As is the case with the {@link org.apache.apippi.hadoop.cql3.CqlOutputFormat}, 
 * you need to set the prepared statement in your
 * Hadoop job Configuration. The {@link CqlConfigHelper} class, through its
 * {@link org.apache.apippi.hadoop.ConfigHelper#setOutputPreparedStatement} method, is provided to make this
 * simple.
 * you need to set the Keyspace. The {@link ConfigHelper} class, through its
 * {@link org.apache.apippi.hadoop.ConfigHelper#setOutputColumnFamily} method, is provided to make this
 * simple.
 * </p>
 */
...
{   
    ...
    private static final String OUTPUT_CQL_SCHEMA_PREFIX = "apippi.table.schema.";
    private static final String OUTPUT_CQL_INSERT_PREFIX = "apippi.table.insert.";
    private static final String DELETE_SOURCE = "apippi.output.delete.source";
