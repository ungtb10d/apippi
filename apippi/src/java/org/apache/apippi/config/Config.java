...
import org.apache.apippi.service.StartupChecks.StartupCheckType;

/**
 * A class that contains configuration properties for the apippi node it runs within.
 *
...
public class Config
{
    ...
    /*
     * Prefix for Java properties for internal apippi configuration options
     */
    public static final String PROPERTY_PREFIX = "apippi.";
    ...
    // Defensive settings for protecting apippi from true network partitions. See (apippi-14358) for details.
    ...
    /**
     * @deprecated retry support removed on apippi-10992
     */
    @Deprecated
    ...
    public String row_cache_class_name = "org.apache.apippi.cache.OHCProvider";
    ...
    public boolean file_cache_enabled = Boolean.getBoolean("apippi.file_cache_enabled");

    /**
     * Because of the current {@link org.apache.apippi.utils.memory.BufferPool} slab sizes of 64 KiB, we
     ...
     * able to fail fast - i.e. stop the apippi daemon, which is currently the only appropriate approach to
     ...
     */
    // Below parameter is not presented in apippi.yaml but to be on the safe side that no one was directly using it
    // I still added backward compatibility (apippi-15234)
     ...
     * - 'die' - i.e. it is able to emit a warning to the client before the apippi Daemon will shut down.
     ...
     * timeout. See apippi-13993 and apippi-14297 for more details.
     *
    ...
    // threads during tool usage mode. See apippi-12988 and DatabaseDescriptorRefTest for details
     ...
     * provide another tool to manage cluster health vs application access. See apippi-12106 and CEP-13 for more details.
     */
    ...
    public boolean autocompaction_on_startup_enabled = Boolean.parseBoolean(System.getProperty("apippi.autocompaction_on_startup_enabled", "true"));

    // see apippi-3200 / apippi-16274
    ...
    // see apippi-17048 and the comment in apippi.yaml
    ...
    /**
     * The variants of paxos implementation and semantics supported by apippi.
     */
     ...
     */
    public volatile boolean skip_paxos_repair_on_topology_change = Boolean.getBoolean("apippi.skip_paxos_repair_on_topology_change");
     ...
     * of linearizability violations. this facility should be activated only for debugging apippi or by power users
     ...
     */
    public volatile Set<String> skip_paxos_repair_on_topology_change_keyspaces = splitCommaDelimited(System.getProperty("apippi.skip_paxos_repair_on_topology_change_keyspaces"));

    /**
     * See {@link org.apache.apippi.service.paxos.ContentionStrategy}
     */
