...
/**
 * Converters for backward compatibility with the old apippi.yaml where duration, data rate and
 * data storage configuration parameters were provided only by value and the expected unit was part of the configuration
 * parameter name(suffix). (apippi-15234)
...
{
    /**
     * This converter is used when we change the name of a apippi.yaml configuration parameter but we want to be
     ...
     * inter_dc_stream_throughput_outbound which were provided in megabits per second prior apippi-15234.
     */
     ...
     *
     * @param value we will use from apippi.yaml to create a new {@link Config} parameter of type {@link DurationSpec},
     ...
     * values in the old format pre-apippi-15234 and in the right units, used in the Virtual Tables to ensure backward
     * compatibility
     *
