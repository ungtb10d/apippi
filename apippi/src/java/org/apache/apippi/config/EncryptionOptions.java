...
import org.apache.apippi.security.DisableSslContextFactory;
...
public class EncryptionOptions
{
    ...
    // See apippi-15262 and apippi-15146
    ...
    {
        ssl_context_factory = new ParameterizedClass("org.apache.apippi.security.DefaultSslContextFactory",
                                                     new HashMap<>());
    ...
    private void initializeSslContextFactory()
    {
        ...
        if (apippiRelevantProperties.TEST_JVM_DTEST_DISABLE_SSL.getBoolean())
        {
