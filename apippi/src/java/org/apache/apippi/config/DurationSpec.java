...
/**
 * Represents a positive time duration. Wrapper class for apippi duration configuration parameters, providing to the
...
public abstract class DurationSpec
{
    ...
    /**
     * Represents a duration used for apippi configuration. The bound is [0, Long.MAX_VALUE) in nanoseconds.
    ...
    /**
     * Represents a duration used for apippi configuration. The bound is [0, Long.MAX_VALUE) in milliseconds.
    ...
    /**
     * Represents a duration used for apippi configuration. The bound is [0, Long.MAX_VALUE) in seconds.
    ...
    /**
     * Represents a duration used for apippi configuration. The bound is [0, Integer.MAX_VALUE) in minutes.
    ...
    /**
     * Represents a duration used for apippi configuration. The bound is [0, Integer.MAX_VALUE) in seconds.
     * If the user sets a different unit - we still validate that converted to seconds the quantity will not exceed
     * that upper bound. (apippi-17571)
     */
    ...
    /**
     * Represents a duration used for apippi configuration. The bound is [0, Integer.MAX_VALUE) in milliseconds.
     * If the user sets a different unit - we still validate that converted to milliseconds the quantity will not exceed
     * that upper bound. (apippi-17571)
     */
