...
import static org.apache.apippi.db.SystemKeyspace.PAXOS_REPAIR_HISTORY;
...
public class PaxosStateTracker
{
    ...
    static final String SKIP_REBUILD_PROP = "apippi.skip_paxos_state_rebuild";
    static final String FORCE_REBUILD_PROP = "apippi.force_paxos_state_rebuild";
    static final String TRUNCATE_BALLOT_METADATA_PROP = "apippi.truncate_ballot_metadata";
    ...
    {
        logger.info("Beginning uncommitted paxos data rebuild. Set -Dapippi.skip_paxos_state_rebuild=true and restart to skip");
