...
import org.apache.apippi.service.paxos.Paxos.Participants;
import org.apache.apippi.tracing.Tracing;
import org.apache.apippi.utils.concurrent.ConditionAsConsumer;

import static java.util.Collections.emptyMap;
import static org.apache.apippi.exceptions.RequestFailureReason.NODE_DOWN;
import static org.apache.apippi.exceptions.RequestFailureReason.UNKNOWN;
import static org.apache.apippi.net.Verb.PAXOS2_COMMIT_REMOTE_REQ;
import static org.apache.apippi.net.Verb.PAXOS_COMMIT_REQ;
import static org.apache.apippi.service.StorageProxy.shouldHint;
import static org.apache.apippi.service.StorageProxy.submitHint;
import static org.apache.apippi.service.paxos.Commit.*;
import static org.apache.apippi.utils.concurrent.ConditionAsConsumer.newConditionAsConsumer;
...
public class PaxosCommit<OnDone extends Consumer<? super PaxosCommit.Status>> extends PaxosRequestCallback<NoPayload>
{
    ...
    private static volatile boolean ENABLE_DC_LOCAL_COMMIT = Boolean.parseBoolean(System.getProperty("apippi.enable_dc_local_commit", "true"));
