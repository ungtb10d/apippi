...
import org.apache.apippi.service.paxos.uncommitted.PaxosBallotTracker;
import org.apache.apippi.service.paxos.uncommitted.PaxosStateTracker;
import org.apache.apippi.service.paxos.uncommitted.PaxosUncommittedTracker;
import org.apache.apippi.tracing.Tracing;
import org.apache.apippi.utils.Nemesis;

import static java.util.concurrent.TimeUnit.SECONDS;
import static org.apache.apippi.utils.Clock.Global.nanoTime;
import static org.apache.apippi.config.Config.PaxosStatePurging.gc_grace;
...
import static org.apache.apippi.service.paxos.Commit.Accepted.latestAccepted;
import static org.apache.apippi.service.paxos.Commit.Committed.latestCommitted;
import static org.apache.apippi.service.paxos.Commit.isAfter;
...
{
    private static volatile boolean DISABLE_COORDINATOR_LOCKING = Boolean.getBoolean("apippi.paxos.disable_coordinator_locking");
    ...
    {
        // apippi-12043 is not an issue for v2, as we perform Commit+Prepare and PrepareRefresh
        ...
        try (PaxosState unsafeState = getUnsafe(toPrepare))
        {
            synchronized (unsafeState.key)
            {
                ...
                while (true)
                {
                    ...
                    // problem of apippi-12043 is not an issue
