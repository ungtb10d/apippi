...
import org.apache.apippi.net.RequestCallbackWithFailure;
...
import static org.apache.apippi.net.Verb.PAXOS2_REPAIR_REQ;
import static java.util.concurrent.TimeUnit.NANOSECONDS;
import static org.apache.apippi.service.paxos.Commit.*;
import static org.apache.apippi.service.paxos.ContentionStrategy.Type.REPAIR;
import static org.apache.apippi.service.paxos.ContentionStrategy.waitUntilForContention;
import static org.apache.apippi.service.paxos.Paxos.*;
import static org.apache.apippi.service.paxos.PaxosPrepare.*;
import static org.apache.apippi.utils.Clock.Global.nanoTime;
import static org.apache.apippi.utils.NullableSerializer.deserializeNullable;
import static org.apache.apippi.utils.NullableSerializer.serializeNullable;
import static org.apache.apippi.utils.NullableSerializer.serializedSizeNullable;
 ...
 *      after repair completes that permits a linearization failure, such as with apippi-15745.
 ...
 *      linearization failure, such as with apippi-15745.
 *
...
public class PaxosRepair extends AbstractPaxosRepair
{
    ...
    private static volatile boolean SKIP_VERSION_VALIDATION = Boolean.getBoolean("apippi.skip_paxos_repair_version_validation");
    ...
    static boolean validateVersionCompatibility(apippiVersion version)
    {
    ...
    static boolean validatePeerCompatibility(Replica peer)
    {
        ...
        apippiVersion version = versionString != null ? new apippiVersion(versionString) : null;
