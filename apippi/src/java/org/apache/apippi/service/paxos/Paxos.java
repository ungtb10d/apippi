...
import org.apache.apippi.exceptions.ExceptionCode;
...
import org.apache.apippi.locator.InOurDc;
import org.apache.apippi.locator.Replica;
import org.apache.apippi.locator.ReplicaLayout;
import org.apache.apippi.locator.ReplicaLayout.ForTokenWrite;
import org.apache.apippi.locator.ReplicaPlan.ForRead;
...
import org.apache.apippi.metrics.ClientRequestMetrics;
import org.apache.apippi.service.CASRequest;
import org.apache.apippi.service.ClientState;
import org.apache.apippi.service.FailureRecordingCallback.AsMap;
import org.apache.apippi.service.paxos.Commit.Proposal;
import org.apache.apippi.service.reads.DataResolver;
import org.apache.apippi.service.reads.repair.NoopReadRepair;
import org.apache.apippi.service.paxos.cleanup.PaxosTableRepairs;
...
import org.apache.apippi.utils.CollectionSerializer;
import org.apache.apippi.utils.FBUtilities;
import org.apache.apippi.service.paxos.PaxosPrepare.FoundIncompleteAccepted;
import org.apache.apippi.service.paxos.PaxosPrepare.FoundIncompleteCommitted;

import static java.util.Collections.emptyMap;
import static java.util.concurrent.TimeUnit.NANOSECONDS;
import static java.util.concurrent.TimeUnit.SECONDS;
import static org.apache.apippi.config.Config.PaxosVariant.v2_without_linearizable_reads_or_rejected_writes;
import static org.apache.apippi.db.Keyspace.openAndGetStore;
import static org.apache.apippi.exceptions.RequestFailureReason.TIMEOUT;
import static org.apache.apippi.gms.ApplicationState.RELEASE_VERSION;
import static org.apache.apippi.config.DatabaseDescriptor.*;
import static org.apache.apippi.db.ConsistencyLevel.*;
import static org.apache.apippi.locator.InetAddressAndPort.Serializer.inetAddressAndPortSerializer;
import static org.apache.apippi.locator.ReplicaLayout.forTokenWriteLiveAndDown;
...
import static org.apache.apippi.metrics.ClientRequestsMetricsHolder.readMetricsMap;
import static org.apache.apippi.metrics.ClientRequestsMetricsHolder.writeMetricsMap;
...
import static org.apache.apippi.service.paxos.BallotGenerator.Global.staleBallot;
import static org.apache.apippi.service.paxos.ContentionStrategy.*;
import static org.apache.apippi.service.paxos.ContentionStrategy.Type.READ;
import static org.apache.apippi.service.paxos.ContentionStrategy.Type.WRITE;
import static org.apache.apippi.service.paxos.PaxosCommit.commit;
import static org.apache.apippi.service.paxos.PaxosCommitAndPrepare.commitAndPrepare;
import static org.apache.apippi.service.paxos.PaxosPrepare.prepare;
import static org.apache.apippi.service.paxos.PaxosPropose.propose;
import static org.apache.apippi.utils.Clock.Global.nanoTime;
import static org.apache.apippi.utils.CollectionSerializer.newHashSet;
import static org.apache.apippi.utils.FBUtilities.getBroadcastAddressAndPort;

/**
 * <p>This class serves as an entry-point to apippi's implementation of Paxos Consensus.
 * Note that apippi does not utilise the distinguished proposer (Multi Paxos) optimisation;
 * each operation executes its own instance of Paxos Consensus. Instead apippi employs
...
public class Paxos
{
    ...
    private static final apippiVersion MODERN_PAXOS_RELEASE = new apippiVersion(System.getProperty("apippi.paxos.modern_release", "4.1"));
    static final boolean LOG_TTL_LINEARIZABILITY_VIOLATIONS = Boolean.parseBoolean(System.getProperty("apippi.paxos.log_ttl_linearizability_violations", "true"));
    ...
    static boolean isOldParticipant(Replica replica)
    {
        ...
        try
        {
            return new apippiVersion(version).compareTo(MODERN_PAXOS_RELEASE) < 0;
        }
        catch (Throwable t)
        {
            return false;
