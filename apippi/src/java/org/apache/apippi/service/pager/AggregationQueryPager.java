...
public final class AggregationQueryPager implements QueryPager
{
     ...
     * <p>For maintaining backward compatibility we are forced to use the {@link org.apache.apippi.db.filter.DataLimits.CQLLimits} instead of the
     * {@link org.apache.apippi.db.filter.DataLimits.CQLGroupByLimits}. Due to that pages need to be fetched in a different way.</p>
     */
