...
import org.apache.apippi.db.MutationExceededMaxSizeException;
...
import static org.apache.apippi.db.IMutation.MAX_MUTATION_SIZE;
...
public class BlockingReadRepairs
{
    ...
    private static final boolean DROP_OVERSIZED_READ_REPAIR_MUTATIONS =
        Boolean.getBoolean("apippi.drop_oversized_readrepair_mutations");
