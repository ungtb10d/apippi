...
import org.apache.apippi.service.reads.thresholds.WarningContext;
import org.apache.apippi.service.reads.thresholds.WarningsSnapshot;
...
import static org.apache.apippi.tracing.Tracing.isTracing;
...
public class ReadCallback<E extends Endpoints<E>, P extends ReplicaPlan.ForRead<E, P>> implements RequestCallback<ReadResponse>
{
    ...
    public ReadCallback(ResponseResolver<E, P> resolver, ReadCommand command, ReplicaPlan.Shared<E, P> replicaPlan, long queryStartNanoTime)
    {
        ...
        // we don't support read repair (or rapid read protection) for range scans yet (apippi-6897)
    ...
    public void onResponse(Message<ReadResponse> message)
    {
         ...
         * be accessible when we do signal. (see apippi-16807)
         */
