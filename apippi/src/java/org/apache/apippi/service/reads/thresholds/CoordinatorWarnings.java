 ...
 */
package org.apache.apippi.service.reads.thresholds;
...
public class CoordinatorWarnings
{
    ...
    private static final boolean ENABLE_DEFENSIVE_CHECKS = Boolean.getBoolean("apippi.reads.thresholds.coordinator.defensive_checks_enabled");
