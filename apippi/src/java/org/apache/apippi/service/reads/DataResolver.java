...
import org.apache.apippi.db.transform.EmptyPartitionsDiscarder;
import org.apache.apippi.db.transform.Filter;
import org.apache.apippi.db.transform.FilteredPartitions;
...
public class DataResolver<E extends Endpoints<E>, P extends ReplicaPlan.ForRead<E, P>> extends ResponseResolver<E, P>
{
                                              ...
                                              UnaryOperator<PartitionIterator> preCountFilter)
    {
         ...
         *
         * See apippi-13747 for more details.
         */
                ...
                return new UnfilteredRowIterators.MergeListener()
                {
                    ...
                    public void onMergedRangeTombstoneMarkers(RangeTombstoneMarker merged, RangeTombstoneMarker[] versions)
                    {
                        try
                        {
                            ...
                            // unexpectedly in a few occasions (apippi-13237, apippi-13719). It's hard to get insights
