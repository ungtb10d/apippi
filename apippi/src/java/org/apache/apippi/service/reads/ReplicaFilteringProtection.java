...
import org.apache.apippi.db.Columns;
...
import org.apache.apippi.db.filter.ClusteringIndexNamesFilter;
...
import org.apache.apippi.db.rows.RangeTombstoneMarker;
...
import org.apache.apippi.db.rows.UnfilteredRowIterators;
...
import org.apache.apippi.utils.btree.BTreeSet;
 ...
 * <p>
 * See apippi-8272, apippi-8273, and apippi-15907 for further details.
 */
    ...
    private void incrementCachedRows()
    {
        ...
        if (currentRowsCached == cachedRowsFailThreshold + 1)
        {
            String message = String.format("Replica filtering protection has cached over %d rows during query %s. " +
                                           "(See 'cached_replica_rows_fail_threshold' in apippi.yaml.)",
        ...
        else if (currentRowsCached == cachedRowsWarnThreshold + 1 && !hitWarningThreshold)
        {
            ...
            String message = String.format("Replica filtering protection has cached over %d rows during query %s. " +
                                           "(See 'cached_replica_rows_warn_threshold' in apippi.yaml.)",
