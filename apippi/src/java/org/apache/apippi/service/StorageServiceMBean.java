...
import org.apache.apippi.utils.BreaksJMX;
...
public interface StorageServiceMBean extends NotificationEmitter
{
    ...
    /**
     * Fetch a string representation of the apippi version.
     * @return A string representation of the apippi version.
     */
    public String getReleaseVersion();

    /**
     * Fetch a string representation of the apippi git SHA.
     * @return A string representation of the apippi git SHA.
     */
     ...
     * @return status of parent repair from enum {@link org.apache.apippi.repair.RepairRunnable.Status}
     ...
     * @param dynamicUpdateInterval    integer, in ms (defaults to the value configured in apippi.yaml, which defaults to 100)
     * @param dynamicResetInterval     integer, in ms (defaults to the value configured in apippi.yaml, which defaults to 600,000)
     * @param dynamicBadnessThreshold  double, (defaults to the value configured in apippi.yaml, which defaults to 0.0)
     */
    ...
    // allows a user to forcibly completely stop apippi
     ...
     * Note this becomes false before {@link org.apache.apippi.db.SystemKeyspace#bootstrapComplete()} is called,
     ...
     * to avoid sending potentially multiple MB of data when accessing this mbean by default.  See apippi-4452.
     *
     ...
     * @param path Path where the full query log will be stored. If null apippi.yaml value is used.
     ...
     * Also delete any generated files in the last used full query log path as well as the one configure in apippi.yaml
     */
