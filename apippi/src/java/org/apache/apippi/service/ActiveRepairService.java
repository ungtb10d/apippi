...
import org.apache.apippi.locator.EndpointsByRange;
import org.apache.apippi.locator.EndpointsForRange;
import org.apache.apippi.utils.ExecutorUtils;
import org.apache.apippi.repair.state.CoordinatorState;
import org.apache.apippi.repair.state.ParticipateState;
import org.apache.apippi.repair.state.ValidationState;
import org.apache.apippi.utils.Simulate;
...
import org.apache.apippi.gms.ApplicationState;
...
import org.apache.apippi.repair.CommonRange;
import org.apache.apippi.repair.NoSuchRepairSessionException;
import org.apache.apippi.service.paxos.PaxosRepair;
import org.apache.apippi.service.paxos.cleanup.PaxosCleanup;
import org.apache.apippi.repair.RepairJobDesc;
import org.apache.apippi.repair.RepairParallelism;
import org.apache.apippi.repair.RepairSession;
import org.apache.apippi.repair.consistent.CoordinatorSessions;
import org.apache.apippi.repair.consistent.LocalSessions;
import org.apache.apippi.repair.consistent.admin.CleanupSummary;
import org.apache.apippi.repair.consistent.admin.PendingStats;
import org.apache.apippi.repair.consistent.admin.RepairStats;
import org.apache.apippi.repair.consistent.RepairedState;
import org.apache.apippi.repair.consistent.admin.SchemaArgsParser;
import org.apache.apippi.repair.messages.CleanupMessage;
import org.apache.apippi.repair.messages.PrepareMessage;
import org.apache.apippi.repair.messages.RepairMessage;
...
import org.apache.apippi.utils.MerkleTrees;
...
import static org.apache.apippi.config.Config.RepairCommandPoolFullStrategy.reject;
import static org.apache.apippi.config.DatabaseDescriptor.*;
import static org.apache.apippi.net.Message.out;
import static org.apache.apippi.net.Verb.PREPARE_MSG;
import static org.apache.apippi.utils.Clock.Global.currentTimeMillis;
import static org.apache.apippi.utils.Simulate.With.MONITORS;
...
public class ActiveRepairService implements IEndpointStateChangeSubscriber, IFailureDetectionEventListener, ActiveRepairServiceMBean
{
    ...
    public ActiveRepairService(IFailureDetector failureDetector, Gossiper gossiper)
    {
        ...
        this.repairStatusByCmd = CacheBuilder.newBuilder()
                                             .expireAfterWrite(
                                             Long.getLong("apippi.parent_repair_status_expiry_seconds",
                                             ...
                                             .maximumSize(Long.getLong("apippi.parent_repair_status_cache_size", 100_000))
                                             .build();
     ...
     * @param parentSessionId an identifier for an active parent repair session
     * @return the {@link ParentRepairSession} associated with the provided identifier
     * @see org.apache.apippi.db.repair.apippiTableRepairManager#snapshot(String, Collection, boolean)
     */
            ...
            for (TableMetadata table : tables)
            {
                ...
                if (!PaxosRepair.hasSufficientLiveNodesForTopologyChange(keyspace, range, endpoints))
                {
                    ...
                    throw new RuntimeException(String.format("Insufficient live nodes to repair paxos for %s in %s for %s.\n" +
                                                             ...
                                                             "the system property apippi.skip_paxos_repair_on_topology_change to false. The jmx property " +
                                                             ...
                                                             "system property apippi.skip_paxos_repair_on_topology_change_keyspaces, or temporarily with the jmx" +
                ...
                if (pending.size() > 1 && !Boolean.getBoolean("apippi.paxos_repair_allow_multiple_pending_unsafe"))
                {
                    throw new RuntimeException(String.format("Cannot begin paxos auto repair for %s in %s.%s, multiple pending endpoints exist for range (%s). " +
                                                             "Set -Dapippi.paxos_repair_allow_multiple_pending_unsafe=true to skip this check",
