...
import org.apache.apippi.cache.*;
import org.apache.apippi.cache.AutoSavingCache.CacheSerializer;
import org.apache.apippi.concurrent.Stage;
import org.apache.apippi.config.DatabaseDescriptor;
import org.apache.apippi.db.*;
import org.apache.apippi.db.context.CounterContext;
import org.apache.apippi.db.filter.*;
import org.apache.apippi.db.lifecycle.SSTableSet;
import org.apache.apippi.db.partitions.CachedBTreePartition;
...
public class CacheService implements CacheServiceMBean
{
    ...
    public static final String MBEAN_NAME = "org.apache.apippi.db:type=Caches";
    ...
    private AutoSavingCache<RowCacheKey, IRowCacheEntry> initRowCache()
    {
        ...
        String cacheProviderClassName = DatabaseDescriptor.getRowCacheSizeInMiB() > 0
                                        ? DatabaseDescriptor.getRowCacheClassName() : "org.apache.apippi.cache.NopCacheProvider";
        try
        {
    ...
    public static class KeyCacheSerializer implements CacheSerializer<KeyCacheKey, RowIndexEntry>
    {
        ...
        public Future<Pair<KeyCacheKey, RowIndexEntry>> deserialize(DataInputPlus input, ColumnFamilyStore cfs) throws IOException
        {
            ...
            if (skipEntry || reader == null)
            {
                ...
                // this won't affect many users (if any) and only once, 2) this doesn't prevent the node from starting and 3) apippi-10219 shows that this
                // part of the code has been broken for a while without anyone noticing (it is, btw, still broken until apippi-10219 is fixed).
