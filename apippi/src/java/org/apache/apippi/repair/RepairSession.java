...
import org.apache.apippi.repair.state.SessionState;
...
import org.apache.apippi.repair.consistent.ConsistentSession;
import org.apache.apippi.repair.consistent.LocalSession;
 ...
 *      ({@link org.apache.apippi.repair.ValidationTask}) and waits until all trees are received (in
 *      validationComplete()).
 *   </li>
 ...
 * roughly at the same time on every node (see apippi-2816). However the synchronization
