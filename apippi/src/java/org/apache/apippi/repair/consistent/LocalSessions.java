...
import org.apache.apippi.repair.KeyspaceRepairManager;
...
import static org.apache.apippi.net.Verb.FAILED_SESSION_MSG;
import static org.apache.apippi.net.Verb.FINALIZE_PROMISE_MSG;
import static org.apache.apippi.net.Verb.PREPARE_CONSISTENT_RSP;
import static org.apache.apippi.net.Verb.STATUS_REQ;
import static org.apache.apippi.net.Verb.STATUS_RSP;
import static org.apache.apippi.repair.consistent.ConsistentSession.State.*;
...
public class LocalSessions
{
     ...
     */
    static final int CHECK_STATUS_TIMEOUT = Integer.getInteger("apippi.repair_status_check_timeout_seconds",
     ...
     */
    static final int AUTO_FAIL_TIMEOUT = Integer.getInteger("apippi.repair_fail_timeout_seconds",
     ...
     */
    static final int AUTO_DELETE_TIMEOUT = Integer.getInteger("apippi.repair_delete_timeout_seconds",
                                                              Ints.checkedCast(TimeUnit.DAYS.toSeconds(1)));
    /**
     * How often LocalSessions.cleanup is run
     */
    public static final int CLEANUP_INTERVAL = Integer.getInteger("apippi.repair_cleanup_interval_seconds",
