...
import org.apache.apippi.metrics.MessagingMetrics;
...
import static org.apache.apippi.concurrent.Stage.MUTATION;
 ...
 * {@link org.apache.apippi.net.InboundMessageHandler.WaitQueue}, to be reactivated once more permits
 * become available.
 *
 ...
 *
 * See {@link org.apache.apippi.metrics.InternodeInboundMetrics} and
 * {@link org.apache.apippi.metrics.InternodeOutboundMetrics} for JMX-exposed counters.
 *
 * We also provide {@code system_views.internode_inbound} and {@code system_views.internode_outbound} virtual tables -
 * implemented in {@link org.apache.apippi.db.virtual.InternodeInboundTable} and
 * {@link org.apache.apippi.db.virtual.InternodeOutboundTable} respectively.
 */
public class MessagingService extends MessagingServiceMBeanImpl
{
    ...
    public <T> org.apache.apippi.utils.concurrent.Future<Message<T>> sendWithResult(Message message, InetAddressAndPort to)
    {
