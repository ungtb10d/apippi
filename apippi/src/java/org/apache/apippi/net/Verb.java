...
import org.apache.apippi.batchlog.BatchRemoveVerbHandler;
import org.apache.apippi.batchlog.BatchStoreVerbHandler;
...
import org.apache.apippi.db.CounterMutationVerbHandler;
import org.apache.apippi.db.Mutation;
import org.apache.apippi.db.MutationVerbHandler;
import org.apache.apippi.db.ReadCommand;
import org.apache.apippi.db.ReadCommandVerbHandler;
import org.apache.apippi.db.ReadRepairVerbHandler;
import org.apache.apippi.db.ReadResponse;
import org.apache.apippi.db.SnapshotCommand;
import org.apache.apippi.db.TruncateResponse;
import org.apache.apippi.db.TruncateVerbHandler;
import org.apache.apippi.db.TruncateRequest;
import org.apache.apippi.exceptions.RequestFailureReason;
import org.apache.apippi.gms.GossipDigestAck;
import org.apache.apippi.gms.GossipDigestAck2;
import org.apache.apippi.gms.GossipDigestAck2VerbHandler;
import org.apache.apippi.gms.GossipDigestAckVerbHandler;
import org.apache.apippi.gms.GossipDigestSyn;
import org.apache.apippi.gms.GossipDigestSynVerbHandler;
import org.apache.apippi.gms.GossipShutdownVerbHandler;
import org.apache.apippi.hints.HintMessage;
import org.apache.apippi.hints.HintVerbHandler;
import org.apache.apippi.io.IVersionedAsymmetricSerializer;
import org.apache.apippi.repair.RepairMessageVerbHandler;
import org.apache.apippi.repair.messages.CleanupMessage;
import org.apache.apippi.repair.messages.FailSession;
import org.apache.apippi.repair.messages.FinalizeCommit;
import org.apache.apippi.repair.messages.FinalizePromise;
import org.apache.apippi.repair.messages.FinalizePropose;
import org.apache.apippi.repair.messages.PrepareConsistentRequest;
import org.apache.apippi.repair.messages.PrepareConsistentResponse;
import org.apache.apippi.repair.messages.PrepareMessage;
import org.apache.apippi.repair.messages.SnapshotMessage;
import org.apache.apippi.repair.messages.StatusRequest;
import org.apache.apippi.repair.messages.StatusResponse;
import org.apache.apippi.repair.messages.SyncResponse;
import org.apache.apippi.repair.messages.SyncRequest;
import org.apache.apippi.repair.messages.ValidationResponse;
import org.apache.apippi.repair.messages.ValidationRequest;
import org.apache.apippi.schema.SchemaMutationsSerializer;
import org.apache.apippi.schema.SchemaPullVerbHandler;
import org.apache.apippi.schema.SchemaPushVerbHandler;
import org.apache.apippi.schema.SchemaVersionVerbHandler;
import org.apache.apippi.service.paxos.PaxosCommit;
import org.apache.apippi.service.paxos.PaxosCommitAndPrepare;
import org.apache.apippi.service.paxos.PaxosPrepare;
import org.apache.apippi.service.paxos.PaxosPrepareRefresh;
import org.apache.apippi.service.paxos.PaxosPropose;
import org.apache.apippi.service.paxos.PaxosRepair;
import org.apache.apippi.service.paxos.cleanup.PaxosCleanupHistory;
import org.apache.apippi.service.paxos.cleanup.PaxosCleanupRequest;
import org.apache.apippi.service.paxos.cleanup.PaxosCleanupResponse;
import org.apache.apippi.service.paxos.cleanup.PaxosCleanupComplete;
import org.apache.apippi.service.paxos.cleanup.PaxosStartPrepareCleanup;
import org.apache.apippi.service.paxos.cleanup.PaxosFinishPrepareCleanup;
import org.apache.apippi.utils.BooleanSerializer;
import org.apache.apippi.service.EchoVerbHandler;
import org.apache.apippi.service.SnapshotVerbHandler;
import org.apache.apippi.service.paxos.Commit;
import org.apache.apippi.service.paxos.Commit.Agreed;
import org.apache.apippi.service.paxos.PrepareResponse;
import org.apache.apippi.service.paxos.v1.PrepareVerbHandler;
import org.apache.apippi.service.paxos.v1.ProposeVerbHandler;
import org.apache.apippi.streaming.ReplicationDoneVerbHandler;
import org.apache.apippi.utils.TimeUUID;
import org.apache.apippi.utils.UUIDSerializer;

import static java.util.concurrent.TimeUnit.NANOSECONDS;
import static org.apache.apippi.concurrent.Stage.*;
import static org.apache.apippi.net.VerbTimeouts.*;
import static org.apache.apippi.net.Verb.Kind.*;
import static org.apache.apippi.net.Verb.Priority.*;
...
public enum Verb
{
     ...
     * intermediary byte[] (See apippi-3716), we need to wire that up to the CallbackInfo object
     * (see below).
     *
