...
import org.apache.apippi.cql3.BatchQueryOptions;
import org.apache.apippi.cql3.CQLStatement;
import org.apache.apippi.cql3.QueryEvents;
...
import org.apache.apippi.cql3.VariableSpecifications;
...
import org.apache.apippi.transport.CBUtil;
import org.apache.apippi.transport.Message;
import org.apache.apippi.transport.ProtocolException;
...
public class BatchMessage extends Message.Request
{
    ...
    private void traceQuery(QueryState state)
    {
        ...
        // TODO we don't have [typed] access to CQL bind variables here.  apippi-4560 is open to add support.
