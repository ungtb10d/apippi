...
final class ConnectionLimitHandler extends ChannelInboundHandlerAdapter
{
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception
    {
        ...
        if (count > limit)
        {
            ...
            noSpamLogger.error("Exceeded maximum native connection limit of {} by using {} connections (see native_transport_max_concurrent_connections in apippi.yaml)", limit, count);
            ctx.close();
        }
        else
        {
