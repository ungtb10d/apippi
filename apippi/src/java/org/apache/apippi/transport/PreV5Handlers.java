...
import static org.apache.apippi.transport.CQLMessageHandler.RATE_LIMITER_DELAY_UNIT;
import static org.apache.apippi.transport.ClientResourceLimits.GLOBAL_REQUEST_LIMITER;

public class PreV5Handlers
{
    /**
     * Wraps an {@link org.apache.apippi.transport.Dispatcher} so that it can be used as an
    ...
    /**
     * Simple adaptor to allow {@link org.apache.apippi.transport.Message.Decoder#decodeMessage(Channel, Envelope)}
    ...
    /**
     * Pre-V5 exception handler which closes the connection if an {@link org.apache.apippi.transport.ProtocolException}
     * is thrown
     */
    @ChannelHandler.Sharable
