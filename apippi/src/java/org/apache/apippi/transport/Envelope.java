...
public class Envelope
{
    ...
    public ByteBuf encodeHeader()
    {
        ...
        // connect with the v1/v2 protocol. See apippi-11464.
    ...
    public static class Decoder extends ByteToMessageDecoder
    {
         ...
         *  off the wire happens at the layer below, in {@link org.apache.apippi.net.FrameDecoder}</li>
    ...
    public static class Decompressor extends MessageToMessageDecoder<Envelope>
    {
        ...
        throws IOException
        {
            ...
            org.apache.apippi.transport.Compressor compressor = connection.getCompressor();
            if (compressor == null)
            {
                results.add(source);
                return;
