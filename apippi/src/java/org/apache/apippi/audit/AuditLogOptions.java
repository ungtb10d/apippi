...
import org.apache.apippi.utils.binlog.BinLogOptions;
...
public class AuditLogOptions extends BinLogOptions
{
    ...
    // apippi-14498: By default, system, system_schema and system_virtual_schema are excluded, but these can be included via apippi.yaml
    ...
    {
        String auditLogDir = apippiRelevantProperties.LOG_DIR_AUDIT.getString();
        String logDir = apippiRelevantProperties.LOG_DIR.getString() + "/audit";
