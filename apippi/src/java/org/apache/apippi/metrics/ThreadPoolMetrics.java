...
import org.apache.apippi.concurrent.ResizableThreadPool;
...
public class ThreadPoolMetrics
{
    ...
    {
        return new MetricName("org.apache.apippi.metrics",
                              "ThreadPools",
                              metricName,
                              path + '.' + poolName,
                              format("org.apache.apippi.metrics:type=ThreadPools,path=%s,scope=%s,name=%s",
