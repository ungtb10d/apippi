...
{
    public static final String GROUP_NAME = "org.apache.apippi.metrics";
    ...
    public static apippiMetricsRegistry.MetricName createMetricName(String type, String metricName, String scope)
    {
        return new apippiMetricsRegistry.MetricName(GROUP_NAME, type, metricName, scope, createDefaultMBeanName(type, metricName, scope));
    }
