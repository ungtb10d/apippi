...
import org.apache.apippi.utils.EstimatedHistogram;
...
public class TableMetrics
{
    ...
    /**
     * This histogram records the maximum number of rows {@link org.apache.apippi.service.reads.ReplicaFilteringProtection}
     ...
     * replica_filtering_protection thresholds in apippi.yaml.
     */
    ...
    {
        apippiMetricsRegistry.MetricName name = factory.createMetricName(tableMetricName);
        ...
        if (metric != null)
        {
            ...
            apippiMetricsRegistry.MetricName cfAlias = aliasFactory.createMetricName(cfMetricName);
    ...
    static class TableMetricNameFactory implements MetricNameFactory
    {
        ...
        public apippiMetricsRegistry.MetricName createMetricName(String metricName)
        {
            ...
            return new apippiMetricsRegistry.MetricName(groupName, type, metricName, keyspaceName + "." + tableName, mbeanName.toString());
        }
    }
    ...
    static class AllTableMetricNameFactory implements MetricNameFactory
    {
        ...
        public apippiMetricsRegistry.MetricName createMetricName(String metricName)
        {
            ...
            mbeanName.append("type=").append(type);
            mbeanName.append(",name=").append(metricName);
            return new apippiMetricsRegistry.MetricName(groupName, type, metricName, "all", mbeanName.toString());
        }
    }
