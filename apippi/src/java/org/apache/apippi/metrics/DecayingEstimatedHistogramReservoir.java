 ...
 * when logically adjacent buckets are updated. See apippi-15213.
 * <p/>
 * <ul>
...
public class DecayingEstimatedHistogramReservoir implements SnapshottingReservoir
{
    ...
    public static final int DEFAULT_STRIPE_COUNT = Integer.parseInt(System.getProperty("apippi.dehr_stripe_count", "2"));
