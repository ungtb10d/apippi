 ...
 */
package org.apache.apippi.index;
...
import org.apache.apippi.db.filter.ClusteringIndexSliceFilter;
...
import org.apache.apippi.index.Index.IndexBuildingSupport;
import org.apache.apippi.index.internal.apippiIndex;
import org.apache.apippi.index.transactions.*;
import org.apache.apippi.io.sstable.format.SSTableReader;
import org.apache.apippi.notifications.INotification;
import org.apache.apippi.notifications.INotificationConsumer;
import org.apache.apippi.notifications.SSTableAddedNotification;
...
import org.apache.apippi.service.pager.SinglePartitionPager;
...
import static org.apache.apippi.utils.ExecutorUtils.awaitTermination;
import static org.apache.apippi.utils.ExecutorUtils.shutdown;
 ...
 * added via {@link org.apache.apippi.notifications.SSTableAddedNotification}s, guaranteeing
 * the following:
 * <ul>
...
public class SecondaryIndexManager implements IndexRegistry, INotificationConsumer
{
    ...
    private Index createInstance(IndexMetadata indexDef)
    {
        ...
        {
            newIndex = apippiIndex.newIndex(baseCfs, indexDef);
        }
        return newIndex;
    }
    ...
    {
        if (Boolean.getBoolean("apippi.force_default_indexing_page_size"))
    ...
    public void deletePartition(UnfilteredRowIterator partition, int nowInSec)
    {
        ...
        // cause a race (see apippi-3712). This is done internally by the
