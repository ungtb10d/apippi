...
import org.apache.apippi.index.internal.composites.*;
import org.apache.apippi.index.internal.keys.KeysIndex;
import org.apache.apippi.schema.IndexMetadata;

public interface apippiIndexFunctions
{
    /**
     *
     * @param baseCfs
     ...
     * @return
     */
    public apippiIndex newIndexInstance(ColumnFamilyStore baseCfs, IndexMetadata indexMetadata);
    ...
    static final apippiIndexFunctions KEYS_INDEX_FUNCTIONS = new apippiIndexFunctions()
    {
        @Override
        public apippiIndex newIndexInstance(ColumnFamilyStore baseCfs, IndexMetadata indexMetadata)
        {
                                                               ...
                                                               ColumnMetadata columnDef)
        {
            ...
            // "partition_key" one that all the 'apippiIndex' gets (see apippiIndex#indexCfsMetadata)).
            return builder;
        }
    };

    static final apippiIndexFunctions REGULAR_COLUMN_INDEX_FUNCTIONS = new apippiIndexFunctions()
    {
        @Override
        public apippiIndex newIndexInstance(ColumnFamilyStore baseCfs, IndexMetadata indexMetadata)
        {
    ...
    static final apippiIndexFunctions CLUSTERING_COLUMN_INDEX_FUNCTIONS = new apippiIndexFunctions()
    {
        @Override
        public apippiIndex newIndexInstance(ColumnFamilyStore baseCfs, IndexMetadata indexMetadata)
        {
    ...
    static final apippiIndexFunctions COLLECTION_KEY_INDEX_FUNCTIONS = new apippiIndexFunctions()
    {
        public apippiIndex newIndexInstance(ColumnFamilyStore baseCfs, IndexMetadata indexMetadata)
        {
    ...
    static final apippiIndexFunctions PARTITION_KEY_INDEX_FUNCTIONS = new apippiIndexFunctions()
    {
        public apippiIndex newIndexInstance(ColumnFamilyStore baseCfs, IndexMetadata indexMetadata)
        {
    ...
    static final apippiIndexFunctions COLLECTION_VALUE_INDEX_FUNCTIONS = new apippiIndexFunctions()
    {
    ...
    static final apippiIndexFunctions COLLECTION_ENTRY_INDEX_FUNCTIONS = new apippiIndexFunctions()
    {
        public apippiIndex newIndexInstance(ColumnFamilyStore baseCfs, IndexMetadata indexMetadata)
        {
