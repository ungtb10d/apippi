...
public abstract class apippiIndexSearcher implements Index.Searcher
{
    private static final Logger logger = LoggerFactory.getLogger(apippiIndexSearcher.class);

    private final RowFilter.Expression expression;
    protected final apippiIndex index;
    protected final ReadCommand command;

    public apippiIndexSearcher(ReadCommand command,
