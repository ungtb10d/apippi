...
package org.apache.apippi.streaming.async;
...
import org.apache.apippi.streaming.StreamDeserializingTask;
import org.apache.apippi.streaming.StreamingChannel;
import org.apache.apippi.streaming.StreamingDataOutputPlus;
import org.apache.apippi.streaming.StreamSession;
import org.apache.apippi.streaming.messages.IncomingStreamMessage;
import org.apache.apippi.streaming.messages.OutgoingStreamMessage;
import org.apache.apippi.streaming.messages.StreamMessage;
import org.apache.apippi.utils.concurrent.ImmediateFuture;
import org.apache.apippi.utils.concurrent.Semaphore;
...
import static org.apache.apippi.config.Config.PROPERTY_PREFIX;
import static org.apache.apippi.streaming.StreamSession.createLogTag;
import static org.apache.apippi.streaming.messages.StreamMessage.serialize;
import static org.apache.apippi.streaming.messages.StreamMessage.serializedSize;
import static org.apache.apippi.utils.Clock.Global.nanoTime;
import static org.apache.apippi.utils.FBUtilities.getAvailableProcessors;
import static org.apache.apippi.utils.JVMStabilityInspector.inspectThrowable;
import static org.apache.apippi.utils.concurrent.BlockingQueues.newBlockingQueue;
import static org.apache.apippi.utils.concurrent.Semaphore.newFairSemaphore;
 ...
 *
 * - we've exceeded our network I/O use due to rate limiting (at the apippi level)
 * - the receiver isn't keeping up, which causes the local TCP socket buffer to not empty, which causes epoll writes to not
 * move any bytes to the socket, which causes buffers to stick around in user-land (a/k/a apippi) memory.
 *
