 ...
 * That protocol is described in the package-level documentation for {@link org.apache.apippi.net.async}, and
 * thus not here.
 *
 * Streaming 2.0 was implemented as apippi-5286. Streaming 2.0 used (the equivalent of) a single thread and
 ...
 *
 * The full details of the session lifecycle are documented in {@link org.apache.apippi.streaming.StreamSession}.
 *
 */
