...
import static org.apache.apippi.config.apippiRelevantEnv.JAVA_HOME;
            ...
            try
            {
                if (DatabaseDescriptor.getDumpHeapOnUncaughtException())
                {
                    ...
                    if (absoluteBasePath == null)
                    {
                        ...
                        throw new RuntimeException("Cannot create heap dump unless -XX:HeapDumpPath or apippi.yaml:heap_dump_path is specified.");
                    }
