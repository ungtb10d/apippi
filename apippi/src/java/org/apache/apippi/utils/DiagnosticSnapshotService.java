 ...
 * (apippi-15789) during a read, a snapshot request will be issued to all participating replicas. If detected during
 ...
 * of the replica set. This window is configurable via a system property (apippi.diagnostic_snapshot_interval_nanos),
...
public class DiagnosticSnapshotService
{
    ...
    private void maybeTriggerSnapshot(TableMetadata metadata, String prefix, Iterable<InetAddressAndPort> endpoints)
    {
        ...
        long interval = Long.getLong("apippi.diagnostic_snapshot_interval_nanos", SNAPSHOT_INTERVAL_NANOS);
