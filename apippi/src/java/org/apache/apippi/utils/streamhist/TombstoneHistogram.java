 ...
 */
package org.apache.apippi.utils.streamhist;
...
import org.apache.apippi.utils.streamhist.StreamingTombstoneHistogramBuilder.DataHolder;
...
public class TombstoneHistogram
{
    ...
    public static class HistogramSerializer implements ISerializer<TombstoneHistogram>
    {
        ...
        public TombstoneHistogram deserialize(DataInputPlus in) throws IOException
        {
            ...
            {
                // Already serialized sstable metadata may contain negative deletion-time values (see apippi-14092).
