...
package org.apache.apippi.utils.logging;
...
import org.apache.apippi.audit.FileAuditLogger;
import org.apache.apippi.db.virtual.LogMessagesTable;
import org.apache.apippi.db.virtual.VirtualKeyspace;
import org.apache.apippi.db.virtual.VirtualKeyspaceRegistry;
import org.apache.apippi.db.virtual.VirtualTable;

import static org.apache.apippi.db.virtual.LogMessagesTable.LOGS_VIRTUAL_TABLE_DEFAULT_ROWS;
import static org.apache.apippi.db.virtual.LogMessagesTable.TABLE_NAME;
import static org.apache.apippi.schema.SchemaConstants.VIRTUAL_VIEWS;

/**
 * Appends apippi logs to virtual table system_views.system_logs
 */
public final class VirtualTableAppender extends AppenderBase<LoggingEvent>
{
     ...
     *
     * @see org.apache.apippi.service.apippiDaemon#setupVirtualKeyspaces
     */
