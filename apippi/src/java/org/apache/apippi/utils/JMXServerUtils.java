...
import org.apache.apippi.auth.jmx.AuthenticationProxy;

import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_ACCESS_FILE;
import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_AUTHENTICATE;
import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_PASSWORD_FILE;
import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_RMI_PORT;
import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_SSL;
import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_SSL_ENABLED_CIPHER_SUITES;
import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_SSL_ENABLED_PROTOCOLS;
import static org.apache.apippi.config.apippiRelevantProperties.COM_SUN_MANAGEMENT_JMXREMOTE_SSL_NEED_CLIENT_AUTH;
...
public class JMXServerUtils
{
    ...
    private static Map<String, Object> configureJmxAuthentication()
    {
        ...
        // apippi's own custom JMXAuthenticator implementation which delegates
        ...
        String configEntry = System.getProperty("apippi.jmx.remote.login.config");
        if (configEntry != null)
        {
    ...
    {
        // If a custom authz proxy is supplied (apippi ships with AuthorizationProxy, which
        ...
        String authzProxyClass = System.getProperty("apippi.jmx.authorizer");
