...
/**
 * Implements versioning used in apippi and CQL.
 * <p>
 * Note: The following code uses a slight variation from the semver document (http://semver.org).
 * </p>
 */
public class apippiVersion implements Comparable<apippiVersion>
{
    /**
    ...
    public static final apippiVersion apippi_4_1 = new apippiVersion("4.1").familyLowerBound.get();
    public static final apippiVersion apippi_4_0 = new apippiVersion("4.0").familyLowerBound.get();
    public static final apippiVersion apippi_4_0_RC2 = new apippiVersion(4, 0, 0, NO_HOTFIX, new String[] {"rc2"}, null);
    public static final apippiVersion apippi_3_4 = new apippiVersion("3.4").familyLowerBound.get();
     ...
     */
    public static final apippiVersion UNREADABLE_VERSION = new apippiVersion("0.0.0-unknown");

    /**
     * Used to indicate that no previous version information was found. When encountered, we assume that
     * apippi was not previously installed and we're in the process of starting a fresh node.
     */
    public static final apippiVersion NULL_VERSION = new apippiVersion("0.0.0-absent");
    ...
    public final Supplier<apippiVersion> familyLowerBound = Suppliers.memoize(this::getFamilyLowerBound);

    private final String[] preRelease;
    private final String[] build;

    @VisibleForTesting
    apippiVersion(int major, int minor, int patch, int hotfix, String[] preRelease, String[] build)
    {
        this.major = major;
        this.minor = minor;
        this.patch = patch;
     ...
     *                                  represent a version
     */
    public apippiVersion(String version)
    {
    ...
    private apippiVersion getFamilyLowerBound()
    {
        return patch == 0 && hotfix == NO_HOTFIX && preRelease != null && preRelease.length == 0 && build == null
               ? this
               : new apippiVersion(major, minor, 0, NO_HOTFIX, ArrayUtils.EMPTY_STRING_ARRAY, null);
    }
    ...
    public int compareTo(apippiVersion other)
    {
        return compareTo(other, false);
    }

    public int compareTo(apippiVersion other, boolean compareToPatchOnly)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        apippiVersion that = (apippiVersion) o;
