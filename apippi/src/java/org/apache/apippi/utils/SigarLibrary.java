...
public class SigarLibrary
{
    ...
    public void warnIfRunningInDegradedMode()
    {
        if (initialized)
        {
            ...
            if (swapEnabled || !goodAddressSpace || !goodFileLimits || !goodProcNumber || apippiRelevantProperties.TEST_IGNORE_SIGAR.getBoolean())
            {
                logger.warn("apippi server running in degraded mode. Is swap disabled? : {},  Address space adequate? : {}, " +
