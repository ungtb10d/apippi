...
public abstract class MemtablePool
{
    ...
    MemtablePool(long maxOnHeapMemory, long maxOffHeapMemory, float cleanThreshold, MemtableCleaner cleaner)
    {
        ...
        blockedOnAllocating = apippiMetricsRegistry.Metrics.timer(nameFactory.createMetricName("BlockedOnAllocation"));
        numPendingTasks = apippiMetricsRegistry.Metrics.register(nameFactory.createMetricName("PendingFlushTasks"),
