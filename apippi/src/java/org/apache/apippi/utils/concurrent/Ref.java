...
import org.apache.apippi.io.util.Memory;
import org.apache.apippi.io.util.SafeMemory;
...
public final class Ref<T> implements RefCounted<T>
{
    ...
    public static final boolean DEBUG_ENABLED = System.getProperty("apippi.debugrefcount", "false").equalsIgnoreCase("true");
