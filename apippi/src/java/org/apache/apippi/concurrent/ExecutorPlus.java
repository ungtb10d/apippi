...
/**
 * apippi's extension of {@link ExecutorService}, using our own {@link Future}, supporting
...
public interface ExecutorPlus extends ExecutorService, ResizableThreadPool
{
    ...
    /**
     * Overrides {@link ExecutorService#submit(Callable)} to return a apippi {@link Future}
     */
    @Override
    <T> Future<T> submit(Callable<T> task);

    /**
     * Overrides {@link ExecutorService#submit(Runnable, Object)} to return a apippi {@link Future}
     */
    @Override
    <T> Future<T> submit(Runnable task, T result);

    /**
     * Overrides {@link ExecutorService#submit(Runnable)} to return a apippi {@link Future}
     */
    @Override
     ...
     * the global Tracing sessions; see apippi-5668)
     * ==============================================
     */
