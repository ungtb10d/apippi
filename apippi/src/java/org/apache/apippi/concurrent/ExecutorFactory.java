...
import static org.apache.apippi.concurrent.ExecutorFactory.SimulatorSemantics.NORMAL;
import static org.apache.apippi.concurrent.InfiniteLoopExecutor.Daemon.DAEMON;
import static org.apache.apippi.concurrent.InfiniteLoopExecutor.Interrupts.UNSYNCHRONIZED;
import static org.apache.apippi.concurrent.NamedThreadFactory.createThread;
import static org.apache.apippi.concurrent.NamedThreadFactory.setupThread;
import static org.apache.apippi.concurrent.ThreadPoolExecutorBuilder.pooledJmx;
import static org.apache.apippi.concurrent.ThreadPoolExecutorBuilder.sequentialJmx;
...
public interface ExecutorFactory extends ExecutorBuilderFactory.Jmxable<ExecutorPlus, SequentialExecutorPlus>
{
     ...
     *                   See: {@link org.apache.apippi.db.commitlog.AbstractCommitLogSegmentManager::start}
     * @return the new thread
     */
