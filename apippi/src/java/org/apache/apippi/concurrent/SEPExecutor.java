...
import static org.apache.apippi.concurrent.SEPExecutor.TakeTaskPermitResult.*;
import static org.apache.apippi.concurrent.SEPWorker.Work;
...
public class SEPExecutor implements LocalAwareExecutorPlus, SEPExecutorMBean
{
    ...
    SEPExecutor(SharedExecutorPool pool, int maximumPoolSize, MaximumPoolSizeListener maximumPoolSizeListener, String jmxPath, String name)
    {
        this.pool = pool;
        this.name = name;
        this.mbeanName = "org.apache.apippi." + jmxPath + ":type=" + name;
