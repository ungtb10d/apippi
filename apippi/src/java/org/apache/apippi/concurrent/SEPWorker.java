...
import static org.apache.apippi.concurrent.SEPExecutor.TakeTaskPermitResult.RETURNED_WORK_PERMIT;
import static org.apache.apippi.concurrent.SEPExecutor.TakeTaskPermitResult.TOOK_PERMIT;
...
final class SEPWorker extends AtomicReference<SEPWorker.Work> implements Runnable
{
    ...
    private static final boolean SET_THREAD_NAME = Boolean.parseBoolean(System.getProperty("apippi.set_sep_thread_name", "true"));
