 ...
 */
package org.apache.apippi.cache;
...
public class AutoSavingCache<K extends CacheKey, V> extends InstrumentingCache<K, V>
{
    ...
    /*
     * apippi-10155 required a format change to fix 2i indexes and caching.
     ...
     *
     * "e" introduced with apippi-11206, omits IndexInfo from key-cache, stores offset into index-file
     *
     * "f" introduced with apippi-9425, changes "keyspace.table.index" in cache keys to TableMetadata.id+TableMetadata.indexName
     */
    ...
    // Unused, but exposed for a reason. See apippi-8096.
