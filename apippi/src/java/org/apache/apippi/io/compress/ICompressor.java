...
{
    /**
     * Ways that a particular instance of ICompressor should be used internally in apippi.
     *
    ...
    /**
     * Hints to apippi which uses this compressor is recommended for. For example a compression algorithm which gets
     ...
     *
     * Note that apippi may ignore these recommendations, it is not a strict contract.
     */
