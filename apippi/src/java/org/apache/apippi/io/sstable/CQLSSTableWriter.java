...
import org.apache.apippi.cql3.functions.types.UserType;
...
public class CQLSSTableWriter implements Closeable
{
    ...
    static
    {
        System.setProperty("apippi.schema.force_load_local_keyspaces", "true");
    ...
    public UserType getUDType(String dataType)
    {
        ...
        org.apache.apippi.db.marshal.UserType userType = ksm.types.getNullable(ByteBufferUtil.bytes(dataType));
