...
import org.apache.apippi.io.sstable.format.SSTableReaderBuilder;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import org.apache.apippi.db.*;
import org.apache.apippi.db.columniterator.SSTableIterator;
import org.apache.apippi.db.columniterator.SSTableReversedIterator;
...
import org.apache.apippi.io.sstable.format.SSTableReadsListener.SelectionReason;
import org.apache.apippi.io.sstable.format.SSTableReadsListener.SkippingReason;
            ...
            while (!in.isEOF())
            {
                ...
                if (opSatisfied)
                {
                    ...
                    if (exactMatch && updateCacheAndStats)
                    {
                        ...
                        {
                            // expensive sanity check!  see apippi-4687
