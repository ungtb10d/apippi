...
import org.apache.apippi.io.sstable.format.*;
...
public class BigFormat implements SSTableFormat
{
    ...
    //
    // Minor versions were introduced with version "hb" for apippi 1.0.3; prior to that,
    ...
    static class BigVersion extends Version
    {
        ...
        /**
         * apippi-9067: 4.0 bloom filter representation changed (two longs just swapped)
