 ...
 */
package org.apache.apippi.io.sstable.format;
...
import org.apache.apippi.db.rows.UnfilteredSource;
...
import org.apache.apippi.cache.InstrumentingCache;
import org.apache.apippi.cache.KeyCacheKey;
...
import org.apache.apippi.exceptions.UnknownColumnException;
import org.apache.apippi.io.FSError;
...
import org.apache.apippi.io.sstable.*;
import org.apache.apippi.io.sstable.metadata.*;
import org.apache.apippi.io.util.*;
...
import static org.apache.apippi.db.Directories.SECONDARY_INDEX_NAME_SEPARATOR;
...
public abstract class SSTableReader extends SSTable implements UnfilteredSource, SelfRefCounted<SSTableReader>
{
    ...
    private static final boolean TRACK_ACTIVITY = apippiRelevantProperties.DISABLE_SSTABLE_ACTIVITY_TRACKING.getBoolean();
    ...
    public static SSTableReader openForBatch(Descriptor descriptor, Set<Component> components, TableMetadataRef metadata)
    {
        ...
        {
            logger.error("Cannot open {}; partitioner {} does not match system partitioner {}.  Note that the default partitioner starting with apippi 1.2 is Murmur3Partitioner, so you will need to edit that to match your old partitioner if upgrading.",
    ...
    /**
     * Execute provided task with sstable lock to avoid racing with index summary redistribution, SEE apippi-15861.
     *
