 ...
 */
package org.apache.apippi.io.sstable.format.big;
...
import org.apache.apippi.io.compress.CompressedSequentialWriter;
import org.apache.apippi.io.compress.ICompressor;
...
import org.apache.apippi.utils.concurrent.SharedCloseableImpl;
import org.apache.apippi.utils.concurrent.Transactional;
...
public class BigTableWriter extends SSTableWriter
{
     ...
     * @param opType
     * @return {@link org.apache.apippi.schema.CompressionParams}
     */
    private CompressionParams compressionFor(final OperationType opType)
    {
        ...
        if (null != compressor && opType == OperationType.FLUSH)
        {
            ...
            // compression algorithm indicates we should. See apippi-15379 for more details.
