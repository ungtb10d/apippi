...
import org.apache.apippi.io.compress.*;
...
public final class CompressionParams
{
    ...
    public static final CompressionParams DEFAULT = !apippiRelevantProperties.DETERMINISM_SSTABLE_COMPRESSION_DEFAULT.getBoolean()
                                                    ? noCompression()
    ...
    private static Class<?> parseCompressorClass(String className) throws ConfigurationException
    {
        ...
        className = className.contains(".") ? className : "org.apache.apippi.io.compress." + className;
        try
        {
    ...
    static class Serializer implements IVersionedSerializer<CompressionParams>
    {
        ...
        public CompressionParams deserialize(DataInputPlus in, int version) throws IOException
        {
            ...
            int minCompressRatio = Integer.MAX_VALUE;   // Earlier apippi cannot use uncompressed chunks.
            if (version >= MessagingService.VERSION_40)
