...
import static org.apache.apippi.schema.IndexMetadata.isNameValid;
...
public class TableMetadata implements SchemaElement
{
    ...
    public TableMetadata updateIndexTableMetadata(TableParams baseTableParams)
    {
        ...
        // Row caching is never enabled; see apippi-5732
     ...
     *
     * For non-composite types it returns the result of {@link org.apache.apippi.cql3.CQL3Type#toCQLLiteral}
     * applied to the partition key.
     * For composite types it applies {@link org.apache.apippi.cql3.CQL3Type#toCQLLiteral} to each subkey and
