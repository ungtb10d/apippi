...
import org.apache.apippi.config.InheritingClass;
import org.apache.apippi.config.ParameterizedClass;
import org.apache.apippi.db.memtable.Memtable;
import org.apache.apippi.db.memtable.SkipListMemtableFactory;
...
public final class MemtableParams
{
    ...
    private static Memtable.Factory getMemtableFactory(ParameterizedClass options)
    {
        ...
        className = className.contains(".") ? className : "org.apache.apippi.db.memtable." + className;
        try
        {
