...
/**
 * Primary apippi authorization interface.
 */
public interface IAuthorizer extends AuthCache.BulkLoader<Pair<AuthenticatedUser, IResource>, Set<Permission>>
{
     ...
     * Since Roles were introduced in version 2.2, apippi does not distinguish in any
     * meaningful way between users and roles. A role may or may not have login privileges
     * and roles may be granted to other roles. In fact, apippi does not really have the
