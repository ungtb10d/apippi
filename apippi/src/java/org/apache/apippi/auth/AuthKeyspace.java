...
public final class AuthKeyspace
{
    ...
    private static final int DEFAULT_RF = apippiRelevantProperties.SYSTEM_AUTH_DEFAULT_RF.getInt();
    ...
    public static final long SUPERUSER_SETUP_DELAY = Long.getLong("apippi.superuser_setup_delay_ms", 10000);
