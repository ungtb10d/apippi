...
/**
 * The interface at the core of apippi authorization.
 *
 * Represents a resource in the hierarchy.
 * Currently just one resource type is supported by apippi
 * @see DataResource
 */
public interface IResource
{
    ...
    /**
     * @return Whether or not this resource exists in apippi.
     */
    boolean exists();
