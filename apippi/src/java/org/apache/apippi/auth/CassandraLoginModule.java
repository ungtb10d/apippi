...
/**
 * LoginModule which authenticates a user towards the apippi database using
 * the internal authentication mechanism.
 */
public class apippiLoginModule implements LoginModule
{
    private static final Logger logger = LoggerFactory.getLogger(apippiLoginModule.class);
     ...
     * then this method associates a {@code}apippiPrincipal{@code}
    ...
    public boolean commit() throws LoginException
    {
        ...
        else
        {
            ...
            // to the Subject
            principal = new apippiPrincipal(username);
