...
import org.apache.apippi.cql3.UntypedResultSet.Row;
...
/**
 * apippiAuthorizer is an IAuthorizer implementation that keeps
 * user permissions internally in C* using the system_auth.role_permissions
 * table.
 */
public class apippiAuthorizer implements IAuthorizer
{
    private static final Logger logger = LoggerFactory.getLogger(apippiAuthorizer.class);
    ...
    public void revokeAllFrom(RoleResource revokee)
    {
        ...
        {
            logger.warn(String.format("apippiAuthorizer failed to revoke all permissions of %s", revokee.getRoleName()), e);
        }
    }
    ...
    public void revokeAllOn(IResource droppedResource)
    {
        ...
        {
            logger.warn(String.format("apippiAuthorizer failed to revoke all permissions on %s", droppedResource), e);
        }
    }
