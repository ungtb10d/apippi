...
public class AuthCache<K, V> implements AuthCacheMBean, Shutdownable
{
    ...
    public static final String MBEAN_NAME_BASE = "org.apache.apippi.auth:type=";

    // We expect default values on cache retries and interval to be sufficient for everyone but have this escape hatch
    // just in case.
    static final String CACHE_LOAD_RETRIES_PROPERTY = "apippi.auth_cache.warming.max_retries";
    static final String CACHE_LOAD_RETRY_INTERVAL_PROPERTY = "apippi.auth_cache.warming.retry_interval_ms";
    ...
    {
        if (Boolean.getBoolean("apippi.disable_auth_caches_remote_configuration"))
