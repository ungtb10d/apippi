...
import org.apache.apippi.exceptions.AuthenticationException;
...
import static org.apache.apippi.auth.apippiRoleManager.consistencyForRoleRead;
 ...
 * PasswordAuthenticator requires the use of apippiRoleManager
...
public class PasswordAuthenticator implements IAuthenticator, AuthCache.BulkLoader<String, String>
{
    ...
    public Supplier<Map<String, String>> bulkLoader()
    {
        return () ->
        {
            ...
            UntypedResultSet results = process("SELECT role, salted_hash FROM system_auth.roles", apippiAuthorizer.authReadConsistencyLevel());
            results.forEach(row -> {
    ...
    {
        // Also protected by apippiRoleManager, but the duplication doesn't hurt and is more explicit
    ...
    private class PlainTextSaslAuthenticator implements SaslNegotiator
    {
         ...
         * @throws org.apache.apippi.exceptions.AuthenticationException if either the
