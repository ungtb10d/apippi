 ...
 */
public class apippiPrincipal implements Principal, Serializable
{
     ...
     *                  is <code>null</code>.
     */
    public apippiPrincipal(String name)
    {
        if (name == null)
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof apippiPrincipal))
            return false;
        apippiPrincipal that = (apippiPrincipal) o;
