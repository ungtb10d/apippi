...
public class apippiNetworkAuthorizer implements INetworkAuthorizer
{
    private static final Logger logger = LoggerFactory.getLogger(apippiNetworkAuthorizer.class);
    ...
    {
        QueryOptions options = QueryOptions.forInternalCalls(apippiAuthorizer.authReadConsistencyLevel(),
    ...
    public void setRoleDatacenters(RoleResource role, DCPermissions permissions)
    {
        ...
        process(query, apippiAuthorizer.authWriteConsistencyLevel());
    }
