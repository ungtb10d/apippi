...
public final class AuthConfig
{
    ...
    public static void applyAuth()
    {
        ...
        if (conf.role_manager != null)
            ...
            roleManager = new apippiRoleManager();

        if (authenticator instanceof PasswordAuthenticator && !(roleManager instanceof apippiRoleManager))
            throw new ConfigurationException("apippiRoleManager must be used with PasswordAuthenticator", false);
