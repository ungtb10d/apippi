...
import org.apache.apippi.cql3.restrictions.StatementRestrictions;
import org.apache.apippi.cql3.selection.RawSelector;
import org.apache.apippi.cql3.selection.ResultSetBuilder;
import org.apache.apippi.cql3.selection.Selectable;
import org.apache.apippi.cql3.selection.Selectable.WithFunction;
import org.apache.apippi.cql3.selection.Selection;
import org.apache.apippi.cql3.selection.Selection.Selectors;
import org.apache.apippi.cql3.selection.Selector;
import org.apache.apippi.db.*;
import org.apache.apippi.db.aggregation.AggregationSpecification;
import org.apache.apippi.db.aggregation.GroupMaker;
import org.apache.apippi.db.filter.*;
...
import org.apache.apippi.db.view.View;
...
import org.apache.apippi.service.pager.AggregationQueryPager;
import org.apache.apippi.service.pager.PagingState;
import org.apache.apippi.service.pager.QueryPager;
...
import static org.apache.apippi.cql3.statements.RequestValidations.checkFalse;
import static org.apache.apippi.cql3.statements.RequestValidations.checkNotNull;
import static org.apache.apippi.cql3.statements.RequestValidations.checkNull;
import static org.apache.apippi.cql3.statements.RequestValidations.checkTrue;
import static org.apache.apippi.cql3.statements.RequestValidations.invalidRequest;
import static org.apache.apippi.utils.ByteBufferUtil.UNSET_BYTE_BUFFER;
...
public class SelectStatement implements CQLStatement.SingleKeyspaceCqlStatement
{
    ...
    {
        // Note: getRequestedColumns don't handle static columns, but due to apippi-5762
    ...
    public static class RawStatement extends QualifiedStatement
    {
        ...
        public SelectStatement prepare(boolean forView) throws InvalidRequestException
        {
            ...
            // even if we don't ultimately ship them to the client (apippi-4911).
