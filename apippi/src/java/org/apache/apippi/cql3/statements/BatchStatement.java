...
import org.apache.apippi.metrics.BatchMetrics;
...
public class BatchStatement implements CQLStatement
{
    ...
    @Override
    public Iterable<org.apache.apippi.cql3.functions.Function> getFunctions()
    {
        List<org.apache.apippi.cql3.functions.Function> functions = new ArrayList<>();
    ...
    private void verifyBatchType(Collection<? extends IMutation> mutations)
    {
        if (!isLogged() && mutations.size() > 1)
        {
            ...
            // apippi-11529: log only if we have more than a threshold of keys, this was also suggested in the
            // original ticket that introduced this warning, apippi-9282
