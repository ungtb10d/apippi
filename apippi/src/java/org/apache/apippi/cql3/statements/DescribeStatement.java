...
import org.apache.apippi.db.KeyspaceNotDefinedException;
...
import static org.apache.apippi.cql3.statements.RequestValidations.checkNotEmpty;
...
public abstract class DescribeStatement<T> extends CQLStatement.Raw implements CQLStatement
{
    ...
    public ResultMessage executeLocally(QueryState state, QueryOptions options)
    {
        ...
        // completes within a few seconds. This seems good enough for now. Once apippi actually supports
    ...
    public static DescribeStatement<List<Object>> cluster()
    {
        return new DescribeStatement<List<Object>>()
        {
            ...
            protected Stream<List<Object>> describe(ClientState state, Keyspaces keyspaces)
            {
                ...
                list.add(trimIfPresent(DatabaseDescriptor.getPartitionerName(), "org.apache.apippi.dht."));
                list.add(trimIfPresent(DatabaseDescriptor.getEndpointSnitch().getClass().getName(),
                                            "org.apache.apippi.locator."));
