...
public final class CreateViewStatement extends AlterSchemaStatement
{
    ...
    public Keyspaces apply(Keyspaces schema)
    {
        if (!DatabaseDescriptor.getMaterializedViewsEnabled())
            throw ire("Materialized views are disabled. Enable in apippi.yaml to use.");
        ...
        if (!restrictedNonPrimaryKeyColumns.isEmpty() && !Boolean.getBoolean("apippi.mv.allow_filtering_nonkey_columns_unsafe"))
        {
