...
import org.apache.apippi.concurrent.ThreadPoolExecutorJMXAdapter;
import org.apache.apippi.concurrent.NamedThreadFactory;
import org.apache.apippi.concurrent.ThreadPoolExecutorBase;
...
{
    private static final int KEEPALIVE = Integer.getInteger("apippi.udf_executor_thread_keepalive_ms", 30000);
