...
import static org.apache.apippi.cql3.functions.TimeFcts.*;
...
public final class CastFcts
{
    ...
    public static Collection<Function> all()
    {
        ...
        functions.add(apippiFunctionWrapper.create(TimeUUIDType.instance, SimpleDateType.instance, toDate(TimeUUIDType.instance)));
        functions.add(apippiFunctionWrapper.create(TimeUUIDType.instance, TimestampType.instance, toTimestamp(TimeUUIDType.instance)));
        ...
        functions.add(apippiFunctionWrapper.create(TimestampType.instance, SimpleDateType.instance, toDate(TimestampType.instance)));
        ...
        functions.add(apippiFunctionWrapper.create(SimpleDateType.instance, TimestampType.instance, toTimestamp(SimpleDateType.instance)));
     ...
     * @param <O> the output parameter
     */
    private static final class apippiFunctionWrapper<I, O> extends CastFunction<I, O>
    {
        /**
        ...
        public static <I, O> apippiFunctionWrapper<I, O> create(AbstractType<I> inputType,
                                                                   AbstractType<O> outputType,
                                                                   NativeScalarFunction delegate)
        {
            return new apippiFunctionWrapper<I, O>(inputType, outputType, delegate);
        }

        private apippiFunctionWrapper(AbstractType<I> inputType,
                                         AbstractType<O> outputType,
                                         NativeScalarFunction delegate)
        {
            super(inputType, outputType);
