...
import org.apache.apippi.cql3.functions.types.exceptions.CodecNotFoundException;
...
public interface GettableByIndexData
{
     ...
     * instances, and a CQL {@code NULL} will be mapped to an empty collection (note that apippi
     ...
     * mutability nor its thread-safety. Furthermore, the behavior of this method in respect to CQL
     * {@code NULL} values is also codec-dependent. By default, the driver will return mutable
     * instances, and a CQL {@code NULL} will mapped to an empty collection (note that apippi makes
