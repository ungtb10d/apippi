...
/**
 * Data types supported by apippi.
 */
public abstract class DataType
{
     ...
     *
     * <p>A custom type is defined by the name of the class used on the apippi side to implement
    ...
    /**
     * Returns the Duration type, introduced in apippi 3.10.
     *
     ...
     * serialized as a single value in apippi's storage engine, whereas non-frozen types are stored
