...
import org.apache.apippi.cql3.functions.types.*;
...
public final class UDFContextImpl implements UDFContext
{
    ...
    {
        Optional<org.apache.apippi.db.marshal.UserType> udtType = keyspaceMetadata.types.get(ByteBufferUtil.bytes(udtName));
