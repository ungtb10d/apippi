...
import org.apache.apippi.cql3.functions.types.exceptions.InvalidTypeException;
...
import static org.apache.apippi.cql3.functions.types.DataType.*;
...
public abstract class TypeCodec<T>
{
     ...
     * providing a (very lightweight) support for apippi types that do not have a CQL equivalent.
     *
     ...
     * org.apache.apippi.db.marshal.AbstractCompositeType}, whose CQL literals are actually
