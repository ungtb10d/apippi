...
import org.apache.apippi.security.SecurityThreadGroup;
...
{
    private static final String BASE_PACKAGE = "org.apache.apippi.cql3.udf.gen";
            ...
            if ((i & 1) == 1)
            {
                switch (s)
                {
                    ...
                    case "body":
                        ...
                        s = patternJavaDriver.matcher(body).replaceAll("org.apache.apippi.cql3.functions.types.");
                        break;
                    case "arguments":
