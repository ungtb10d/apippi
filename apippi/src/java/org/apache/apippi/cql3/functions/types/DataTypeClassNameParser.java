 ...
 */
package org.apache.apippi.cql3.functions.types;
...
import org.apache.apippi.cql3.functions.types.exceptions.DriverInternalError;
import org.apache.apippi.cql3.functions.types.utils.Bytes;

/*
 * Parse data types from schema tables, for apippi 3.0 and above.
 * In these versions, data types appear as class names, like "org.apache.apippi.db.marshal.AsciiType"
 * or "org.apache.apippi.db.marshal.TupleType(org.apache.apippi.db.marshal.Int32Type,org.apache.apippi.db.marshal.Int32Type)".
 *
 * This is modified (and simplified) from apippi's TypeParser class to suit
 ...
 * problem because in theory we'll only parse class names coming from apippi and
...
public class DataTypeClassNameParser
{
    ...
    private static final String REVERSED_TYPE = "org.apache.apippi.db.marshal.ReversedType";
    private static final String FROZEN_TYPE = "org.apache.apippi.db.marshal.FrozenType";
    private static final String LIST_TYPE = "org.apache.apippi.db.marshal.ListType";
    private static final String SET_TYPE = "org.apache.apippi.db.marshal.SetType";
    private static final String MAP_TYPE = "org.apache.apippi.db.marshal.MapType";
    private static final String UDT_TYPE = "org.apache.apippi.db.marshal.UserType";
    private static final String TUPLE_TYPE = "org.apache.apippi.db.marshal.TupleType";
    private static final String DURATION_TYPE = "org.apache.apippi.db.marshal.DurationType";

    private static final ImmutableMap<String, DataType> cassTypeToDataType =
    new ImmutableMap.Builder<String, DataType>()
    .put("org.apache.apippi.db.marshal.AsciiType", DataType.ascii())
    .put("org.apache.apippi.db.marshal.LongType", DataType.bigint())
    .put("org.apache.apippi.db.marshal.BytesType", DataType.blob())
    .put("org.apache.apippi.db.marshal.BooleanType", DataType.cboolean())
    .put("org.apache.apippi.db.marshal.CounterColumnType", DataType.counter())
    .put("org.apache.apippi.db.marshal.DecimalType", DataType.decimal())
    .put("org.apache.apippi.db.marshal.DoubleType", DataType.cdouble())
    .put("org.apache.apippi.db.marshal.FloatType", DataType.cfloat())
    .put("org.apache.apippi.db.marshal.InetAddressType", DataType.inet())
    .put("org.apache.apippi.db.marshal.Int32Type", DataType.cint())
    .put("org.apache.apippi.db.marshal.UTF8Type", DataType.text())
    .put("org.apache.apippi.db.marshal.TimestampType", DataType.timestamp())
    .put("org.apache.apippi.db.marshal.SimpleDateType", DataType.date())
    .put("org.apache.apippi.db.marshal.TimeType", DataType.time())
    .put("org.apache.apippi.db.marshal.UUIDType", DataType.uuid())
    .put("org.apache.apippi.db.marshal.IntegerType", DataType.varint())
    .put("org.apache.apippi.db.marshal.TimeUUIDType", DataType.timeuuid())
    .put("org.apache.apippi.db.marshal.ByteType", DataType.tinyint())
    .put("org.apache.apippi.db.marshal.ShortType", DataType.smallint())
    ...
    String className, ProtocolVersion protocolVersion, CodecRegistry codecRegistry)
    {
        ...
        if (frozen)
            ...
            + "this driver version might be too old for your version of apippi");
