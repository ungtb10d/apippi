...
import org.apache.apippi.cql3.selection.Selector.Factory;
...
import static org.apache.apippi.cql3.selection.SelectorFactories.createFactoriesAndCollectColumnDefinitions;
...
public interface Selectable extends AssignmentTestable
{
    ...
    public static class WritetimeOrTTL implements Selectable
    {
        ...
        public enum Kind
        {
            ...
            MAX_WRITE_TIME("maxwritetime", LongType.instance); // maxwritetime is available after apippi 4.1 (exclusive)
