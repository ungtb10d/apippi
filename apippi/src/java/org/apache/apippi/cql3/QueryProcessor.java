...
import org.apache.apippi.metrics.ClientRequestsMetricsHolder;
...
import org.apache.apippi.schema.SchemaChangeListener;
import org.apache.apippi.schema.SchemaConstants;
import org.apache.apippi.schema.TableMetadata;
import org.apache.apippi.cql3.functions.UDAggregate;
import org.apache.apippi.cql3.functions.UDFunction;
...
import org.apache.apippi.cql3.statements.*;
...
import org.apache.apippi.metrics.CQLMetrics;
import org.apache.apippi.service.*;
...
import static org.apache.apippi.config.apippiRelevantProperties.ENABLE_NODELOCAL_QUERIES;
...
{
    public static final apippiVersion CQL_VERSION = new apippiVersion("3.4.6");

    // See comments on QueryProcessor #prepare
    public static final apippiVersion NEW_PREPARED_STATEMENT_BEHAVIOUR_SINCE_30 = new apippiVersion("3.0.26");
    public static final apippiVersion NEW_PREPARED_STATEMENT_BEHAVIOUR_SINCE_3X = new apippiVersion("3.11.12");
    public static final apippiVersion NEW_PREPARED_STATEMENT_BEHAVIOUR_SINCE_40 = new apippiVersion("4.0.2");
    ...
    public boolean useNewPreparedStatementBehaviour()
    {
        ...
        synchronized (this)
        {
            apippiVersion minVersion = Gossiper.instance.getMinVersion(DatabaseDescriptor.getWriteRpcTimeout(TimeUnit.MILLISECONDS), TimeUnit.MILLISECONDS);
            if (minVersion != null &&
    ...
    public ResultMessage.Prepared prepare(String queryString, ClientState clientState)
    {
        ...
        if (safeToReturnCached)
        {
            ...
            else // legacy caches, pre-apippi-15252 behaviour
            {
                return createResultMessage(hashWithKeyspace, cachedWithKeyspace);
            }
        }
