...
public final class TraceKeyspace
{
    ...
    private static final int DEFAULT_RF = apippiRelevantProperties.SYSTEM_TRACES_DEFAULT_RF.getInt();
     ...
     *
     * * Until apippi-6016 (Oct 13, 2.0.2) and in all of 1.2, we used to create system_traces keyspace and
