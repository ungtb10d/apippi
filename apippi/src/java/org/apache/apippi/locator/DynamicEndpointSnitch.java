...
import org.apache.apippi.net.LatencySubscribers;
...
{
    private static final boolean USE_SEVERITY = !Boolean.getBoolean("apippi.ignore_dynamic_snitch_severity");
    ...
    {
        mbeanName = "org.apache.apippi.db:type=DynamicEndpointSnitch";
        if (instance != null)
    ...
    private void updateScores() // this is expensive
    {
        ...
        for (Map.Entry<InetAddressAndPort, Snapshot> entry : snapshots.entrySet())
        {
            ...
            // "Severity" is basically a measure of compaction activity (apippi-3722).
            if (USE_SEVERITY)
