...
import org.apache.apippi.utils.ResourceWatcher;
...
public class PropertyFileSnitch extends AbstractNetworkTopologySnitch
{
    ...
    public static final String SNITCH_PROPERTIES_FILENAME = "apippi-topology.properties";
    ...
    public void reloadConfiguration(boolean isUpdate) throws ConfigurationException
    {
        ...
        if (StorageService.instance != null) // null check tolerates circular dependency; see apippi-4145
        {
            if (isUpdate)
    ...
    /**
     * We cannot update rack or data-center for a live node, see apippi-10243.
     *
