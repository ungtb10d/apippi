...
import org.apache.apippi.dht.RingPosition;
...
import org.apache.apippi.service.DatacenterSyncWriteResponseHandler;
import org.apache.apippi.service.DatacenterWriteResponseHandler;
...
public abstract class AbstractReplicationStrategy
{
     ...
     * "primary" range in
     * {@link org.apache.apippi.service.StorageService#getPrimaryRangesForEndpoint(String, InetAddressAndPort)}
     * which is in turn relied on by various components like repair and size estimate calculations.
     *
     * @see #getNaturalReplicasForToken(org.apache.apippi.dht.RingPosition)
     *
     ...
     * map is already immutable and comes from {@link org.apache.apippi.schema.ReplicationParams}
                                                   ...
                                                   ClientState state) throws ConfigurationException
    {
        ...
        {
            throw new ConfigurationException("Transient replication is disabled. Enable in apippi.yaml to use.");
        }
    }

    public static Class<AbstractReplicationStrategy> getClass(String cls) throws ConfigurationException
    {
        String className = cls.contains(".") ? cls : "org.apache.apippi.locator." + cls;

        if ("org.apache.apippi.locator.OldNetworkTopologyStrategy".equals(className)) // see apippi-16301 
