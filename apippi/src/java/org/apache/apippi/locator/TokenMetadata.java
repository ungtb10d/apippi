...
import org.apache.apippi.utils.BiMultiValMap;
import org.apache.apippi.utils.Pair;
import org.apache.apippi.utils.SortedBiMultiValMap;
...
public class TokenMetadata
{
    ...
    // Prior to apippi-603, we just had <tt>Map<Range, InetAddressAndPort> pendingRanges<tt>,
    ...
    /**
     * To be used by tests only (via {@link org.apache.apippi.service.StorageService#setPartitionerUnsafe}).
     */
    @VisibleForTesting
    ...
    /**
     * This is called when the snitch properties for this endpoint are updated, see apippi-10238.
     */
     ...
     * the topology mappings of any endpoints whose snitch has changed, see apippi-10238.
     */
    ...
    public TokenMetadata cachedOnlyTokenMap()
    {
        ...
        // synchronize to prevent thundering herd (apippi-6345)
        synchronized (this)
        {
