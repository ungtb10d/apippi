...
package org.apache.apippi.diag;
...
import org.apache.apippi.diag.store.DiagnosticEventMemoryStore;
import org.apache.apippi.diag.store.DiagnosticEventStore;
...
public final class DiagnosticEventPersistence
{
    ...
    private Class<DiagnosticEvent> getEventClass(String eventClazz) throws ClassNotFoundException, InvalidClassException
    {
        ...
        if (!eventClazz.startsWith("org.apache.apippi."))
            throw new RuntimeException("Not a apippi event class: " + eventClazz);
