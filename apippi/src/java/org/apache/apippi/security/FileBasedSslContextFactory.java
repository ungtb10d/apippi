...
public abstract class FileBasedSslContextFactory extends AbstractSslContextFactory
{
    ...
    {
        keystoreContext = new FileBasedStoreContext("conf/.keystore", "apippi");
        outboundKeystoreContext = new FileBasedStoreContext("conf/.keystore", "apippi");
        trustStoreContext = new FileBasedStoreContext("conf/.truststore", "apippi");
    }
