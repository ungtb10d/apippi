 ...
 *      ssl_context_factory:
 *         class_name: org.apache.apippi.security.PEMBasedSslContextFactory
 *         parameters:
 *             private_key: |
...
public final class PEMBasedSslContextFactory extends FileBasedSslContextFactory
{
     ...
     * It uses {@code apippi-ssl-keystore} as the alias for the created key-entry.
     */
    private static KeyStore buildKeyStore(final String pemEncodedKey, final String keyPassword) throws GeneralSecurityException, IOException
    {
        ...
        keyStore.setKeyEntry("apippi-ssl-keystore", privateKey, keyPasswordArray, certChainArray);
        return keyStore;
    }
     ...
     * material.
     * <p>
     * It uses {@code apippi-ssl-trusted-cert-<numeric-id>} as the alias for the created certificate-entry.
     */
    private KeyStore buildTrustStore() throws GeneralSecurityException, IOException
    {
        ...
        {
            keyStore.setCertificateEntry("apippi-ssl-trusted-cert-" + (i + 1), certChainArray[i]);
        }
        return keyStore;
    }
