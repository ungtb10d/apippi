 ...
 * objects. Please use the apippi configuration key {@code ssl_context_factory} as part of {@code
 ...
 * <p>
 * Since on top of Netty, apippi is internally using JSSE SSLContext also for certain use-cases- this interface
 * has methods for both.
 * <p>
 * Below is an example of how to configure a custom implementation with parameters
 * <pre>
 * ssl_context_factory:
 *       class_name: org.apache.apippi.security.YourSslContextFactoryImpl
 *       parameters:
 *         key1: "value1"
 *         key2: "value2"
 *         key3: "value3"
...
public interface ISslContextFactory
{
     ...
     * This will be called by apippi's periodic polling for any potential changes that will reload the SSL context.
