...
print_help()
{
  ...
  echo "                   -e DTEST_BRANCH=apippi-8272"
  echo "                   -e DTEST_REPO=https://github.com/adelapena/apippi-dtest.git"
  echo "                   -e REPEATED_TESTS_STOP_ON_FAILURE=false"
  echo "                   -e REPEATED_UTESTS=org.apache.apippi.cql3.ViewTest#testCountersTable"
  echo "                   -e REPEATED_UTESTS_COUNT=500"
  echo "                   -e REPEATED_UTESTS_FQLTOOL=org.apache.apippi.fqltool.FQLCompareTest"
  echo "                   -e REPEATED_UTESTS_FQLTOOL_COUNT=500"
  echo "                   -e REPEATED_UTESTS_LONG=org.apache.apippi.db.commitlog.CommitLogStressTest"
  echo "                   -e REPEATED_UTESTS_LONG_COUNT=100"
  echo "                   -e REPEATED_UTESTS_STRESS=org.apache.apippi.stress.generate.DistributionGaussianTest"
  echo "                   -e REPEATED_UTESTS_STRESS_COUNT=500"
  echo "                   -e REPEATED_SIMULATOR_DTESTS=org.apache.apippi.simulator.test.TrivialSimulationTest"
  echo "                   -e REPEATED_SIMULATOR_DTESTS_COUNT=500"
  echo "                   -e REPEATED_JVM_DTESTS=org.apache.apippi.distributed.test.PagingTest"
  echo "                   -e REPEATED_JVM_DTESTS_COUNT=500"
  echo "                   -e REPEATED_JVM_UPGRADE_DTESTS=org.apache.apippi.distributed.upgrade.GroupByTest"
  ...
  echo "                   -e REPEATED_ANT_TEST_CLASS=org.apache.apippi.cql3.ViewTest"
...
if (!($all)); then
  ...
  add_diff_tests "REPEATED_UTESTS" "test/unit/" "org.apache.apippi"
  add_diff_tests "REPEATED_UTESTS_LONG" "test/long/" "org.apache.apippi"
  add_diff_tests "REPEATED_UTESTS_STRESS" "tools/stress/test/unit/" "org.apache.apippi.stress"
  add_diff_tests "REPEATED_UTESTS_FQLTOOL" "tools/fqltool/test/unit/" "org.apache.apippi.fqltool"
  add_diff_tests "REPEATED_SIMULATOR_DTESTS" "test/simulator/test/" "org.apache.apippi.simulator.test"
  add_diff_tests "REPEATED_JVM_DTESTS" "test/distributed/" "org.apache.apippi.distributed.test"
  add_diff_tests "REPEATED_JVM_UPGRADE_DTESTS" "test/distributed/" "org.apache.apippi.distributed.upgrade"
fi
