...
```
generate.sh -m \
  -e DTEST_REPO=https://github.com/adelapena/apippi-dtest.git \
  -e DTEST_BRANCH=apippi-8272
...
```
generate.sh -m \
  -e REPEATED_UTESTS=org.apache.apippi.cql3.ViewTest,org.apache.apippi.db.CellTest \
  -e REPEATED_UTESTS_FQLTOOL=org.apache.apippi.fqltool.FQLCompareTest \
  -e REPEATED_UTESTS_LONG=org.apache.apippi.io.sstable.CQLSSTableWriterLongTest#testWideRow \
  -e REPEATED_UTESTS_STRESS=org.apache.apippi.stress.generate.DistributionGaussianTest \
  -e REPEATED_SIMULATOR_DTESTS=org.apache.apippi.simulator.test.TrivialSimulationTest \
  -e REPEATED_DTESTS=cql_test.py,consistency_test.py::TestAvailability::test_simple_strategy \
  -e REPEATED_JVM_DTESTS=org.apache.apippi.distributed.test.PagingTest#testPaging \
  -e REPEATED_UPGRADE_DTESTS=upgrade_tests/cql_tests.py \
  -e REPEATED_JVM_UPGRADE_DTESTS=org.apache.apippi.distributed.upgrade.GroupByTest
```
...
generate.sh -m \
  ...
  -e REPEATED_ANT_TEST_CLASS=org.apache.apippi.cql3.ViewTest \
