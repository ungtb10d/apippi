 ...
 */
package org.apache.apippi.stress.util;
...
public class JavaDriverClient
{
    ...
    public JavaDriverClient(StressSettings settings, String host, int port, EncryptionOptions encryptionOptions)
    {
        ...
        //See https://issues.apache.org/jira/browse/apippi-7217
    ...
    public void connect(ProtocolOptions.Compression compression) throws Exception
    {
        ...
        if (encryptionOptions.getEnabled())
        {
            ...
            // RemoteEndpointAwareJdkSSLOptions.  See apippi-13325 and apippi-16362.
    ...
    public ResultSet execute(String query, org.apache.apippi.db.ConsistencyLevel consistency)
    {
    ...
    public ResultSet executePrepared(PreparedStatement stmt, List<Object> queryParams, org.apache.apippi.db.ConsistencyLevel consistency)
    {
        if (consistency.isSerialConsistency())
        {
            stmt.setSerialConsistencyLevel(from(consistency));
     ...
     * @return
     */
    public static ConsistencyLevel from(org.apache.apippi.db.ConsistencyLevel cl)
    {
        switch (cl)
        {
            case ANY:
