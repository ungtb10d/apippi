...
public class SettingsSchema implements Serializable
{
    ...
    public void createKeySpaces(StressSettings settings)
    {
        ...
        {
            //Keyspace
            client.execute(createKeyspaceStatementCQL3(), org.apache.apippi.db.ConsistencyLevel.LOCAL_ONE);

            client.execute("USE \""+keyspace+"\"", org.apache.apippi.db.ConsistencyLevel.LOCAL_ONE);

            //Add standard1 and counter1
            client.execute(createStandard1StatementCQL3(settings), org.apache.apippi.db.ConsistencyLevel.LOCAL_ONE);
            client.execute(createCounter1StatementCQL3(settings), org.apache.apippi.db.ConsistencyLevel.LOCAL_ONE);
