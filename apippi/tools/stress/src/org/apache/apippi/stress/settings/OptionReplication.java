...
class OptionReplication extends OptionMulti
{
    ...
    private final OptionSimple strategy = new OptionSimple("strategy=", new StrategyAdapter(), "org.apache.apippi.locator.SimpleStrategy", "The replication strategy to use", false);
    ...
    public Map<String, String> getOptions()
    {
        ...
        if (!options.containsKey("replication_factor") && (strategy.value().equals("org.apache.apippi.locator.SimpleStrategy") || factor.setByUser()))
    ...
    private static final class StrategyAdapter implements Function<String, String>
    {
        public String apply(String name)
        {
            ...
            for (String fullname : new String[] { name, "org.apache.apippi.locator." + name })
            {
                try
                {
