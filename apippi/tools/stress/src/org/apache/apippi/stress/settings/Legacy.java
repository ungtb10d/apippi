...
public class Legacy implements Serializable
{
    ...
    static
    {
        ...
        availableOptions.addOption("R",  "replication-strategy", true,   "Replication strategy to use (only on insert if keyspace does not exist), default:org.apache.apippi.locator.SimpleStrategy");
    ...
    {
        System.out.println("Usage: ./bin/apippi-stress legacy [options]\n\nOptions:");
