package org.apache.apippi.stress.report;
/*
 *
...
import org.apache.apippi.stress.StressAction.Consumer;
import org.apache.apippi.stress.StressAction.MeasurementSink;
import org.apache.apippi.stress.StressAction.OpMeasurement;
import org.apache.apippi.stress.settings.SettingsLog.Level;
import org.apache.apippi.stress.settings.StressSettings;
import org.apache.apippi.stress.util.JmxCollector;
import org.apache.apippi.stress.util.JmxCollector.GcStats;
import org.apache.apippi.stress.util.ResultLogger;
import org.apache.apippi.stress.util.Uncertainty;
    ...
    public StressMetrics(ResultLogger output, final long logIntervalMillis, StressSettings settings)
    {
        ...
        if(settings.log.hdrFile != null)
        {
            try
            {
                ...
                histogramWriter.outputComment("Logging op latencies for apippi Stress");
