...
import org.apache.apippi.cql3.statements.schema.CreateTypeStatement;
...
public class StressCQLSSTableWriter implements Closeable
{
     ...
     * <a href="http://apippi.apache.org/doc/cql3/CQL.html#identifiers">case-sensitive quoted identifier</a>
    ...
    public static class Builder
    {
        ...
        public static ColumnFamilyStore createOfflineTable(CreateTableStatement.Raw schemaStatement, List<CreateTypeStatement.Raw> typeStatements, List<File> directoryList)
        {
            ...
            Directories directories = new Directories(tableMetadata, directoryList.stream().map(f -> new Directories.DataDirectory(new org.apache.apippi.io.util.File(f.toPath()))).collect(Collectors.toList()));
