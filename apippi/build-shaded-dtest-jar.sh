...
ARTIFACT_NAME=apippi-dtest
REPO_DIR=~/.m2/repository
apippi_VERSION=$(cat build.xml | grep 'property name="base.version"' | awk -F "\"" '{print $4}')
...
mvn install:install-file               \
   -Dfile=./build/dtest-${apippi_VERSION}.jar \
   -DgroupId=org.apache.apippi      \
