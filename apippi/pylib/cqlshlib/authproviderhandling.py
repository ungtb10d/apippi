...
def load_auth_provider(config_file=None, cred_file=None, username=None, password=None):
    ...
    Params:
    * config_file ..: path to cqlsh config file (usually ~/.apippi/cqlshrc).
    * cred_file ....: path to cqlsh credentials file (default is  ~/.apippi/credentials).
    ...
    * password .....: override used to return PlainTextAuthProvider according to legacy case
    ...
    if module_name == 'apippi.auth' and class_name == 'PlainTextAuthProvider':
