 ...
 */
package org.apache.apippi.test.microbench.tries;
...
import org.apache.apippi.db.tries.TrieEntriesWalker;
...
@Fork(value = 1,jvmArgsAppend = { "-Xmx4G", "-Xms4G", "-Djmh.executor=CUSTOM", "-Djmh.executor.class=org.apache.apippi.test.microbench.FastThreadExecutor"})
