...
import org.apache.apippi.metrics.DecayingEstimatedHistogramReservoir;
import org.apache.apippi.metrics.LatencyMetrics;
...
@Fork(value = 1, jvmArgsAppend = { "-Xmx512M", "-Djmh.executor=CUSTOM", "-Djmh.executor.class=org.apache.apippi.test.microbench.FastThreadExecutor"})
...
public class LatencyTrackingBench
{
    ...
    class BenchMetricsNameFactory implements MetricNameFactory
    {
        ...
        {
            return new apippiMetricsRegistry.MetricName(BenchMetricsNameFactory.class, metricName);
        }
    }
