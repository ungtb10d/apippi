...
import org.apache.apippi.db.streaming.apippiEntireSSTableStreamReader;
import org.apache.apippi.db.streaming.apippiEntireSSTableStreamWriter;
import org.apache.apippi.db.streaming.apippiStreamHeader;
import org.apache.apippi.db.streaming.apippiStreamReader;
import org.apache.apippi.db.streaming.apippiStreamWriter;
import org.apache.apippi.db.streaming.ComponentContext;
...
import org.apache.apippi.net.AsyncStreamingInputPlus;
...
public class ZeroCopyStreamingBenchmark
{
    ...
    public static class BenchmarkState
    {
        ...
        private apippiEntireSSTableStreamWriter blockStreamWriter;
        private ComponentContext context;
        private ByteBuf serializedBlockStream;
        private InetAddressAndPort peer = FBUtilities.getBroadcastAddressAndPort();
        private apippiEntireSSTableStreamReader blockStreamReader;
        private apippiStreamWriter partialStreamWriter;
        private apippiStreamReader partialStreamReader;
        ...
        public void setupBenchmark() throws IOException
        {
            ...
            blockStreamWriter = new apippiEntireSSTableStreamWriter(sstable, session, context);
            ...
            apippiStreamHeader entireSSTableStreamHeader =
            ...
            blockStreamReader = new apippiEntireSSTableStreamReader(new StreamMessageHeader(sstable.metadata().id,
            ...
            apippiStreamHeader partialSSTableStreamHeader =
            apippiStreamHeader.builder()
                                 .withSSTableFormat(sstable.descriptor.formatType)
                                 .withSSTableVersion(sstable.descriptor.version)
                                 .withSSTableLevel(0)
            ...
            partialStreamWriter = new apippiStreamWriter(sstable, partialSSTableStreamHeader, session);
            ...
            partialStreamReader = new apippiStreamReader(new StreamMessageHeader(sstable.metadata().id,
                                                                                    peer, session.planId(), false,
                                                                                    0, 0, 0,
                                                                                    null),
