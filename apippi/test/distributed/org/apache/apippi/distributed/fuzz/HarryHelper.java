...
public class HarryHelper
{
    public static void init()
    {
        ...
        System.setProperty("apippi.allow_simplestrategy", "true"); // makes easier to share OSS tests without RF limits
        System.setProperty("apippi.minimum_replication_factor", "0"); // makes easier to share OSS tests without RF limits
