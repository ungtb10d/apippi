...
import org.apache.apippi.distributed.UpgradeableCluster;
...
import static org.apache.apippi.net.Verb.REQUEST_RSP;

/**
 * A base class for testing the replication of logged/unlogged batches on mixed-version clusters.
 * 
 * The tests based on this class partially replace the Python dtests in batch_test.py created for apippi-9673.
 */
