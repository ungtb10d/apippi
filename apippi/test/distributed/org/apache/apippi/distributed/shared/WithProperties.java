...
public final class WithProperties implements AutoCloseable
{
    ...
    public void set(apippiRelevantProperties prop, String value)
    {
        with(prop.getKey(), value);
    }

    public void set(apippiRelevantProperties prop, String... values)
    {
        set(prop, Arrays.asList(values));
    }

    public void set(apippiRelevantProperties prop, Collection<String> values)
    {
        set(prop, Joiner.on(",").join(values));
    }

    public void set(apippiRelevantProperties prop, boolean value)
    {
        set(prop, Boolean.toString(value));
    }

    public void set(apippiRelevantProperties prop, long value)
    {
