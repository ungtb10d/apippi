...
public class FailingResponseDoesNotLogTest extends TestBaseImpl
{
    ...
    {
        System.setProperty("apippi.custom_query_handler_class", AlwaysRejectErrorQueryHandler.class.getName());
        ...
        {
            System.clearProperty("apippi.custom_query_handler_class");
        }
    }
