...
import org.apache.apippi.auth.RoleOptions;
...
import static org.apache.apippi.auth.AuthKeyspace.ROLES;
...
import static org.apache.apippi.distributed.shared.NetworkTopology.dcAndRack;
import static org.apache.apippi.distributed.shared.NetworkTopology.networkTopology;
...
public class UpdateSystemAuthAfterDCExpansionTest extends TestBaseImpl
{
    ...
    static void assertQueryThrowsConfigurationException(Cluster cluster, String query)
    {
        cluster.forEach(instance -> {
            ...
            {
                assertEquals("org.apache.apippi.exceptions.ConfigurationException", tr.getClass().getCanonicalName());
            }
        });
    }
    ...
    static public void beforeClass() throws Throwable
    {
        ...
        // exception from apippiRoleManager
        System.setProperty("apippi.superuser_setup_delay_ms", "0");
