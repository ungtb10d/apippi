...
import org.apache.apippi.distributed.impl.DistributedTestSnitch;
...
import static org.apache.apippi.distributed.action.GossipHelper.disseminateGossipState;
                                        ...
                                        .start())
        {
            ...
            cluster.get(1).acceptsOnInstance((InetSocketAddress ip) -> {
                ...
                Assert.assertTrue(String.format("%s should contain %s", set, ip),
                                  set.contains(DistributedTestSnitch.toapippiInetAddressAndPort(ip)));
