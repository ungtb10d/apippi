...
import org.apache.apippi.tools.BulkLoader;
import org.apache.apippi.tools.ToolRunner;
import org.apache.apippi.service.StorageService;
import org.apache.apippi.utils.NativeSSTableLoaderClient;
...
public class SSTableLoaderEncryptionOptionsTest extends AbstractEncryptionOptionsImpl
{
    ...
    {
        File cfDir = new File("build/test/apippi/ssl_upload_tables", table);
        cfDir.tryCreateDirectories();
        // Get paths as Strings, because org.apache.apippi.io.util.File in the dtest
        // node is loaded by org.apache.apippi.distributed.shared.InstanceClassLoader.
