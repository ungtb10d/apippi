...
public class JVMDTestTest extends TestBaseImpl
{
    ...
    {
        Map<String,Object> commitLogCompression = ImmutableMap.of("class_name", "org.apache.apippi.io.compress.LZ4Compressor",
                                      ...
                                      }).start())
        {
            cluster.get(1).runOnInstance(() -> {
                ...
                assertEquals("org.apache.apippi.io.compress.LZ4Compressor", DatabaseDescriptor.getCommitLogCompression().class_name);
