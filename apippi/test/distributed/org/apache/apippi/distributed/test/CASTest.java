...
import static org.apache.apippi.distributed.api.ConsistencyLevel.ANY;
import static org.apache.apippi.distributed.api.ConsistencyLevel.ONE;
import static org.apache.apippi.distributed.api.ConsistencyLevel.QUORUM;
import static org.apache.apippi.distributed.api.ConsistencyLevel.SERIAL;
...
import static org.apache.apippi.net.Verb.PAXOS2_PREPARE_REFRESH_REQ;
...
import static org.apache.apippi.net.Verb.READ_REQ;
...
public class CASTest extends CASCommonTestCases
{
    ...
    {
        System.setProperty("apippi.paxos.use_self_execution", "false");
     ...
     *
     * <p>This specifically test for the inconsistency described/fixed by apippi-12126.
     */
    @Test
    ...
    static void consistencyAfterWriteTimeoutTest(BiConsumer<String, ICoordinator> postTimeoutOperation1, BiConsumer<String, ICoordinator> postTimeoutOperation2, boolean loseCommitOfOperation1, Cluster cluster)
    {
        ...
        // operation asserted nothing was inserted). It is this execution that failed before apippi-12126.
