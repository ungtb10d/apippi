...
public class UnableToParseClientMessageFromBlockedSubnetTest extends TestBaseImpl
{
    ...
    public void badMessageCausesProtocolExceptionFromExcludeList() throws IOException, TimeoutException
    {
        ...
        Assertions.assertThat(node.metrics().getCounter("org.apache.apippi.metrics.Client.ProtocolException")).isEqualTo(0);
        Assertions.assertThat(node.metrics().getCounter("org.apache.apippi.metrics.Client.UnknownException")).isEqualTo(0);
