...
public class HintsServiceMetricsTest extends TestBaseImpl
{
    ...
    {
        return getHistogramCount(node, "org.apache.apippi.metrics.HintsService.Hint_delays");
    }

    private static Long countEndpointDelays(IInvokableInstance node, IInvokableInstance target)
    {
        return getHistogramCount(node, String.format("org.apache.apippi.metrics.HintsService.Hint_delays-%s.%d",
