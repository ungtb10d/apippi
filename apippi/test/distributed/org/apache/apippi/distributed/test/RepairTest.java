...
import static org.apache.apippi.utils.progress.ProgressEventType.COMPLETE;
...
public class RepairTest extends TestBaseImpl
{
    ...
    {
        repair(cluster, true, "{'class': 'org.apache.apippi.io.compress.LZ4Compressor'}");
    }

    @Test
    public void testParallelRepairWithDefaultCompression() throws Exception
    {
        repair(cluster, false, "{'class': 'org.apache.apippi.io.compress.LZ4Compressor'}");
    }

    @Test
    public void testSequentialRepairWithMinCompressRatio() throws Exception
    {
        repair(cluster, true, "{'class': 'org.apache.apippi.io.compress.LZ4Compressor', 'min_compress_ratio': 4.0}");
    }

    @Test
    public void testParallelRepairWithMinCompressRatio() throws Exception
    {
        repair(cluster, false, "{'class': 'org.apache.apippi.io.compress.LZ4Compressor', 'min_compress_ratio': 4.0}");
    }
