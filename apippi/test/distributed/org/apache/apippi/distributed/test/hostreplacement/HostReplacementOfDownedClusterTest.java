...
package org.apache.apippi.distributed.test.hostreplacement;
...
import org.apache.apippi.distributed.test.TestBaseImpl;
import org.assertj.core.api.Assertions;

import static org.apache.apippi.config.apippiRelevantProperties.GOSSIPER_QUARANTINE_DELAY;
import static org.apache.apippi.distributed.shared.ClusterUtils.assertGossipInfo;
import static org.apache.apippi.distributed.shared.ClusterUtils.assertNotInRing;
import static org.apache.apippi.distributed.shared.ClusterUtils.assertRingIs;
import static org.apache.apippi.distributed.shared.ClusterUtils.awaitRingHealthy;
import static org.apache.apippi.distributed.shared.ClusterUtils.awaitRingJoin;
import static org.apache.apippi.distributed.shared.ClusterUtils.getTokenMetadataTokens;
import static org.apache.apippi.distributed.shared.ClusterUtils.replaceHostAndStart;
import static org.apache.apippi.distributed.shared.ClusterUtils.stopAll;
import static org.apache.apippi.distributed.test.hostreplacement.HostReplacementTest.setupCluster;
import static org.apache.apippi.distributed.test.hostreplacement.HostReplacementTest.validateRows;
