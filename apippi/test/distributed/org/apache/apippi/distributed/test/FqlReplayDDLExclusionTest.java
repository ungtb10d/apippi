...
public class FqlReplayDDLExclusionTest extends TestBaseImpl
{
    ...
    public void test() throws Throwable
    {
                                                   ...
                                                   .start()))
        {
            ...
            // in apippi where events are propagated to logger
                 ...
                 Session s = c.connect())
            {
                ...
                final ToolResult negativeRunner = ToolRunner.invokeClass("org.apache.apippi.fqltool.FullQueryLogTool",
                                                                         "replay",
                                                                         "--keyspace", "fql_ks",
                                                                         "--target", "127.0.0.1",
                ...
                final ToolResult positiveRunner = ToolRunner.invokeClass("org.apache.apippi.fqltool.FullQueryLogTool",
                                                                         "replay",
                                                                         "--keyspace", "fql_ks",
                                                                         "--target", "127.0.0.1",
                                                                         // important
