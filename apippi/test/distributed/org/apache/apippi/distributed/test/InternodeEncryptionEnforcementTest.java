...
import org.apache.apippi.net.InboundMessageHandlers;
import org.apache.apippi.net.MessagingService;
import org.apache.apippi.net.OutboundConnections;
    ...
    public void testConnectionsAreRejectedWithInvalidConfig() throws Throwable
    {
        Cluster.Builder builder = builder()
            ...
            .withConfig(c ->
            {
                ...
                if (c.num() == 1)
                {
                    encryption.put("keystore", "test/conf/apippi_ssl_test.keystore");
                    encryption.put("keystore_password", "apippi");
                    encryption.put("truststore", "test/conf/apippi_ssl_test.truststore");
                    encryption.put("truststore_password", "apippi");
    ...
    public void testConnectionsAreAcceptedWithValidConfig() throws Throwable
    {
        Cluster.Builder builder = builder()
            ...
            .withConfig(c ->
            {
                ...
                HashMap<String, Object> encryption = new HashMap<>(); encryption.put("keystore", "test/conf/apippi_ssl_test.keystore");
                encryption.put("keystore_password", "apippi");
                encryption.put("truststore", "test/conf/apippi_ssl_test.truststore");
                encryption.put("truststore_password", "apippi");
    ...
    public static class CertificateVerifyAuthenticator implements IInternodeAuthenticator
    {
        ...
        public boolean authenticate(InetAddress remoteAddress, int remotePort, Certificate[] certificates, InternodeConnectionDirection connectionType)
        {
            ...
            try
            {
                ...
                // configured in the apippi.yaml configuration.
                KeyStore keyStore = KeyStore.getInstance("JKS");
                char[] keyStorePassword = "apippi".toCharArray();
                InputStream keyStoreData = new FileInputStream("test/conf/apippi_ssl_test.keystore");
                keyStore.load(keyStoreData, keyStorePassword);
                return certificates != null && certificates.length != 0 && keyStore.getCertificate("apippi_ssl_test").equals(certificates[0]);
            }
            catch (Exception e)
            {
                return false;
