...
import org.apache.apippi.service.reads.range.RangeCommandIterator;
...
public class FailureLoggingTest extends TestBaseImpl
{
    ...
    {
        apippiRelevantProperties.FAILURE_LOGGING_INTERVAL_SECONDS.setInt(0);
    ...
    public static class BBRequestFailures
    {
        ...
        {
            throw UnavailableException.create(org.apache.apippi.db.ConsistencyLevel.ALL, 1, 0);
        }

        @SuppressWarnings("unused")
        public static PartitionIterator fetchRows(List<SinglePartitionReadCommand> commands, 
                                                  org.apache.apippi.db.ConsistencyLevel consistencyLevel, 
