...
public class MixedModeFuzzTest extends TestBaseImpl
{
                            ...
                            switch (action)
                            {
                                case BUMP_VERSION:
                                    ...
                                    c.stream().forEach(node -> node.runOnInstance(() -> {
                                        ...
                                        {
                                            apippiVersion upgradeTo = QueryProcessor.NEW_PREPARED_STATEMENT_BEHAVIOUR_SINCE_40;
    ...
    private static apippiVersion INITIAL_VERSION = new apippiVersion("4.0.11");
    private static volatile AtomicReference<apippiVersion> version = new AtomicReference<>(INITIAL_VERSION);
    ...
    public static class MultiBehaviour
    {
        ...
        public static boolean useNewPreparedStatementBehaviour()
        {
            ...
            synchronized (sync)
            {
                apippiVersion minVersion = version.get();
