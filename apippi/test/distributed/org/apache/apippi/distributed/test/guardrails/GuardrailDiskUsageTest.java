...
package org.apache.apippi.distributed.test.guardrails;
...
public class GuardrailDiskUsageTest extends GuardrailTester
{
    ...
    public static void setupCluster() throws IOException
    {
        ...
        apippiRelevantProperties.DISK_USAGE_MONITOR_INTERVAL_MS.setInt(100);
        ...
        try (com.datastax.driver.core.Cluster c = builder.withCredentials("apippi", "apippi").build();
