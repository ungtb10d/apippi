...
public class PaxosUncommittedIndexTest extends TestBaseImpl
{
    ...
    {
        String expectedCreateCustomIndex = "CREATE CUSTOM INDEX \"PaxosUncommittedIndex\" ON system.paxos () USING 'org.apache.apippi.service.paxos.uncommitted.PaxosUncommittedIndex'";
