...
public class BootstrapBinaryDisabledTest extends TestBaseImpl
{
    ...
    public void test() throws IOException, TimeoutException
    {
        ...
        config.put("authenticator", "org.apache.apippi.auth.PasswordAuthenticator");
        config.put("authorizer", "org.apache.apippi.auth.apippiAuthorizer");
        config.put("role_manager", "org.apache.apippi.auth.apippiRoleManager");
                                  ...
                                  boolean isWriteSurvey) throws TimeoutException
    {
        ...
        System.setProperty("apippi.ring_delay_ms", "5000");
        if (isWriteSurvey)
            System.setProperty("apippi.write_survey", "true");
