...
import org.apache.apippi.auth.apippiRoleManager;
...
import org.apache.apippi.streaming.StreamException;
...
public class FailedBootstrapTest extends TestBaseImpl
{
    ...
    public void roleSetupDoesNotProduceUnavailables() throws IOException
    {
        ...
        try (Cluster cluster = builder.start())
        {
            ...
            IInvokableInstance added = replaceHostAndStart(cluster, nodeToRemove, p -> p.setProperty("apippi.superuser_setup_delay_ms", "1"));
            ...
            // apippiRoleManager attempted to do distributed reads while bootstrap was still going (it failed, so still in bootstrap mode)
            // so need to validate that is no longer happening and we incrementing org.apache.apippi.metrics.ClientRequestMetrics.unavailables
    ...
    public static class BB
    {
        public static void install(ClassLoader classLoader, Integer num)
        {
            ...
            new ByteBuddy().rebase(apippiRoleManager.class)
