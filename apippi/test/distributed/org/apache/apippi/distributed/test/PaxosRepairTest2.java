...
import org.apache.apippi.db.ReadQuery;
...
import org.apache.apippi.service.paxos.uncommitted.PaxosKeyState;
import org.apache.apippi.service.paxos.uncommitted.PaxosRows;
import org.apache.apippi.service.paxos.uncommitted.PaxosUncommittedTracker;
import org.apache.apippi.service.paxos.uncommitted.PaxosUncommittedTracker.UpdateSupplier;
...
public class PaxosRepairTest2 extends TestBaseImpl
{
    ...
    {
        Ballot staleBallot = Paxos.newBallot(Ballot.none(), org.apache.apippi.db.ConsistencyLevel.SERIAL);
    ...
    {
        System.setProperty("apippi.auto_repair_frequency_seconds", "1");
        System.setProperty("apippi.disable_paxos_auto_repairs", "true");
        try (Cluster cluster = init(Cluster.create(3, cfg -> cfg
                                                             .set("paxos_variant", "v2")
        ...
        {
            System.clearProperty("apippi.auto_repair_frequency_seconds");
            System.clearProperty("apippi.disable_paxos_auto_repairs");
        }
    }
    ...
    {
        apippiRelevantProperties.CLOCK_GLOBAL.setString(OffsettableClock.class.getName());
        try (Cluster cluster = init(Cluster.create(3, cfg -> cfg
                                                             .set("paxos_variant", "v2")
