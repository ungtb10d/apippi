...
package org.apache.apippi.distributed.test.ring;
...
import static org.apache.apippi.distributed.action.GossipHelper.bootstrap;
import static org.apache.apippi.distributed.action.GossipHelper.pullSchemaFrom;
import static org.apache.apippi.distributed.action.GossipHelper.statusToBootstrap;
import static org.apache.apippi.distributed.action.GossipHelper.withProperty;
...
public class BootstrapTest extends TestBaseImpl
{
    ...
    public void beforeTest()
    {
        ...
        savedMigrationDelay = apippiRelevantProperties.MIGRATION_DELAY.getLong();
        apippiRelevantProperties.MIGRATION_DELAY.setLong(ManagementFactory.getRuntimeMXBean().getUptime() + savedMigrationDelay);
    ...
    {
        apippiRelevantProperties.MIGRATION_DELAY.setLong(savedMigrationDelay);
    ...
    public void bootstrapUnspecifiedFailsOnResumeTest() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            IInvokableInstance newInstance = cluster.bootstrap(config);
                withProperty("apippi.join_ring", false, () -> newInstance.startup(cluster));
    ...
    private void bootstrapTest() throws Throwable
    {
                                        ...
                                        .start())
        {
            ...
            IInstanceConfig config = cluster.newInstanceConfig();
            IInvokableInstance newInstance = cluster.bootstrap(config);
            withProperty("apippi.join_ring", false,
