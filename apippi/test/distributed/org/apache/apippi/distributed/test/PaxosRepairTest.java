...
import org.apache.apippi.cql3.statements.SelectStatement;
...
import static org.apache.apippi.net.Verb.PAXOS2_CLEANUP_FINISH_PREPARE_REQ;
import static org.apache.apippi.net.Verb.PAXOS2_CLEANUP_REQ;
import static org.apache.apippi.net.Verb.PAXOS2_COMMIT_AND_PREPARE_REQ;
...
import static org.apache.apippi.net.Verb.PAXOS2_PROPOSE_RSP;
import static org.apache.apippi.net.Verb.PAXOS2_REPAIR_REQ;
import static org.apache.apippi.net.Verb.PAXOS_COMMIT_REQ;
import static org.apache.apippi.net.Verb.PAXOS_COMMIT_RSP;
...
public class PaxosRepairTest extends TestBaseImpl
{
    ...
    static
    {
        apippiRelevantProperties.PAXOS_EXECUTE_ON_SELF.setBoolean(false);
