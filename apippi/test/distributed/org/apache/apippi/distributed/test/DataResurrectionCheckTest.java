...
import org.apache.apippi.service.DataResurrectionCheck;
import org.apache.apippi.service.DataResurrectionCheck.Heartbeat;
import org.apache.apippi.service.StartupChecks.StartupCheckType;
import org.apache.apippi.utils.Clock.Global;

import static java.lang.String.format;
import static java.util.concurrent.TimeUnit.MINUTES;
import static java.util.concurrent.TimeUnit.SECONDS;
import static org.apache.apippi.config.StartupChecksOptions.ENABLED_PROPERTY;
import static org.apache.apippi.distributed.Cluster.build;
import static org.apache.apippi.distributed.api.Feature.NATIVE_PROTOCOL;
import static org.apache.apippi.service.DataResurrectionCheck.DEFAULT_HEARTBEAT_FILE;
import static org.apache.apippi.service.DataResurrectionCheck.EXCLUDED_KEYSPACES_CONFIG_PROPERTY;
import static org.apache.apippi.service.DataResurrectionCheck.EXCLUDED_TABLES_CONFIG_PROPERTY;
import static org.apache.apippi.service.StartupChecks.StartupCheckType.check_data_resurrection;
...
public class DataResurrectionCheckTest extends TestBaseImpl
{
    ...
    public void testDataResurrectionCheck() throws Exception
    {
        try
        {
            ...
            System.setProperty(apippiRelevantProperties.CHECK_DATA_RESURRECTION_HEARTBEAT_PERIOD.getKey(), "3600000");
        ...
        {
            System.clearProperty(apippiRelevantProperties.CHECK_DATA_RESURRECTION_HEARTBEAT_PERIOD.getKey());
        }
    }
