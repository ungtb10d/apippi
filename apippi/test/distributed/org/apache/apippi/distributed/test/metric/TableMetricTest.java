...
package org.apache.apippi.distributed.test.metric;
...
import org.apache.apippi.schema.SchemaKeyspace;
...
import static org.apache.apippi.config.apippiRelevantProperties.MBEAN_REGISTRATION_CLASS;
...
public class TableMetricTest extends TestBaseImpl
{
     ...
     *
     * @see <a href="https://issues.apache.org/jira/browse/apippi-16095">apippi-16095</a>
     */
    @Test
    ...
    {
        return String.format("org.apache.apippi.metrics:type=Keyspace,keyspace=%s,name=%s", keyspace, name);
    }

    private static String getTableMetricName(String keyspace, String table, String name)
    {
        return String.format("org.apache.apippi.metrics:type=Table,keyspace=%s,scope=%s,name=%s", keyspace, table, name);
    }
