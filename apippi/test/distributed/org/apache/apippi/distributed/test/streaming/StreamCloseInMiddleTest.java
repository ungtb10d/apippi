 ...
 */
package org.apache.apippi.distributed.test.streaming;
...
import org.apache.apippi.db.streaming.apippiIncomingFile;
...
import org.apache.apippi.io.util.SequentialWriter;
...
public class StreamCloseInMiddleTest extends TestBaseImpl
{
    ...
    {
        String key = "org.apache.apippi.metrics.Streaming.%s./127.0.0.1.7012";
    ...
    public static class BBHelper
    {
        ...
        {
            if (isCaller(apippiIncomingFile.class.getName(), "read")) // handles compressed and non-compressed
                throw new java.nio.channels.ClosedChannelException();
            // different context; pass through
            return zuper.call();
        }
