...
import static org.apache.apippi.distributed.test.AbstractEncryptionOptionsImpl.ConnectResult.CONNECTING;
import static org.apache.apippi.distributed.test.AbstractEncryptionOptionsImpl.ConnectResult.UNINITIALIZED;
...
public class AbstractEncryptionOptionsImpl extends TestBaseImpl
{
    ...
    final static String validKeyStorePath = "test/conf/apippi_ssl_test.keystore";
    final static String validKeyStorePassword = "apippi";
    final static String validTrustStorePath = "test/conf/apippi_ssl_test.truststore";
    final static String validTrustStorePassword = "apippi";
