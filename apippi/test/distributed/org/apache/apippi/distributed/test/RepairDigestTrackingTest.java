...
import org.apache.apippi.service.StorageProxy.LocalReadRunnable;
...
public class RepairDigestTrackingTest extends TestBaseImpl
{
    ...
    /**
     * In apippi-16721, we discovered that if responses from remote replicas came back while the local runnable was 
     ...
     * 
     * These problems are sidestepped completely by apippi-16721, as an RDI instance is now created and destroyed 
