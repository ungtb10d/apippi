...
public class DistributedTestSnitch extends AbstractNetworkTopologySnitch
{
    ...
    public static InetAddressAndPort toapippiInetAddressAndPort(InetSocketAddress addressAndPort)
    {
    ...
    public static InetSocketAddress fromapippiInetAddressAndPort(InetAddressAndPort addressAndPort)
    {
    ...
    public String getRack(InetAddressAndPort endpoint)
    {
        ...
        return maybeGetFromEndpointState(mapping.localRack(fromapippiInetAddressAndPort(endpoint)), endpoint, ApplicationState.RACK, DEFAULT_RACK);
    }
    ...
    {
        assert mapping != null : "network topology must be assigned before using snitch";
        return maybeGetFromEndpointState(mapping.localDC(fromapippiInetAddressAndPort(endpoint)), endpoint, ApplicationState.DC, DEFAULT_DC);
    }
