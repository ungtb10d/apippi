...
import org.apache.apippi.distributed.upgrade.UpgradeTestBase;
import org.apache.apippi.locator.InetAddressAndPort;
import org.apache.apippi.locator.SimpleSeedProvider;
...
public class InstanceConfig implements IInstanceConfig
{
                           ...
                           int native_transport_port)
    {
        ...
        this    .set("num_tokens", initial_token.size())
                ...
                .set("partitioner", "org.apache.apippi.dht.Murmur3Partitioner")
    ...
    {
        return DistributedTestSnitch.fromapippiInetAddressAndPort(getBroadcastAddressAndPort());
    }
