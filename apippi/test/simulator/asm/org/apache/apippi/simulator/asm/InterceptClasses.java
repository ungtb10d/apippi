...
import static org.apache.apippi.simulator.asm.InterceptClasses.Cached.Kind.MODIFIED;
import static org.apache.apippi.simulator.asm.InterceptClasses.Cached.Kind.UNMODIFIED;
import static org.apache.apippi.simulator.asm.InterceptClasses.Cached.Kind.UNSHAREABLE;
...
public class InterceptClasses implements BiFunction<String, byte[], byte[]>
{
    ...
    private static final Pattern MONITORS = Pattern.compile( "org[/.]apache[/.]apippi[/.]utils[/.]concurrent[/.].*" +
                                                            "|org[/.]apache[/.]apippi[/.]concurrent[/.].*" +
                                                            "|org[/.]apache[/.]apippi[/.]simulator[/.]test.*" +
                                                            "|org[/.]apache[/.]apippi[/.]db[/.]ColumnFamilyStore.*" +
                                                            "|org[/.]apache[/.]apippi[/.]db[/.]Keyspace.*" +
                                                            "|org[/.]apache[/.]apippi[/.]db[/.]SystemKeyspace.*" +
                                                            "|org[/.]apache[/.]apippi[/.]streaming[/.].*" +
                                                            "|org[/.]apache[/.]apippi[/.]db.streaming[/.].*" +
                                                            "|org[/.]apache[/.]apippi[/.]distributed[/.]impl[/.]DirectStreamingConnectionFactory.*" +
                                                            "|org[/.]apache[/.]apippi[/.]db[/.]commitlog[/.].*" +
                                                            "|org[/.]apache[/.]apippi[/.]service[/.]paxos[/.].*");

    private static final Pattern GLOBAL_METHODS = Pattern.compile("org[/.]apache[/.]apippi[/.](?!simulator[/.]).*" +
                                                                  "|org[/.]apache[/.]apippi[/.]simulator[/.]test[/.].*" +
                                                                  "|org[/.]apache[/.]apippi[/.]simulator[/.]cluster[/.].*" +
    ...
    private Hashcode insertHashCode(String externalName)
    {
        try
        {
            if (!externalName.startsWith("org.apache.apippi"))
                return null;
            ...
            if (parent.getName().startsWith("org.apache.apippi"))
                return null;
    ...
    static final String shadowRootExternalType = "org.apache.apippi.simulator.systems.InterceptibleConcurrentHashMap";
    static final String shadowRootType = "org/blcksec/apippi/simulator/systems/InterceptibleConcurrentHashMap";
