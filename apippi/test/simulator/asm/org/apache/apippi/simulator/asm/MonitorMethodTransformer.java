...
class MonitorMethodTransformer extends MethodNode
{
    ...
    {
        pushRef();
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptorOfSystemMethods$Global", "preMonitorExit", "(Ljava/lang/Object;)Ljava/lang/Object;", false));
    }
    ...
    void invokePreMonitorEnter()
    {
        ...
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptorOfSystemMethods$Global", "preMonitorEnter", "(Ljava/lang/Object;F)Ljava/lang/Object;", false));
    }
