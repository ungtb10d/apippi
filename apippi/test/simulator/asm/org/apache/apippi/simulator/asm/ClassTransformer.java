...
import static org.apache.apippi.simulator.asm.Flag.DETERMINISTIC;
import static org.apache.apippi.simulator.asm.Flag.GLOBAL_METHODS;
import static org.apache.apippi.simulator.asm.Flag.MONITORS;
import static org.apache.apippi.simulator.asm.Flag.NEMESIS;
import static org.apache.apippi.simulator.asm.Flag.NO_PROXY_METHODS;
import static org.apache.apippi.simulator.asm.TransformationKind.HASHCODE;
import static org.apache.apippi.simulator.asm.TransformationKind.SYNCHRONIZED;
import static org.apache.apippi.simulator.asm.Utils.deterministicToString;
import static org.apache.apippi.simulator.asm.Utils.visitEachRefType;
import static org.apache.apippi.simulator.asm.Utils.generateTryFinallyProxyCall;
...
{
    private static final List<AbstractInsnNode> DETERMINISM_SETUP = singletonList(new MethodInsnNode(INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptibleThread", "enterDeterministicMethod", "()V", false));
    private static final List<AbstractInsnNode> DETERMINISM_CLEANUP = singletonList(new MethodInsnNode(INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptibleThread", "exitDeterministicMethod", "()V", false));
