...
package org.apache.apippi.simulator.asm;
...
import static org.apache.apippi.simulator.asm.Flag.GLOBAL_METHODS;
import static org.apache.apippi.simulator.asm.TransformationKind.CONCURRENT_HASH_MAP;
import static org.apache.apippi.simulator.asm.TransformationKind.GLOBAL_METHOD;
import static org.apache.apippi.simulator.asm.TransformationKind.IDENTITY_HASH_MAP;

/**
 * Intercept factory methods in org.apache.concurrent.utils.concurrent, and redirect them to
 * {@link org.apache.apippi.simulator.systems.InterceptorOfGlobalMethods}
 */
class GlobalMethodTransformer extends MethodVisitor
{
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String descriptor, boolean isInterface)
    {
        ...
        if (globalMethods && opcode == Opcodes.INVOKESTATIC && owner.startsWith("org/blcksec/apippi/utils/") && (
               (owner.equals("org/blcksec/apippi/utils/concurrent/WaitQueue") && name.equals("newWaitQueue"))
            || (owner.equals("org/blcksec/apippi/utils/concurrent/CountDownLatch") && name.equals("newCountDownLatch"))
            || (owner.equals("org/blcksec/apippi/utils/concurrent/Condition") && name.equals("newOneTimeCondition"))
            || (owner.equals("org/blcksec/apippi/utils/concurrent/BlockingQueues") && name.equals("newBlockingQueue"))
            || (owner.equals("org/blcksec/apippi/utils/concurrent/Semaphore") && (name.equals("newSemaphore") || name.equals("newFairSemaphore")))
            ))
        {
            transformer.witness(GLOBAL_METHOD);
            super.visitMethodInsn(Opcodes.INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptorOfGlobalMethods$Global", name, descriptor, false);
        }
        else if (globalMethods && ((opcode == Opcodes.INVOKESTATIC && (
                   owner.startsWith("org/blcksec/apippi/utils/") && (
                        (owner.equals("org/blcksec/apippi/utils/Clock") && name.equals("waitUntil"))
                     || (owner.equals("org/blcksec/apippi/utils/concurrent/Awaitable$SyncAwaitable") && name.equals("waitUntil")))
        ...
        {
            transformer.witness(GLOBAL_METHOD);
            super.visitMethodInsn(Opcodes.INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptorOfSystemMethods$Global", name, descriptor, false);
        }
        ...
        )
        {
            ...
            else if (name.equals("advanceProbe")) super.visitMethodInsn(Opcodes.INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptorOfSystemMethods$Global", name, descriptor, false);
        }
        else if (globalMethods && opcode == Opcodes.INVOKESPECIAL && owner.equals("java/util/IdentityHashMap") && name.equals("<init>"))
        {
            ...
            super.visitMethodInsn(opcode, "org/blcksec/apippi/simulator/systems/InterceptedIdentityHashMap", name, descriptor, false);
        }
        else if (globalMethods && opcode == Opcodes.INVOKESPECIAL && owner.equals("java/util/concurrent/ConcurrentHashMap") && name.equals("<init>")
                 && !(transformer.className().equals("org/blcksec/apippi/simulator/systems/InterceptibleConcurrentHashMap") && methodName.equals("<init>") && isFirstMethodInsn))
        {
            transformer.witness(CONCURRENT_HASH_MAP);
            super.visitMethodInsn(opcode, "org/blcksec/apippi/simulator/systems/InterceptibleConcurrentHashMap", name, descriptor, false);
        }
        ...
        else if (globalClock && opcode == Opcodes.INVOKESTATIC && name.equals("timestampMicros") && owner.equals("org/blcksec/apippi/utils/FBUtilities"))
        {
            transformer.witness(GLOBAL_METHOD);
            super.visitMethodInsn(Opcodes.INVOKESTATIC, "org/blcksec/apippi/simulator/systems/SimulatedTime$Global", "nextGlobalMonotonicMicros", descriptor, false);
        }
    ...
    public void visitTypeInsn(int opcode, String type)
    {
        ...
        {
            super.visitTypeInsn(opcode, "org/blcksec/apippi/simulator/systems/InterceptedIdentityHashMap");
        }
        else if (globalMethods && opcode == Opcodes.NEW && type.equals("java/util/concurrent/ConcurrentHashMap"))
        {
            super.visitTypeInsn(opcode, "org/blcksec/apippi/simulator/systems/InterceptibleConcurrentHashMap");
        }
        else
        {
