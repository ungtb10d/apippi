...
import static org.apache.apippi.simulator.asm.Flag.LOCK_SUPPORT;
import static org.apache.apippi.simulator.asm.Flag.NO_PROXY_METHODS;
import static org.apache.apippi.simulator.asm.Flag.SYSTEM_CLOCK;
import static org.apache.apippi.simulator.asm.InterceptClasses.BYTECODE_VERSION;
...
public class InterceptAgent
{
        ...
        class RandomVisitor extends ClassVisitor
        {
            ...
            public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions)
            {
                if (descriptor.equals("()V") && name.equals("<init>"))
                {
                    ...
                    visitor.visitLabel(new Label());
                    visitor.visitIntInsn(ALOAD, 0);
                    visitor.visitMethodInsn(INVOKESTATIC, "org/blcksec/apippi/simulator/systems/InterceptorOfSystemMethods$Global", "randomSeed", "()J", false);
    ...
    private static byte[] transformThreadLocalRandom(byte[] bytes)
    {
        ...
        {
            // apippiRelevantProperties is not available to us here
            final boolean determinismCheck = System.getProperty("apippi.test.simulator.determinismcheck", "none").matches("relaxed|strict");
