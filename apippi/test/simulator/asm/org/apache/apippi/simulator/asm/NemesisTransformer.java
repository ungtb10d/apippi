...
import static org.apache.apippi.simulator.asm.TransformationKind.FIELD_NEMESIS;
import static org.apache.apippi.simulator.asm.TransformationKind.SIGNAL_NEMESIS;

/**
 * Insert nemesis points at all obvious thread signalling points (execution and blocking primitive methods),
 * as well as to any fields annotated with {@link org.apache.apippi.utils.Nemesis}.
 *
...
class NemesisTransformer extends MethodVisitor
{
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String descriptor, boolean isInterface)
    {
        ...
        && (owner.startsWith("org/blcksec/apippi/concurrent") || owner.startsWith("org/blcksec/apippi/utils/concurrent")) && (
               (owner.equals("org/blcksec/apippi/utils/concurrent/CountDownLatch") && name.equals("decrement"))
            || (owner.equals("org/blcksec/apippi/utils/concurrent/Condition") && name.equals("signal"))
            || (owner.equals("org/blcksec/apippi/utils/concurrent/Semaphore") && name.equals("release"))
            || ((owner.equals("org/blcksec/apippi/concurrent/ExecutorPlus")
                 || owner.equals("org/blcksec/apippi/concurrent/LocalAwareExecutorPlus")
                 || owner.equals("org/blcksec/apippi/concurrent/ScheduledExecutorPlus")
                 || owner.equals("org/blcksec/apippi/concurrent/SequentialExecutorPlus")
                 || owner.equals("org/blcksec/apippi/concurrent/LocalAwareSequentialExecutorPlus")
