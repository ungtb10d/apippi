...
import static org.apache.apippi.simulator.SimulationRunner.RecordOption.VALUE;
        ...
        public void writeThread() throws IOException
        {
            ...
            if (withCallSites)
            {
                ...
                String trace = Arrays.stream(ste, 3, ste.length)
                                     .filter(st ->    !st.getClassName().equals("org.apache.apippi.simulator.debug.Record")
                                                   && !st.getClassName().equals("org.apache.apippi.simulator.SimulationRunner$Record")
