...
package org.apache.apippi.simulator;
...
import org.apache.apippi.simulator.Debug.Info;
import org.apache.apippi.simulator.Debug.Levels;
import org.apache.apippi.simulator.cluster.ClusterActions.TopologyChange;
import org.apache.apippi.simulator.debug.SelfReconcile;
import org.apache.apippi.simulator.systems.InterceptedWait;
import org.apache.apippi.simulator.systems.InterceptedWait.CaptureSites.Capture;
import org.apache.apippi.simulator.systems.InterceptibleThread;
import org.apache.apippi.simulator.systems.InterceptorOfGlobalMethods;
import org.apache.apippi.simulator.utils.ChanceRange;
import org.apache.apippi.utils.Clock;
import org.apache.apippi.utils.Hex;
import org.apache.apippi.utils.concurrent.UncheckedInterruptedException;

import static java.util.Arrays.stream;
import static java.util.concurrent.TimeUnit.NANOSECONDS;
import static org.apache.apippi.config.apippiRelevantProperties.BATCH_COMMIT_LOG_SYNC_INTERVAL;
import static org.apache.apippi.config.apippiRelevantProperties.apippi_JMX_REMOTE_PORT;
import static org.apache.apippi.config.apippiRelevantProperties.CLOCK_GLOBAL;
import static org.apache.apippi.config.apippiRelevantProperties.CLOCK_MONOTONIC_APPROX;
import static org.apache.apippi.config.apippiRelevantProperties.CLOCK_MONOTONIC_PRECISE;
import static org.apache.apippi.config.apippiRelevantProperties.DETERMINISM_CONSISTENT_DIRECTORY_LISTINGS;
import static org.apache.apippi.config.apippiRelevantProperties.DETERMINISM_UNSAFE_UUID_NODE;
import static org.apache.apippi.config.apippiRelevantProperties.DISABLE_SSTABLE_ACTIVITY_TRACKING;
import static org.apache.apippi.config.apippiRelevantProperties.DETERMINISM_SSTABLE_COMPRESSION_DEFAULT;
import static org.apache.apippi.config.apippiRelevantProperties.GOSSIPER_SKIP_WAITING_TO_SETTLE;
import static org.apache.apippi.config.apippiRelevantProperties.IGNORE_MISSING_NATIVE_FILE_HINTS;
import static org.apache.apippi.config.apippiRelevantProperties.IS_DISABLED_MBEAN_REGISTRATION;
import static org.apache.apippi.config.apippiRelevantProperties.MEMTABLE_OVERHEAD_SIZE;
import static org.apache.apippi.config.apippiRelevantProperties.MIGRATION_DELAY;
import static org.apache.apippi.config.apippiRelevantProperties.PAXOS_REPAIR_RETRY_TIMEOUT_IN_MS;
import static org.apache.apippi.config.apippiRelevantProperties.RING_DELAY;
import static org.apache.apippi.config.apippiRelevantProperties.SHUTDOWN_ANNOUNCE_DELAY_IN_MS;
import static org.apache.apippi.config.apippiRelevantProperties.SYSTEM_AUTH_DEFAULT_RF;
import static org.apache.apippi.config.apippiRelevantProperties.TEST_IGNORE_SIGAR;
...
import static org.apache.apippi.simulator.debug.Reconcile.reconcileWith;
import static org.apache.apippi.simulator.debug.Record.record;
import static org.apache.apippi.simulator.debug.SelfReconcile.reconcileWithSelf;
import static org.apache.apippi.simulator.utils.IntRange.parseRange;
import static org.apache.apippi.simulator.utils.LongRange.parseNanosRange;
...
public class SimulationRunner
{
    ...
    public static void beforeAll()
    {
        ...
        for (apippiRelevantProperties property : Arrays.asList(CLOCK_GLOBAL, CLOCK_MONOTONIC_APPROX, CLOCK_MONOTONIC_PRECISE))
            property.setString("org.apache.apippi.simulator.systems.SimulatedTime$Delegating");
        ...
        System.setProperty("apippi.libjemalloc", "-");
        System.setProperty("apippi.dtest.api.log.topology", "false");
        ...
        System.setProperty("apippi.allow_alter_rf_during_range_movement", "true");

        for (apippiRelevantProperties property : Arrays.asList(CLOCK_GLOBAL, CLOCK_MONOTONIC_APPROX, CLOCK_MONOTONIC_PRECISE))
            property.setString("org.apache.apippi.simulator.systems.SimulatedTime$Global");

        apippi_JMX_REMOTE_PORT.setString("");
        RING_DELAY.setInt(0);
