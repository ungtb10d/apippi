...
import static org.apache.apippi.simulator.asm.InterceptClasses.dotsToSlashes;
import static org.apache.apippi.simulator.asm.NemesisFieldKind.SIMPLE;
...
public class NemesisFieldSelectors
{
    ...
    static
    {
        ...
        new Reflections(ConfigurationBuilder.build("org.apache.apippi").addScanners(new FieldAnnotationsScanner()))
