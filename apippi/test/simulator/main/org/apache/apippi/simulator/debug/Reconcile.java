    ...
    public static class AbstractReconciler
    {
        ...
        private String ourCallSite()
        {
            ...
            return Arrays.stream(ste, 4, ste.length)
                         .filter(st -> !st.getClassName().equals("org.apache.apippi.simulator.debug.Reconcile")
                                       && !st.getClassName().equals("org.apache.apippi.simulator.SimulationRunner$Reconcile")
