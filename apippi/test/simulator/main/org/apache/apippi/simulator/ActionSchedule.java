...
import org.apache.apippi.simulator.OrderOn.OrderOnId;
import org.apache.apippi.simulator.Ordered.Sequence;
import org.apache.apippi.simulator.systems.SimulatedTime;
import org.apache.apippi.simulator.utils.SafeCollections;
import org.apache.apippi.utils.CloseableIterator;
import org.apache.apippi.utils.Throwables;

import static org.apache.apippi.simulator.Action.Modifier.DAEMON;
import static org.apache.apippi.simulator.Action.Modifier.STREAM;
import static org.apache.apippi.simulator.Action.Phase.CONSEQUENCE;
import static org.apache.apippi.simulator.Action.Phase.READY_TO_SCHEDULE;
import static org.apache.apippi.simulator.Action.Phase.RUNNABLE;
import static org.apache.apippi.simulator.Action.Phase.SCHEDULED;
import static org.apache.apippi.simulator.Action.Phase.SEQUENCED_POST_SCHEDULED;
import static org.apache.apippi.simulator.Action.Phase.SEQUENCED_PRE_SCHEDULED;
import static org.apache.apippi.simulator.ActionSchedule.Mode.TIME_LIMITED;
...
import static org.apache.apippi.simulator.SimulatorUtils.dumpStackTraces;
 ...
 *
 * Note there is a distinct scheduling mechanism {@link org.apache.apippi.simulator.Action.Modifier#WITHHOLD}
...
public class ActionSchedule implements CloseableIterator<Object>, LongConsumer
{
    ...
    public boolean hasNext()
    {
        ...
        if (!sequences.isEmpty())
        {
            ...
            {
                logger.error("Simulation failed to make progress. Run with -Dapippi.test.simulator.debug=true to see the blocked task graph. Blocked tasks:");
                actions = sequences.values()
                                   .stream()
