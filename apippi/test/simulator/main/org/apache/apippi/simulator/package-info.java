 ...
 * from a snippet of code to an entire apippi cluster. A simulation execution
 * consists of an {@link org.apache.apippi.simulator.ActionPlan} containing various
 * {@link org.apache.apippi.simulator.Action} to simulate. Each {@code Action} represents
 ...
 * The execution order is determined by an {@link org.apache.apippi.simulator.ActionSchedule}
 * and its {@link org.apache.apippi.simulator.RunnableActionScheduler} and
 * {@link org.apache.apippi.simulator.FutureActionScheduler}.
 *
 * An {@code Action} may be simple, representing some simulation book-keeping or setup, but most
 * commonly derives from {@link org.apache.apippi.simulator.systems.SimulatedAction}.
 * These simulated actions represent some execution context on an {@link org.apache.apippi.simulator.systems.InterceptibleThread},
 ...
 * interaction with it.
 *
 * {@code Action} have various causality mechanisms to control their behaviour, in the form of {@link org.apache.apippi.simulator.Action.Modifier}
 * options that may be applied to themselves, transitively to all of their descendants, or to specific verbs that are
 * consequences of a {@code SimulatedAction}. Also in the form of {@link org.apache.apippi.simulator.OrderOn}
 ...
 *
 * Simulation is achieved through various simulated systems ({@link org.apache.apippi.simulator.systems})
 * and byte weaving ({@link org.apache.apippi.simulator.asm}) of implementation classes, and chaos is introduced
 * via {@link org.apache.apippi.simulator.cluster.KeyspaceActions} and also {@link org.apache.apippi.utils.Nemesis}
 ...
 *
 * The first major simulation introduced was {@link org.apache.apippi.simulator.paxos.PaxosSimulationRunner} which
 ...
 *    -Dapippi.test.simulator.livenesscheck=false
 *    -Dapippi.test.simulator.debug=true
 *
