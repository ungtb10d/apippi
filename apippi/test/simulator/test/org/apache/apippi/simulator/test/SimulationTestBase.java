...
package org.apache.apippi.simulator.test;
...
import org.apache.apippi.distributed.api.ConsistencyLevel;
...
import org.apache.apippi.distributed.shared.InstanceClassLoader;
import org.apache.apippi.simulator.Action;
import org.apache.apippi.simulator.ActionList;
import org.apache.apippi.simulator.ActionPlan;
import org.apache.apippi.simulator.ActionSchedule;
import org.apache.apippi.simulator.ActionSchedule.Work;
import org.apache.apippi.simulator.FutureActionScheduler;
import org.apache.apippi.simulator.RunnableActionScheduler;
import org.apache.apippi.simulator.ClusterSimulation;
import org.apache.apippi.simulator.Debug;
import org.apache.apippi.simulator.RandomSource;
import org.apache.apippi.simulator.Simulation;
import org.apache.apippi.simulator.SimulationRunner;
import org.apache.apippi.simulator.asm.InterceptClasses;
...
import org.apache.apippi.simulator.systems.SimulatedQuery;
...
import static org.apache.apippi.simulator.ActionSchedule.Mode.STREAM_LIMITED;
import static org.apache.apippi.simulator.ActionSchedule.Mode.UNLIMITED;
import static org.apache.apippi.simulator.ClusterSimulation.ISOLATE;
import static org.apache.apippi.simulator.ClusterSimulation.SHARE;
import static org.apache.apippi.simulator.SimulatorUtils.failWithOOM;
import static org.apache.apippi.simulator.systems.InterceptedWait.CaptureSites.Capture.NONE;
import static org.apache.apippi.simulator.utils.KindOfSequence.UNIFORM;
    ...
    static abstract class DTestClusterSimulation implements Simulation
    {
        ...
        public Action schemaChange(int node, String query)
        {
            return new SimulatedQuery(String.format("Schema change: %s", query),
                                      ...
                                      cluster.get(node),
                                      query,
                                      org.apache.apippi.distributed.api.ConsistencyLevel.ALL,
                                      null);
        }
