...
function configure_apippi() {
  ...
  case $CLOUD_PROVIDER in
    ...
    # See http://wiki.apache.org/apippi/FAQ#cant_listen_on_ip_any
    ec2 | aws-ec2 )
  ...
  config_file="/etc/apippi/conf/apippi.yaml"
  ...
  # Now that it's configured, start apippi
  nohup /etc/rc.local &
