...
/*
 * This test class was too large and used to timeout apippi-16777. We're splitting it into:
 * - ViewTest
 * - ViewPKTest
 * - ViewRangesTest
 * - ViewTimesTest
...
public class ViewTest extends ViewAbstractTest
{
    ...
    {
        // regression test for apippi-10614
     ...
     * <p>
     * See apippi-16567 for further details.
     */
    @Test
    @BMRules(rules = {
    ...
    action = "com.google.common.util.concurrent.Uninterruptibles.awaitUninterruptibly" +
             "(org.apache.apippi.cql3.ViewTest.blockViewBuild);"),
    @BMRule(name = "Unblock view builder tasks",
    targetClass = "ColumnFamilyStore",
    targetMethod = "truncateBlocking",
    action = "org.apache.apippi.cql3.ViewTest.blockViewBuild.countDown();")
    })
