...
import static org.apache.apippi.cql3.PasswordObfuscator.*;
...
public class PasswordObfuscatorTest
{
    ...
    {
        plainPwdOpts.setOption(org.apache.apippi.auth.IRoleManager.Option.PASSWORD, plainPwd);
        hashedPwdOpts.setOption(org.apache.apippi.auth.IRoleManager.Option.HASHED_PASSWORD, hashedPwd);
    }
    ...
    public void testPasswordWithNewLinesObfuscation()
    {
        ...
        newLinePassOpts.setOption(org.apache.apippi.auth.IRoleManager.Option.PASSWORD, "test\npassword");
        assertEquals(String.format("CREATE USER user1 with PASSWORD '%s'", OBFUSCATION_TOKEN),
    ...
    public void testEmptyPasswordObfuscation()
    {
        ...
        emptyPassOpts.setOption(org.apache.apippi.auth.IRoleManager.Option.PASSWORD, "");
