...
/* ViewComplexTest class has been split into multiple ones because of timeout issues (apippi-16670, apippi-17167)
...
public class ViewComplexTTLTest extends ViewAbstractParameterizedTest
{
    ...
    {
        // apippi-13657 if base column used in view pk is ttled, then view row is considered dead
    ...
    {
        // apippi-13127 not ttled unselected column in base should keep view row alive
    ...
    {
        // apippi-13127 when liveness timestamp tie, greater localDeletionTime should win if both are expiring.
        createTable("create table %s (p int, c int, v int, primary key(p, c))");
