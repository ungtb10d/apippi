...
import org.apache.apippi.cql3.Attributes;
...
import org.apache.apippi.db.ExpirationDateOverflowHandling;
import org.apache.apippi.db.Keyspace;
import org.apache.apippi.db.rows.AbstractCell;
...
public class TTLTest extends CQLTester
{
     ...
     * {@link AbstractCell#localDeletionTime()} field limitation (apippi-14092)
     */
     ...
     * allowed expiration time {@link org.apache.apippi.db.rows.Cell#MAX_DELETION_TIME} (2038-01-19T03:14:06+00:00)
     */
    ...
    public void testRecoverOverflowedExpirationWithScrub(boolean simple, boolean clustering, boolean runScrub, boolean runSStableScrub,  boolean reinsertOverflowedTTL) throws Throwable
    {
        ...
        catch (Throwable e)
        {
            ...
            // but we need to catch any exceptions we might run into bc of the hack. See apippi-16546
        }
    }
