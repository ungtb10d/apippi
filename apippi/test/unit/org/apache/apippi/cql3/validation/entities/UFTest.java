...
import org.apache.apippi.cql3.functions.JavaBasedUDFunction;
...
public class UFTest extends CQLTester
{
    ...
    public void testSchemaChange() throws Throwable
    {
        ...
        // The function with nested tuple should be created without throwing InvalidRequestException. See apippi-15857
    ...
    public void testFunctionOverloading() throws Throwable
    {
        ...
        // 'overloaded' has multiple overloads - so it has to fail (apippi-7812)
        ...
        assertRows(execute("SELECT v FROM %s WHERE k = " + fOverload + "((int)?)", 3), row(1));
        // overloaded has just one overload now - so the following DROP FUNCTION is not ambigious (apippi-7812)
