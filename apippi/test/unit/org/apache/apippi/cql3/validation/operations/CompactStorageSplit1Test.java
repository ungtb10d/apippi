...
import org.apache.apippi.cql3.validation.entities.SecondaryIndexTest;
...
public class CompactStorageSplit1Test extends CQLTester
{
    ...
    public void testCounterAndColumnSelection() throws Throwable
    {
        for (String compactStorageClause : new String[]{ "", " WITH COMPACT STORAGE" })
        {
            ...
            // Querying, but not including the counter. Pre-apippi-11726, this made us query the counter but include
            // it's value, which broke at merge (post-apippi-11726 are special cases to never skip values).
    ...
    public void testDenseCompositeTable() throws Throwable
    {
        ...
        // we don't have to include all of the clustering columns (see apippi-7990)
