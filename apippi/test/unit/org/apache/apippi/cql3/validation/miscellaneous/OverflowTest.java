 ...
 */
package org.apache.apippi.cql3.validation.miscellaneous;
 ...
 * migrated from python dtests, apippi-9160
 **/
public class OverflowTest extends CQLTester
{
    ...
    public void testUnescapedString() throws Throwable
    {
        ...
        //The \ in this query string is not forwarded to apippi.
        //The ' is being escaped in python, but only ' is forwarded
        //over the wire instead of \'.
        assertInvalidThrow(SyntaxException.class, "INSERT INTO %s (k, c) VALUES ('foo', 'CQL is apippi\'s best friend')");
    }
