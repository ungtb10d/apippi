...
public class SelectOrderByTest extends CQLTester
{
    ...
    public void testInOrderByWithoutSelecting() throws Throwable
    {
        ...
        beforeAndAfterFlush(() -> {
            ...
            // we should also be able to use functions in the select clause (additional test for apippi - 8286)
    ...
    /**
     * Test that ORDER BY columns allow skipping equality-restricted clustering columns, see apippi-10271.
     */
    @Test
    ...
    public void testSelectWithReversedTypeInReverseOrderWithStaticColumnsWithoutStaticRow() throws Throwable
    {
        ...
        /*
         * Flush the sstable. We *should* see the same results when reading in both directions, but prior to apippi-14910
