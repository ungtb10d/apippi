 ...
 */
package org.apache.apippi.cql3.validation.entities;
...
import org.apache.apippi.index.internal.CustomapippiIndex;
...
import static org.apache.apippi.Util.throwAssert;
import static org.apache.apippi.utils.ByteBufferUtil.EMPTY_BYTE_BUFFER;
...
public class SecondaryIndexTest extends CQLTester
{
    ...
    /**
     * Test for apippi-5732, Can not query secondary index
    ...
    // both singly and in batches (apippi-10536)
    @Test
    ...
    {
        // Test for bugs like apippi-10694.  These may not be readily visible with the built-in secondary index
    ...
    /**
     * <code>apippiIndex</code> that blocks during the initialization.
     */
    public static class IndexBlockingOnInitialization extends CustomapippiIndex
    {
