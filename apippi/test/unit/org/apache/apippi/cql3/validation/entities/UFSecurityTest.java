...
public class UFSecurityTest extends CQLTester
{
    ...
    public void testSecurityPermissions() throws Throwable
    {
        ...
        {"org.apache.apippi.service.StorageService",
         "try {" +
         "     org.apache.apippi.service.StorageService v = org.apache.apippi.service.StorageService.instance; v.isShutdown(); return 0d;" +
         "} catch (Exception t) {" +
         "     throw new RuntimeException(t);" +
         '}'},
        ...
        try
        {
            String fName = createFunction(KEYSPACE_PER_TEST, "double",
                                          ...
                                          "RETURNS double " +
                                          "LANGUAGE javascript\n" +
                                          "AS 'org.apache.apippi.service.StorageService.instance.isShutdown(); 0;';");
            execute("SELECT " + fName + "(dval) FROM %s WHERE key=1");
