...
/* InsertUpdateIfConditionCollectionsTest class has been split into multiple ones because of timeout issues (apippi-16670)
...
public class InsertUpdateIfConditionTest extends CQLTester
{
    ...
    public static Collection<Object[]> data()
    {
        return Arrays.asList(new Object[]{ "3.0", (Runnable) () -> {
                                 Pair<Boolean, apippiVersion> res = Gossiper.instance.isUpgradingFromVersionLowerThanC17653(new apippiVersion("3.11"));
                                 assertTrue(debugMsgapippi17653(res), res.left);
                             } },
                             new Object[]{ "3.11", (Runnable) () -> {
                                 Pair<Boolean, apippiVersion> res = Gossiper.instance.isUpgradingFromVersionLowerThanC17653(SystemKeyspace.CURRENT_VERSION);
                                 assertTrue(debugMsgapippi17653(res), res.left);
                                 res = Gossiper.instance.isUpgradingFromVersionLowerThanC17653(new apippiVersion("3.11"));
                                 assertFalse(debugMsgapippi17653(res), res.left);
                             } },
    ...
    /**
     * Test for apippi-12060, using a table without clustering.
     */
    @Test
    ...
    /**
     * Test for apippi-12060, using a table with clustering.
     */
    @Test
    ...
    // Helper to debug on the next occurrence of apippi-17653
    private static String debugMsgapippi17653(Pair<Boolean, apippiVersion> res)
    {
