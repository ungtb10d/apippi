...
import org.apache.apippi.cql3.Duration;
...
import org.apache.apippi.db.memtable.TrieMemtable;
import org.apache.apippi.db.partitions.Partition;
...
import org.apache.apippi.triggers.ITrigger;
import org.apache.apippi.utils.ByteBufferUtil;

import static java.lang.String.format;
import static org.apache.apippi.cql3.Duration.NANOS_PER_HOUR;
import static org.apache.apippi.cql3.Duration.NANOS_PER_MICRO;
import static org.apache.apippi.cql3.Duration.NANOS_PER_MILLI;
import static org.apache.apippi.cql3.Duration.NANOS_PER_MINUTE;
...
public class CreateTest extends CQLTester
{
   ...
   /**
    ...
    public void testCreateTableWithMemtable() throws Throwable
    {
        ...
        assertThrowsConfigurationException("Memtable class org.apache.apippi.db.memtable.SkipListMemtable does not accept any futher parameters, but {invalid=throw} were given.",
                                           "CREATE TABLE %s (a text, b int, c int, primary key (a, b))"
        ...
        assertThrowsConfigurationException("Memtable class org.apache.apippi.db.memtable.TestMemtable does not accept any futher parameters, but {invalid=throw} were given.",
                                           "CREATE TABLE %s (a text, b int, c int, primary key (a, b))"
    ...
    public void testCreateTableWithCompression() throws Throwable
    {
        ...
        assertSchemaOption("compression", map("chunk_length_in_kb", "16", "class", "org.apache.apippi.io.compress.SnappyCompressor", "min_compress_ratio", "2.0"));

        createTable("CREATE TABLE %s (a text, b int, c int, primary key (a, b))"
                    + " WITH compression = { 'sstable_compression' : 'SnappyCompressor', 'min_compress_ratio' : 1 };");
        assertSchemaOption("compression", map("chunk_length_in_kb", "16", "class", "org.apache.apippi.io.compress.SnappyCompressor", "min_compress_ratio", "1.0"));

        createTable("CREATE TABLE %s (a text, b int, c int, primary key (a, b))"
                    + " WITH compression = { 'sstable_compression' : 'SnappyCompressor', 'min_compress_ratio' : 0 };");
        assertSchemaOption("compression", map("chunk_length_in_kb", "16", "class", "org.apache.apippi.io.compress.SnappyCompressor"));
