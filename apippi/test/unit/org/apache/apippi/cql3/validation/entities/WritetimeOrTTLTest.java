...
public class WritetimeOrTTLTest extends CQLTester
{
    ...
    public void testFrozenList() throws Throwable
    {
        ...
        // truncate, since previous columns would win on reconcilliation because of their TTL (apippi-14592)
        execute("TRUNCATE TABLE %s");
    ...
    public void testFunctions() throws Throwable
    {
        ...
        // this is something that we might want to improve in the future (apippi-17811).
