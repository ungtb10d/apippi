...
import org.apache.apippi.cql3.functions.UDFByteCodeVerifier;
import org.apache.apippi.cql3.validation.entities.udfverify.*;
...
public class UFVerifierTest extends CQLTester
{
    ...
    {
        assertEquals(new HashSet<>(Collections.singletonList("call to org.apache.apippi.config.DatabaseDescriptor.getClusterName()")),
