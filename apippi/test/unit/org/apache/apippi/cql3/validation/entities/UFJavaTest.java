...
public class UFJavaTest extends CQLTester
{
    ...
    public void testJavaUTCollections() throws Throwable
    {
        ...
        // The mix of the package names org.apache.apippi.cql3.functions.types and com.datastax.driver.core is
        // intentional to test the replacement of com.datastax.driver.core with org.apache.apippi.cql3.functions.types.
        String fName1 = createFunction(KEYSPACE, "list<frozen<" + type + ">>",
                                       ...
                                       "LANGUAGE java\n" +
                                       "AS $$" +
                                       "     org.apache.apippi.cql3.functions.types.UDTValue udtVal = (com.datastax.driver.core.UDTValue)lst.get(1);" +
        ...
        String fName2 = createFunction(KEYSPACE, "set<frozen<" + type + ">>",
                                       ...
                                       "LANGUAGE java\n" +
                                       "AS $$" +
                                       "     com.datastax.driver.core.UDTValue udtVal = (org.apache.apippi.cql3.functions.types.UDTValue)st.iterator().next();" +
                                       "     return udtVal.getString(\"txt\");$$;");
        String fName3 = createFunction(KEYSPACE, "map<int, frozen<" + type + ">>",
                                       ...
                                       "LANGUAGE java\n" +
                                       "AS $$" +
                                       "     org.apache.apippi.cql3.functions.types.UDTValue udtVal = (com.datastax.driver.core.UDTValue)mp.get(Integer.valueOf(3));" +
                                       "     return udtVal.getString(\"txt\");$$;");
