...
/* ViewFilteringTest class has been split into multiple ones because of timeout issues (apippi-16670, apippi-17167)
...
public class ViewFiltering1Test extends ViewAbstractParameterizedTest
{
    ...
    public static void startup()
    {
        ...
        System.setProperty("apippi.mv.allow_filtering_nonkey_columns_unsafe", "true");
    }

    @AfterClass
    public static void tearDown()
    {
        System.setProperty("apippi.mv.allow_filtering_nonkey_columns_unsafe", "false");
    }

    // TODO will revise the non-pk filter condition in MV, see apippi-11500
    @Ignore
    @Test
    ...
    {
        // apippi-13547: able to shadow entire view row if base column used in filter condition is modified
