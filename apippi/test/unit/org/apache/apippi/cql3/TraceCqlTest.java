...
import org.apache.apippi.tracing.TraceStateImpl;
...
public class TraceCqlTest extends CQLTester
{
    ...
    {
        // make sure we wait for trace events to complete, see apippi-12754
    ...
    public void testCqlStatementTracing() throws Throwable
    {
        ...
        try (Session session = sessionNet())
        {
            ...
            execute("INSERT INTO %s (id, v1, v2, v3) values (?, ?, ?, ?)", 274, "apippiRocks", tuple(9, "foo", 3.14f),
