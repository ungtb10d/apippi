...
import org.apache.apippi.exceptions.PreparedQueryNotFoundException;
import org.apache.apippi.index.StubIndex;
import org.apache.apippi.serializers.BooleanSerializer;
import org.apache.apippi.serializers.Int32Serializer;
...
public class PreparedStatementsTest extends CQLTester
{
    ...
    {
        // Verify the behavior of apippi-10786 (result metadata IDs) on the protocol level.
        ...
        try (SimpleClient simpleClient = newSimpleClient(ProtocolVersion.BETA.orElse(ProtocolVersion.CURRENT)))
        {
            ...
            prepSelect = verifyMetadataFlagsWithLWTsSelect(simpleClient,
                                                           ...
                                                           Arrays.asList(Int32Serializer.instance.serialize(1),
                                                                         ...
                                                                         Int32Serializer.instance.serialize(20)),
                                                           EnumSet.of(org.apache.apippi.cql3.ResultSet.Flag.GLOBAL_TABLES_SPEC));
            ...
            prepSelect = verifyMetadataFlagsWithLWTsSelect(simpleClient,
                                                           ...
                                                           Arrays.asList(Int32Serializer.instance.serialize(1),
                                                                         ...
                                                                         null),
                                                           EnumSet.of(org.apache.apippi.cql3.ResultSet.Flag.GLOBAL_TABLES_SPEC,
                                                                      org.apache.apippi.cql3.ResultSet.Flag.METADATA_CHANGED));
    ...
    private ResultMessage.Prepared verifyMetadataFlagsWithLWTsSelect(SimpleClient simpleClient,
                                                                     ...
                                                                     EnumSet<org.apache.apippi.cql3.ResultSet.Flag> expectedFlags)
    {
        ...
        EnumSet<org.apache.apippi.cql3.ResultSet.Flag> resultFlags = rows.result.metadata.getFlags();
        ...
        if (resultFlags.contains(org.apache.apippi.cql3.ResultSet.Flag.METADATA_CHANGED))
                                                   ...
                                                   List<ByteBuffer> expectedRow)
    {
        ...
        ResultMessage.Rows rows = (ResultMessage.Rows) result;
        EnumSet<org.apache.apippi.cql3.ResultSet.Flag> resultFlags = rows.result.metadata.getFlags();
        assertEquals(EnumSet.of(org.apache.apippi.cql3.ResultSet.Flag.GLOBAL_TABLES_SPEC),
                     resultFlags);
        assertEquals(columnNames.size(),
                     rows.result.metadata.getColumnCount());
        assertEquals(columnNames,
