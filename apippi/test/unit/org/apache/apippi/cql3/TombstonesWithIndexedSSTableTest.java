...
public class TombstonesWithIndexedSSTableTest extends CQLTester
{
    ...
    {
        // That test reproduces the bug from apippi-11158 where a range tombstone boundary in the column index would
        ...
        while (true)
        {
            ...
            {
                // The line below failed with key caching off (apippi-11158)
        ...
        flush();
        // The line below failed with key caching on (apippi-11158)
        compact();
