...
public class ViewComplexUpdatesTest extends ViewAbstractParameterizedTest
{
    ...
    {
        // apippi-13127: if base column not selected in view are alive, then pk of view row should be alive
    ...
    {
        // apippi-11500 able to shadow old view row with column ts greater tahn pk's ts and re-insert the view row
