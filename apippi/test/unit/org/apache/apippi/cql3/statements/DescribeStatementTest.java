...
import static org.apache.apippi.schema.SchemaConstants.*;
...
public class DescribeStatementTest extends CQLTester
{
    ...
    /**
     * Tests for the error reported in apippi-9064 by:
     *
    ...
    public void testDescribeWithCustomIndex() throws Throwable
    {
        ...
        String indexWithoutOptions = createIndex(KEYSPACE_PER_TEST, "CREATE CUSTOM INDEX ON %s(value) USING 'org.apache.apippi.index.sasi.SASIIndex';");
        String indexWithOptions = createIndex(KEYSPACE_PER_TEST, "CREATE CUSTOM INDEX ON %s(value) USING 'org.apache.apippi.index.sasi.SASIIndex' WITH OPTIONS = {'is_literal': 'false'};");
        ...
        String expectedIndexStmtWithoutOptions = "CREATE CUSTOM INDEX " + indexWithoutOptions + " ON " + KEYSPACE_PER_TEST + "." + table + " (value) USING 'org.apache.apippi.index.sasi.SASIIndex';";
        String expectedIndexStmtWithOptions = "CREATE CUSTOM INDEX " + indexWithOptions + " ON " + KEYSPACE_PER_TEST + "." + table + " (value) USING 'org.apache.apippi.index.sasi.SASIIndex' WITH OPTIONS = {'is_literal': 'false'};";
    ...
    private static String tableParametersCql()
    {
        return "additional_write_policy = '99p'\n" +
               ...
               "    AND cdc = false\n" +
               "    AND comment = ''\n" +
               "    AND compaction = {'class': 'org.apache.apippi.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}\n" +
               "    AND compression = {'chunk_length_in_kb': '16', 'class': 'org.apache.apippi.io.compress.LZ4Compressor'}\n" +
