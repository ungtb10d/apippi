...
public class StreamTransferTaskTest
{
    ...
    public void testScheduleTimeout() throws Exception
    {
        ...
        for (SSTableReader sstable : cfs.getLiveSSTables())
        {
            ...
            task.addTransferStream(new apippiOutgoingFile(StreamOperation.BOOTSTRAP, sstable.selfRef(), sstable.getPositionsForRanges(ranges), ranges, 1));
        }
    ...
    public void testFailSessionDuringTransferShouldNotReleaseReferences() throws Exception
    {
        ...
        for (SSTableReader sstable : cfs.getLiveSSTables())
        {
            ...
            refs.add(ref);
            task.addTransferStream(new apippiOutgoingFile(StreamOperation.BOOTSTRAP, ref, sstable.getPositionsForRanges(ranges), ranges, 1));
        }
        assertEquals(14, task.getTotalNumberOfFiles());
