...
public class NodeProbeTest extends CQLTester
{
     ...
     * {@link org.apache.apippi.config.Config#concurrent_compactors} in the target node, independently of where the
     * tool is used.
     *
     * Before apippi-16104 the warning was based on the local value of {@code concurrent_compactors}, and not in the
