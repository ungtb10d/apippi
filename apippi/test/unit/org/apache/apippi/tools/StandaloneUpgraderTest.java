...
public class StandaloneUpgraderTest extends OfflineToolUtils
{
    ...
    public void testMaybeChangeDocs()
    {
        ...
        String help = "usage: sstableupgrade [options] <keyspace> <cf> [snapshot]\n" + 
                       ...
                       "of apippi.This operation will rewrite the sstables in the specified cf\n" + 
                       "to match the currently installed version of apippi.\n" + 
                       ...
                       "major version older than the major version apippi is currently running.\n" + 
