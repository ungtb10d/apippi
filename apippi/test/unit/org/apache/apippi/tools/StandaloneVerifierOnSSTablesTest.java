 ...
 * Since the tool mainly exercises the {@link org.apache.apippi.db.compaction.Verifier}, we elect to
 * not run every conceivable option as many tests are already covered by {@link org.apache.apippi.db.VerifyTest}.
 * 
 * Note: the complete coverage is composed of:
 * - {@link StandaloneVerifierOnSSTablesTest}
 * - {@link StandaloneVerifierTest}
 * - {@link org.apache.apippi.db.VerifyTest}
 */
public class StandaloneVerifierOnSSTablesTest extends OfflineToolUtils
{
    ...
    public static void setup()
    {
        ...
        System.setProperty("apippi.partitioner", "org.apache.apippi.dht.ByteOrderedPartitioner");
    ...
    public void testCheckVersionWithWrongVersion() throws Exception
    {
        ...
        createAndPopulateTable(keyspace, tableName, cfs -> {
            ...
            for (org.apache.apippi.io.util.File cfsDir : cfs.getDirectories().getCFDirectories())
            {
    ...
    private static void populateTable(ColumnFamilyStore cfs, int partitionsPerSSTable)
    {
        ...
        org.apache.apippi.Util.flush(cfs);
    }
}
