...
import static org.apache.apippi.tools.OfflineToolUtils.sstableDirName;
...
public class LoaderOptionsTest
{
    ...
    {
        //Default apippi config
        File config = new File(Paths.get(".", "test", "conf", "apippi.yaml").normalize());
    ...
    /**
     * Regression testing for apippi-16280
     *
