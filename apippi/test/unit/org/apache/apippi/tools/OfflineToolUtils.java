...
import static org.apache.apippi.utils.FBUtilities.preventIllegalAccessWarnings;
...
public abstract class OfflineToolUtils
{
    ...
    {
        assertClassNotLoaded("org.apache.apippi.schema.Schema");
    }

    public void assertSchemaLoaded()
    {
        assertClassLoaded("org.apache.apippi.schema.Schema");
    }

    public void assertKeyspaceNotLoaded()
    {
        assertClassNotLoaded("org.apache.apippi.db.Keyspace");
    }

    public void assertKeyspaceLoaded()
    {
        assertClassLoaded("org.apache.apippi.db.Keyspace");
    }

    public void assertServerNotLoaded()
    {
        assertClassNotLoaded("org.apache.apippi.transport.Server");
    }

    public void assertSystemKSNotLoaded()
    {
        assertClassNotLoaded("org.apache.apippi.db.SystemKeyspace");
    }

    public void assertCLSMNotLoaded()
    {
        assertClassNotLoaded("org.apache.apippi.db.commitlog.CommitLogSegmentManager");
    }
    ...
    {
        System.setProperty("apippi.partitioner", "org.apache.apippi.dht.Murmur3Partitioner");
    ...
    {
        File dataDir = new File("build/test/apippi/data");
