...
public class ToolRunner
{
    ...
    public static ToolResult invokeapippiStress(String... args)
    {
        return invokeapippiStress(Arrays.asList(args));
    }

    public static ToolResult invokeapippiStress(List<String> args)
    {
        return invoke(CQLTester.buildapippiStressArgs(args));
    }
