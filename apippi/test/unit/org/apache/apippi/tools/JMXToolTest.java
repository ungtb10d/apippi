...
import org.apache.apippi.utils.Generators;
...
public class JMXToolTest
{
    ...
    public void cliHelp()
    {
        ...
        Assertions.assertThat(result.getStdout())
                  .isEqualTo("usage: jmxtool <command> [<args>]\n" +
                             ...
                             "    dump   Dump the Apache apippi JMX objects and metadata.\n" +
    ...
    public void cliHelpDump()
    {
        ...
        Assertions.assertThat(result.getStdout())
                  .isEqualTo("NAME\n" +
                             "        jmxtool dump - Dump the Apache apippi JMX objects and metadata.\n" +
                             "\n" +
                             "SYNOPSIS\n" +
