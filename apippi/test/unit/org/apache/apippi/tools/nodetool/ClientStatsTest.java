...
public class ClientStatsTest
{
    ...
    {
        // Since we run EmbeddedapippiServer, we need to manually associate JMX address; otherwise it won't start
        int jmxPort = CQLTester.getAutomaticallyAllocatedPort(InetAddress.getLoopbackAddress());
        System.setProperty("apippi.jmx.local.port", String.valueOf(jmxPort));
