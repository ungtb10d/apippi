...
public class VerifyTest extends CQLTester
{
    ...
    public static void setup() throws Exception
    {
        ...
        AuthTestUtils.LocalapippiRoleManager roleManager = new AuthTestUtils.LocalapippiRoleManager();
    ...
    public void testMaybeChangeDocs()
    {
        ...
        "\n" +
        "        -f, --force\n" +
        "            Override disabling of verify tool - see apippi-9947 for caveats\n" +
        "\n" +
        "        -h <host>, --host <host>\n" +
