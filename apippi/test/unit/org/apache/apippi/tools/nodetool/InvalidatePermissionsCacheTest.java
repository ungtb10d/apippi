...
import org.apache.apippi.auth.JMXResource;
...
import static org.apache.apippi.auth.AuthTestUtils.getRolePermissionsReadCount;
...
public class InvalidatePermissionsCacheTest extends CQLTester
{
    ...
    public static void setup() throws Exception
    {
        ...
        List<IResource> resources = Arrays.asList(
                ...
                JMXResource.root(),
                JMXResource.mbean("org.apache.apippi.auth:type=*"));
    ...
    public void testInvalidatePermissionsWithIncorrectParameters()
    {
        ...
        assertThat(tool.getExitCode()).isEqualTo(1);
        assertThat(tool.getStdout())
                .isEqualTo(wrapByDefaultNodetoolMessage("An error was encountered when looking up function definition: Unable to find abstract-type class 'org.apache.apippi.db.marshal.x'"));
        assertThat(tool.getCleanedStderr()).isEmpty();
    }
    ...
    public void testInvalidatePermissionsForEveryResourceExceptFunction()
    {
        ...
        assertInvalidation(JMXResource.mbean("org.apache.apippi.auth:type=*"),
                Arrays.asList("--mbean", "org.apache.apippi.auth:type=*"));
    }
