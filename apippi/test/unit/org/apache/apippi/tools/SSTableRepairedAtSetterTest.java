...
public class SSTableRepairedAtSetterTest extends OfflineToolUtils
{
    ...
    public void testMaybeChangeDocs()
    {
        ...
        String help = "This command should be run with apippi stopped, otherwise you will get very strange behavior\n" + 
                      "Verify that apippi is not running and then execute the command like this:\n" + 
