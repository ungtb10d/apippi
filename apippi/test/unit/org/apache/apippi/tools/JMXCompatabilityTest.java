...
import org.apache.apippi.tools.ToolRunner.ToolResult;
...
public class JMXCompatabilityTest extends CQLTester
{
    ...
    private void setupStandardTables() throws Throwable
    {
        ...
        // force loading mbean which apippiDaemon creates
        GCInspector.register();
        apippiDaemon.registerNativeAccess();
    ...
    {
        List<String> excludeObjects = Arrays.asList("org.apache.apippi.metrics:type=ThreadPools.*",
                                                    "org.apache.apippi.internal:.*",
                                                    "org.apache.apippi.metrics:type=DroppedMessage.*",
                                                    "org.apache.apippi.metrics:type=ClientRequest,scope=CASRead,name=ConditionNotMet",
                                                    "org.apache.apippi.metrics:type=Client,name=connectedThriftClients", // removed in apippi-11115
                                                    "org.apache.apippi.request:type=ReadRepairStage", // removed in apippi-13910
                                                    "org.apache.apippi.db:type=HintedHandoffManager", // removed in apippi-15939

                                                    // dropped tables
                                                    "org.apache.apippi.metrics:type=Table,keyspace=system,scope=(schema_aggregates|schema_columnfamilies|schema_columns|schema_functions|schema_keyspaces|schema_triggers|schema_usertypes),name=.*",
        ...
        List<String> excludeAttributes = Arrays.asList("RPCServerRunning", // removed in apippi-11115
                                                       "MaxNativeProtocolVersion");
        List<String> excludeOperations = Arrays.asList("startRPCServer", "stopRPCServer", // removed in apippi-11115
        ...
        diff(excludeObjects, excludeAttributes, excludeOperations, "test/data/jmxdump/apippi-3.0-jmx.yaml");
    }

    @Test
    public void diff311() throws Throwable
    {
        List<String> excludeObjects = Arrays.asList("org.apache.apippi.metrics:type=ThreadPools.*", //lazy initialization in 4.0
                                                    "org.apache.apippi.internal:.*",
                                                    "org.apache.apippi.metrics:type=DroppedMessage,scope=PAGED_RANGE.*", //it was deprecated in the previous major version
                                                    "org.apache.apippi.metrics:type=Client,name=connectedThriftClients", // removed in apippi-11115
                                                    "org.apache.apippi.request:type=ReadRepairStage", // removed in apippi-13910
                                                    "org.apache.apippi.db:type=HintedHandoffManager", // removed in apippi-15939
        ...
        diff(excludeObjects, excludeAttributes, excludeOperations, "test/data/jmxdump/apippi-3.11-jmx.yaml");
    }
    ...
    public void diff40() throws Throwable
    {
        ...
        diff(excludeObjects, excludeAttributes, excludeOperations, "test/data/jmxdump/apippi-4.0-jmx.yaml");
    }
    ...
    public void diff41() throws Throwable
    {
        ...
        diff(excludeObjects, excludeAttributes, excludeOperations, "test/data/jmxdump/apippi-4.1-jmx.yaml");
    }
