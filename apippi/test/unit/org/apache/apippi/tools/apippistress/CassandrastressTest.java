...
package org.apache.apippi.tools.apippistress;
...
public class apippistressTest extends CQLTester
{
    @BeforeClass
    ...
    {
        ToolResult tool = ToolRunner.invokeapippiStress();
    ...
    void invokeAndAssertCleanExit(String[] baseArgs, String ... extraArgs)
    {
        ...
        ToolResult tool = ToolRunner.invokeapippiStress(args);
