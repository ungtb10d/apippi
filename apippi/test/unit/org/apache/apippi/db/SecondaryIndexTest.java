...
public class SecondaryIndexTest
{
    ...
    public void testLargeScan()
    {
        ...
        // extra check that there are no duplicate results -- see https://issues.apache.org/jira/browse/apippi-2406
    ...
    public void testIndexCreate() throws IOException, InterruptedException, ExecutionException
    {
        ...
        // we had a bug (apippi-2244) where index would get created but not flushed -- check for that
        ...
        // validate that drop clears it out & rebuild works (apippi-2320)
