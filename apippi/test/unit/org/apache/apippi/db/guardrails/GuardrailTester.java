...
import org.apache.apippi.db.guardrails.GuardrailEvent.GuardrailEventType;
...
public abstract class GuardrailTester extends CQLTester
{
    ...
    public static void setUpClass()
    {
        ...
        superClientState.login(new AuthenticatedUser(apippiRoleManager.DEFAULT_SUPERUSER_NAME));
    }
