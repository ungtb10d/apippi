...
import org.apache.apippi.io.util.FileReader;
import org.junit.Assert;
import org.junit.Before;
import org.junit.Test;

import org.apache.apippi.*;
...
public class SchemaCQLHelperTest extends CQLTester
{
    ...
    public void testCfmOptionsCQL()
    {
        ...
        assertThat(SchemaCQLHelper.getTableMetadataAsCQL(cfs.metadata(), cfs.keyspace.getMetadata()),
                   containsString("CLUSTERING ORDER BY (cl1 ASC)\n" +
                            ...
                            "    AND cdc = false\n" +
                            "    AND comment = 'comment'\n" +
                            "    AND compaction = {'class': 'org.apache.apippi.db.compaction.LeveledCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4', 'sstable_size_in_mb': '1'}\n" +
                            "    AND compression = {'chunk_length_in_kb': '64', 'class': 'org.apache.apippi.io.compress.LZ4Compressor', 'min_compress_ratio': '2.0'}\n" +
    ...
    public void testCfmIndexJson()
    {
        ...
        assertEquals(ImmutableList.of("CREATE INDEX \"indexName\" ON cql_test_keyspace_3.test_table_3 (values(reg1));",
                                      ...
                                      "CREATE CUSTOM INDEX \"indexName4\" ON cql_test_keyspace_3.test_table_3 (entries(reg1)) USING 'org.apache.apippi.index.sasi.SASIIndex';",
                                      "CREATE CUSTOM INDEX \"indexName5\" ON cql_test_keyspace_3.test_table_3 (entries(reg1)) USING 'org.apache.apippi.index.sasi.SASIIndex' WITH OPTIONS = {'is_literal': 'false'};"),
