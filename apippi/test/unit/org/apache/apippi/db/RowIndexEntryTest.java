...
import org.apache.apippi.db.columniterator.AbstractSSTableIterator;
...
import org.apache.apippi.db.rows.SerializationHelper;
import org.apache.apippi.db.rows.Unfiltered;
import org.apache.apippi.db.rows.UnfilteredRowIterator;
import org.apache.apippi.db.rows.UnfilteredSerializer;
...
import org.apache.apippi.serializers.LongSerializer;
...
public class RowIndexEntryTest extends CQLTester
{
    ...
    private static class DoubleSerializer implements AutoCloseable
    {
        ...
        final org.apache.apippi.db.ColumnIndex columnIndex;
        ...
        DoubleSerializer() throws IOException
        {
            ...
            columnIndex = new org.apache.apippi.db.ColumnIndex(header, dataWriterNew, version, Collections.emptyList(),
