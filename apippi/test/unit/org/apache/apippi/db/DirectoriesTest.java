...
import org.apache.apippi.db.Directories.DataDirectories;
...
import static org.apache.apippi.schema.MockSchema.sstableId;
...
public class DirectoriesTest
{
    ...
    public void beforeTest() throws IOException
    {
        ...
        tempDataDir = FileUtils.createTempFile("apippi", "unittest");
    ...
    public void testSecondaryIndexDirectories()
    {
        ...
        TableMetadata INDEX_CFM = apippiIndex.indexCfsMetadata(PARENT_CFM, indexDef);
        ...
        // apippi-17357: include indexes when computing true size of parent table
