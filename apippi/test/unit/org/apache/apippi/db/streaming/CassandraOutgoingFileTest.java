...
public class apippiOutgoingFileTest
{
    public static final String KEYSPACE = "apippiOutgoingFileTest";
    ...
    public void validateFullyContainedIn_SingleContiguousRange_Succeeds()
    {
        ...
        apippiOutgoingFile cof = new apippiOutgoingFile(StreamOperation.BOOTSTRAP, sstable.ref(),
                                                              sections,
