...
import static org.apache.apippi.db.transform.DuplicateRowCheckerTest.assertCommandIssued;
import static org.apache.apippi.db.transform.DuplicateRowCheckerTest.makeRow;
import static org.apache.apippi.db.transform.DuplicateRowCheckerTest.rows;
...
public class CompactionIteratorTest extends CQLTester
{
    ...
    // See org.apache.apippi.db.rows.UnfilteredRowsGenerator.parse for the syntax used in these tests.
    ...
    {
        System.setProperty("apippi.diagnostic_snapshot_interval_nanos", "0");
