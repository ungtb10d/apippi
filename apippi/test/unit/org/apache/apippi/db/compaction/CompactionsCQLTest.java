...
import org.apache.apippi.db.compaction.writers.CompactionAwareWriter;
import org.apache.apippi.db.compaction.writers.MaxSSTableSizeWriter;
...
public class CompactionsCQLTest extends CQLTester
{
    ...
    public void testCompactionInvalidRTs() throws Throwable
    {
        ...
        // in test/conf/apippi.yaml they would start failing
