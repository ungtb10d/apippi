 ...
 */
package org.apache.apippi.db.rows;
...
import static org.apache.apippi.cql3.FieldIdentifier.forUnquoted;
import static org.apache.apippi.utils.ByteBufferUtil.bytes;
...
public class ColumnMetadataVersionComparatorTest
{
    ...
    {
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type org.apache.apippi.db.marshal.Int32Type and one of type org.apache.apippi.db.marshal.UTF8Type (but both types are incompatible)",
                                Int32Type.instance,
                                UTF8Type.instance);
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type org.apache.apippi.db.marshal.FrozenType(org.apache.apippi.db.marshal.UserType(ks,6d7954797065,61:org.apache.apippi.db.marshal.Int32Type,62:org.apache.apippi.db.marshal.Int32Type)) and one of type org.apache.apippi.db.marshal.Int32Type (but both types are incompatible)",
                                udtWith2Fields,
                                Int32Type.instance);
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type org.apache.apippi.db.marshal.SetType(org.apache.apippi.db.marshal.UTF8Type) and one of type org.apache.apippi.db.marshal.SetType(org.apache.apippi.db.marshal.InetAddressType) (but both types are incompatible)",
                                SetType.getInstance(UTF8Type.instance, true),
                                SetType.getInstance(InetAddressType.instance, true));
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type org.apache.apippi.db.marshal.ListType(org.apache.apippi.db.marshal.UTF8Type) and one of type org.apache.apippi.db.marshal.ListType(org.apache.apippi.db.marshal.InetAddressType) (but both types are incompatible)",
                                ListType.getInstance(UTF8Type.instance, true),
                                ListType.getInstance(InetAddressType.instance, true));
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type org.apache.apippi.db.marshal.MapType(org.apache.apippi.db.marshal.UTF8Type,org.apache.apippi.db.marshal.IntegerType) and one of type org.apache.apippi.db.marshal.MapType(org.apache.apippi.db.marshal.InetAddressType,org.apache.apippi.db.marshal.IntegerType) (but both types are incompatible)",
        ...
        assertInvalidComparison("Found 2 incompatible versions of column c in ks.t: one of type org.apache.apippi.db.marshal.MapType(org.apache.apippi.db.marshal.IntegerType,org.apache.apippi.db.marshal.UTF8Type) and one of type org.apache.apippi.db.marshal.MapType(org.apache.apippi.db.marshal.IntegerType,org.apache.apippi.db.marshal.InetAddressType) (but both types are incompatible)",
