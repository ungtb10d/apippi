...
import org.apache.apippi.db.commitlog.CommitLogArchiver;
import org.apache.apippi.db.commitlog.CommitLogReplayer;
...
public class RecoveryManagerTest
{
    ...
    private static class MockInitiator extends CommitLogReplayer.MutationInitiator
    {
        ...
        @Override
        protected org.apache.apippi.utils.concurrent.Future<Integer> initiateMutation(final Mutation mutation,
                                                                                         final long segmentId,
                                                                                         final int serializedSize,
                                                                                         final int entryLocation,
                                                                                         final CommitLogReplayer clr)
        {
            final org.apache.apippi.utils.concurrent.Future<Integer> toWrap =
