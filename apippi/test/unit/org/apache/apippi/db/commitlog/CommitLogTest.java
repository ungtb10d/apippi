...
* under the License.
*/
package org.apache.apippi.db.commitlog;
...
import org.apache.apippi.io.compress.ZstdCompressor;
...
import org.apache.apippi.config.Config.DiskFailurePolicy;
import org.apache.apippi.db.*;
import org.apache.apippi.db.commitlog.CommitLogReplayer.CommitLogReplayException;
...
import org.apache.apippi.io.compress.DeflateCompressor;
import org.apache.apippi.io.compress.LZ4Compressor;
import org.apache.apippi.io.compress.SnappyCompressor;
...
import org.apache.apippi.security.CipherFactory;
import org.apache.apippi.security.EncryptionContext;
import org.apache.apippi.security.EncryptionContextGenerator;
...
import org.apache.apippi.utils.KillerForTests;
import org.apache.apippi.utils.Pair;
import org.apache.apippi.utils.vint.VIntCoding;

import static org.apache.apippi.db.commitlog.CommitLogSegment.ENTRY_OVERHEAD_SIZE;
...
import org.apache.apippi.db.marshal.MapType;
import org.apache.apippi.db.marshal.SetType;
...
public abstract class CommitLogTest
{
    ...
    public void afterTest()
    {
        ...
        System.clearProperty("apippi.replayList");
        testKiller.reset();
    }
    ...
    protected Void testRecovery(byte[] logData, int version) throws Exception
    {
        ...
        try (OutputStream lout = new FileOutputStreamPlus(logFile))
        {
            ...
            CommitLog.instance.recover(logFile.path()); //apippi-1119 / apippi-1179 throw on failure*/
        }
        return null;
    }
    ...
    public void testUnwriteableFlushRecovery() throws ExecutionException, InterruptedException, IOException
    {
        ...
        CommitLog.instance.sync(true);
        System.setProperty("apippi.replayList", KEYSPACE1 + "." + STANDARD1);
