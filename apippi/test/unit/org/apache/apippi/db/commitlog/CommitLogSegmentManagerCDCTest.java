...
import org.apache.apippi.db.commitlog.CommitLogSegment.CDCState;
...
public class CommitLogSegmentManagerCDCTest extends CQLTester
{
    ...
    public void testCDCIndexFileWriteOnSync() throws IOException
    {
        ...
        String input = null;
        // There could be a race between index file update (truncate & write) and read. See apippi-17416
        ...
        Assert.assertTrue("The offset read from CDC index file should be equal or larger than the offset after sync. See apippi-17416",
