...
public class CommitLogSegmentBackpressureTest
{
    ...
    @BMRules(rules = {@BMRule(name = "Acquire Semaphore before sync",
                              ...
                              targetMethod = "run",
                              targetLocation = "AT INVOKE org.apache.apippi.db.commitlog.CommitLog.sync(boolean)",
                              action = "org.apache.apippi.db.commitlog.CommitLogSegmentBackpressureTest.allowSync.acquire()"),
                      @BMRule(name = "Release Semaphore after sync",
                              targetClass = "AbstractCommitLogService$SyncRunnable",
                              targetMethod = "run",
                              targetLocation = "AFTER INVOKE org.apache.apippi.db.commitlog.CommitLog.sync(boolean)",
                              action = "org.apache.apippi.db.commitlog.CommitLogSegmentBackpressureTest.allowSync.release()")})
