...
public class DefaultSslContextFactoryTest
{
    ...
    public void setup()
    {
        commonConfig.put("truststore", "test/conf/apippi_ssl_test.truststore");
        commonConfig.put("truststore_password", "apippi");
    ...
    {
        config.put("keystore", "test/conf/apippi_ssl_test.keystore");
        config.put("keystore_password", "apippi");
    }

    private void addOutboundKeystoreOptions(Map<String, Object> config)
    {
        config.put("outbound_keystore", "test/conf/apippi_ssl_test_outbound.keystore");
        config.put("outbound_keystore_password", "apippi");
    }

    @Test
    public void getSslContextOpenSSL() throws IOException
    {
        EncryptionOptions.ServerEncryptionOptions options = new EncryptionOptions.ServerEncryptionOptions().withTrustStore("test/conf/apippi_ssl_test.truststore")
