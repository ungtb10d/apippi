...
public class CustomSslContextFactoryConfigTest
{
    ...
    {
        System.setProperty("apippi.config", "apippi-sslcontextfactory.yaml");
    }
    ...
    public void testValidCustomSslContextFactoryConfiguration() {
        ...
        Assert.assertEquals("org.apache.apippi.security.DummySslContextFactoryImpl",
    ...
    public void testInvalidCustomSslContextFactoryConfiguration() {
        ...
        try {
            ...
            Assert.assertEquals("Unable to create instance of ISslContextFactory for org.apache.apippi.security" +
