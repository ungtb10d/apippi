...
import static org.apache.apippi.Util.spinAssertEquals;
import static org.apache.apippi.transport.ProtocolVersion.V4;
...
public class RateLimitingTest extends CQLTester
{
    ...
    {
        String metricName = "org.apache.apippi.metrics.Client.RequestDispatched";
        Map<String, Meter> metrics = apippiMetricsRegistry.Metrics.getMeters((name, metric) -> name.equals(metricName));
        if (metrics.size() != 1)
