...
import org.apache.apippi.exceptions.TransportException;
...
import static org.apache.apippi.transport.messages.StartupMessage.CQL_VERSION;
...
public class ProtocolNegotiationTest extends CQLTester
{
                                ...
                                com.datastax.driver.core.ProtocolVersion expectedVersion)
    {
        ...
        {
            if (requestedVersion.toInt() > org.apache.apippi.transport.ProtocolVersion.CURRENT.asInt())
