...
import org.apache.apippi.transport.Event.TopologyChange;
import org.apache.apippi.transport.Event.SchemaChange;
import org.apache.apippi.transport.Event.StatusChange;
...
public class SerDeserTest
{
    ...
    private void preparedMetadataSerializationTest(ProtocolVersion version)
    {
        ...
        // add a column name that contains UTF-8 string (that is valid to apippi)
