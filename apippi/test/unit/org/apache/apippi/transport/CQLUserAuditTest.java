...
import org.apache.apippi.audit.AuditEvent;
...
import org.apache.apippi.config.OverrideConfigurationLoader;
...
{
    private static EmbeddedapippiService embedded;
    ...
    public static void setup() throws Exception
    {
        OverrideConfigurationLoader.override((config) -> {
            ...
            config.role_manager = "apippiRoleManager";
        ...
        embedded = ServerTestUtils.startEmbeddedapippiService();
