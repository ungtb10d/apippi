 ...
 */
package org.apache.apippi.triggers;
...
import static org.apache.apippi.utils.ByteBufferUtil.toInt;
...
public class TriggersTest
{
    ...
    @Test(expected=org.apache.apippi.exceptions.InvalidRequestException.class)
    ...
    public static class ErrorTrigger implements ITrigger
    {
        ...
        public Collection<Mutation> augment(Partition partition)
        {
            throw new org.apache.apippi.exceptions.InvalidRequestException(MESSAGE);
        }
    }
}
