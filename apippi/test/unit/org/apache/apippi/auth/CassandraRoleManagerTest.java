...
import static org.apache.apippi.auth.AuthTestUtils.*;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

public class apippiRoleManagerTest
{
    @BeforeClass
    public static void setupClass()
    {
        ...
        // We start StorageService because confirmFastRoleSetup confirms that apippiRoleManager will
    ...
    public void getGrantedRolesImplMinimizesReads()
    {
        ...
        // it is inefficient, so apippiRoleManager has its own implementation which
    ...
    public void confirmFastRoleSetup()
    {
        ...
        apippiRoleManager crm = new apippiRoleManager();

        assertTrue("Expected the role manager to have existing roles before apippiRoleManager setup", apippiRoleManager.hasExistingRoles());
    }
    ...
    public void warmCacheLoadsAllEntries()
    {
        ...
        // Use apippiRoleManager to get entries for pre-warming a cache, then verify those entries
        apippiRoleManager crm = new apippiRoleManager();
        crm.setup();
