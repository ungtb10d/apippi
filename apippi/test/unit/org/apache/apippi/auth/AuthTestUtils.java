...
public class AuthTestUtils
{
     ...
     */
    public static class LocalapippiRoleManager extends apippiRoleManager
    {
        @Override
    ...
    public static class LocalapippiAuthorizer extends apippiAuthorizer
    {
        @Override
        ResultMessage.Rows select(SelectStatement statement, QueryOptions options)
        {
    ...
    public static class LocalapippiNetworkAuthorizer extends apippiNetworkAuthorizer
    {
        @Override
        ResultMessage.Rows select(SelectStatement statement, QueryOptions options)
        {
