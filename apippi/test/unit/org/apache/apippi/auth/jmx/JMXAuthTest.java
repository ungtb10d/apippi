...
public class JMXAuthTest extends CQLTester
{
    ...
    {
        String config = Paths.get(ClassLoader.getSystemResource("auth/apippi-test-jaas.conf").toURI()).toString();
        ...
        System.setProperty("apippi.jmx.remote.login.config", "TestLogin");
        System.setProperty("apippi.jmx.authorizer", NoSuperUserAuthorizationProxy.class.getName());
    ...
    public void setup() throws Throwable
    {
        ...
        tableMBean = JMXResource.mbean(String.format("org.apache.apippi.db:type=Tables,keyspace=%s,table=%s",
                                                     KEYSPACE, tableName));
    }
    ...
    public void readAttribute() throws Throwable
    {
        ...
        clearAllPermissions();
        JMXResource allTablesInKeyspace = JMXResource.mbean(String.format("org.apache.apippi.db:type=Tables,keyspace=%s,*",
                                                                          KEYSPACE));
        assertPermissionOnResource(Permission.SELECT, allTablesInKeyspace, proxy::getTableName);

        // grant SELECT on all Table mbeans
        clearAllPermissions();
        JMXResource allTables = JMXResource.mbean("org.apache.apippi.db:type=Tables,*");
    ...
    {
        private apippiPrincipal principal;
        ...
        public void initialize(Subject subject, CallbackHandler callbackHandler, Map<String, ?> sharedState, Map<String, ?> options)
        {
            ...
            principal = new apippiPrincipal((String)options.get("role_name"));
        }
