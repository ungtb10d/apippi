...
import static org.apache.apippi.auth.AuthTestUtils.LocalapippiRoleManager;
import static org.apache.apippi.auth.AuthTestUtils.ROLE_B;
import static org.apache.apippi.auth.AuthTestUtils.ROLE_B_1;
import static org.apache.apippi.auth.AuthTestUtils.ROLE_B_2;
import static org.apache.apippi.auth.AuthTestUtils.ROLE_C;
import static org.apache.apippi.auth.AuthTestUtils.ROLE_C_1;
import static org.apache.apippi.auth.AuthTestUtils.ROLE_C_2;
 ...
 */
public class apippiAuthorizerTruncatingTests extends CQLTester
{
    @BeforeClass
    public static void setupClass()
    {
        apippiRelevantProperties.ORG_APACHE_apippi_DISABLE_MBEAN_REGISTRATION.setBoolean(true);
    ...
    public void testBulkLoadingForAuthCache()
    {
        ...
        IRoleManager roleManager = new LocalapippiRoleManager();
        roleManager.setup();
        ...
        apippiAuthorizer authorizer = new apippiAuthorizer();
