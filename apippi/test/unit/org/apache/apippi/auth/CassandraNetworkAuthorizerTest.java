...
import org.apache.apippi.cql3.statements.AlterRoleStatement;
import org.apache.apippi.cql3.statements.AuthenticationStatement;
import org.apache.apippi.cql3.statements.CreateRoleStatement;
import org.apache.apippi.cql3.statements.DropRoleStatement;
...
import static org.apache.apippi.auth.AuthKeyspace.NETWORK_PERMISSIONS;
import static org.apache.apippi.auth.AuthTestUtils.getRolesReadCount;
import static org.apache.apippi.schema.SchemaConstants.AUTH_KEYSPACE_NAME;

public class apippiNetworkAuthorizerTest
{
    private static void setupSuperUser()
    {
        QueryProcessor.executeInternal(String.format("INSERT INTO %s.%s (role, is_superuser, can_login, salted_hash) "
                                                     ...
                                                     AUTH_KEYSPACE_NAME,
                                                     AuthKeyspace.ROLES,
                                                     apippiRoleManager.DEFAULT_SUPERUSER_NAME,
                                                     "xxx"));
    }
    ...
    public static void defineSchema() throws ConfigurationException
    {
        ...
        SchemaLoader.setupAuth(new AuthTestUtils.LocalapippiRoleManager(),
    ...
    private static ClientState getClientState()
    {
        ...
        state.login(new AuthenticatedUser(apippiRoleManager.DEFAULT_SUPERUSER_NAME));
        return state;
    }
