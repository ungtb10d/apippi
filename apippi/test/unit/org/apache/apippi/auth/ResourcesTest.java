...
public class ResourcesTest
{
    ...
    public void testFunctionResourceNameConversion()
    {
        ...
        assertEquals(FunctionResource.function("ks1", "f1", Arrays.asList(Int32Type.instance, DoubleType.instance)),
                Resources.fromName("functions/ks1/f1[org.apache.apippi.db.marshal.Int32Type^org.apache.apippi.db.marshal.DoubleType]"));
        assertEquals("functions/ks1/f1[org.apache.apippi.db.marshal.Int32Type^org.apache.apippi.db.marshal.DoubleType]",
    ...
    public void testJMXResourceNameConversion()
    {
        ...
        assertEquals(JMXResource.mbean("org.apache.apippi.auth:type=*"),
                Resources.fromName("mbean/org.apache.apippi.auth:type=*"));
        assertEquals("mbean/org.apache.apippi.auth:type=*",
                JMXResource.mbean("org.apache.apippi.auth:type=*").getName());
    }
}
