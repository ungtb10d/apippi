...
import org.apache.apippi.diag.DiagnosticEventService;
import org.apache.apippi.gms.GossiperEvent;
...
import org.apache.apippi.locator.RangesByEndpoint;
...
import org.apache.apippi.locator.AbstractNetworkTopologySnitch;
...
import org.apache.apippi.locator.SimpleSnitch;
...
public class MoveTest
{
    ...
    private void finishMove(InetAddressAndPort host, int token, TokenMetadata tmd)
    {
        ...
        // As well as upating TMD, update the host's tokens in gossip. Since apippi-15120, status changing to MOVING
    ...
    public void testSimultaneousMove() throws UnknownHostException
    {
        ...
        // don't require test update every time a new keyspace is added to test/conf/apippi.yaml
