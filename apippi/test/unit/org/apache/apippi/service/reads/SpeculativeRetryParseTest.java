...
import static org.apache.apippi.service.reads.HybridSpeculativeRetryPolicy.Function;
...
public class SpeculativeRetryParseTest
{
    ...
    public static class SuccessfulParseTest
    {
        ...
        {
            Locale.setDefault(new Locale("pt","BR")); // apippi-14374: Brazil uses comma instead of dot as decimal separator
            assertEquals(expectedValue, SpeculativeRetryPolicy.fromString(expectedValue.toString()));
