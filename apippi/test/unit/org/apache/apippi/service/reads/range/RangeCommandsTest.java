...
public class RangeCommandsTest extends CQLTester
{
    ...
    {
        System.setProperty("apippi.max_concurrent_range_requests", String.valueOf(MAX_CONCURRENCY_FACTOR));
    }

    @AfterClass
    public static void cleanup()
    {
        System.clearProperty("apippi.max_concurrent_range_requests");
    }
