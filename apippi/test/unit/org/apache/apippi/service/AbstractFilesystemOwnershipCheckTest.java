...
import static org.apache.apippi.service.FileSystemOwnershipCheck.DEFAULT_FS_OWNERSHIP_FILENAME;
import static org.apache.apippi.service.FileSystemOwnershipCheck.ERROR_PREFIX;
import static org.apache.apippi.service.FileSystemOwnershipCheck.INCONSISTENT_FILES_FOUND;
import static org.apache.apippi.service.FileSystemOwnershipCheck.INVALID_FILE_COUNT;
import static org.apache.apippi.service.FileSystemOwnershipCheck.INVALID_PROPERTY_VALUE;
import static org.apache.apippi.service.FileSystemOwnershipCheck.MISMATCHING_TOKEN;
import static org.apache.apippi.service.FileSystemOwnershipCheck.MISSING_PROPERTY;
import static org.apache.apippi.service.FileSystemOwnershipCheck.MULTIPLE_OWNERSHIP_FILES;
import static org.apache.apippi.service.FileSystemOwnershipCheck.NO_OWNERSHIP_FILE;
import static org.apache.apippi.service.FileSystemOwnershipCheck.READ_EXCEPTION;
import static org.apache.apippi.service.FileSystemOwnershipCheck.TOKEN;
import static org.apache.apippi.service.FileSystemOwnershipCheck.UNSUPPORTED_VERSION;
import static org.apache.apippi.service.FileSystemOwnershipCheck.VERSION;
import static org.apache.apippi.service.FileSystemOwnershipCheck.VOLUME_COUNT;
import static org.apache.apippi.service.StartupChecks.StartupCheckType.check_filesystem_ownership;
...
public abstract class AbstractFilesystemOwnershipCheckTest
{
    ...
    protected void setup()
    {
        ...
        System.clearProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_OWNERSHIP_FILENAME.getKey());
        System.clearProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_OWNERSHIP_TOKEN.getKey());
        System.clearProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_ENABLE.getKey());
    }
    ...
    public void skipCheckDisabledIfSystemPropertyIsFalseButOptionsEnabled() throws Exception
    {
        ...
        System.setProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_ENABLE.getKey(), "false");
        AbstractFilesystemOwnershipCheckTest.checker(() -> { throw new RuntimeException("FAIL"); }).execute(options);
    }
    ...
    {
        System.setProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_OWNERSHIP_TOKEN.getKey(), "");
        AbstractFilesystemOwnershipCheckTest.executeAndFail(AbstractFilesystemOwnershipCheckTest.checker(tempDir), options, MISSING_PROPERTY, apippiRelevantProperties.FILE_SYSTEM_CHECK_OWNERSHIP_TOKEN.getKey());
    }
    ...
    {
        File childDir = new File(tempDir, "apippi/data"); //checkstyle: permit this instantiation
        assertTrue(childDir.tryCreateDirectories());
        assertTrue(childDir.exists());
    ...
    {
        File leafDir = AbstractFilesystemOwnershipCheckTest.mkdirs(tempDir, "apippi/data");
    ...
    {
        File leafDir1 = AbstractFilesystemOwnershipCheckTest.mkdirs(tempDir, "apippi/data");
        AbstractFilesystemOwnershipCheckTest.writeFile(leafDir1, 3, token);
        File leafDir2 = AbstractFilesystemOwnershipCheckTest.mkdirs(tempDir, "apippi/commitlogs");
        AbstractFilesystemOwnershipCheckTest.writeFile(leafDir2, 3, token);
        File leafDir3 = AbstractFilesystemOwnershipCheckTest.mkdirs(tempDir, "apippi/hints");
    ...
    public void overrideFilename() throws Exception
    {
        ...
        System.setProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_OWNERSHIP_FILENAME.getKey(), "other_file");
        AbstractFilesystemOwnershipCheckTest.checker(leafDir).execute(options);
    }
