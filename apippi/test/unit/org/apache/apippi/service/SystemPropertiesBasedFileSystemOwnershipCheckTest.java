...
public class SystemPropertiesBasedFileSystemOwnershipCheckTest extends AbstractFilesystemOwnershipCheckTest
{
    ...
    {
        super.setup();
        System.setProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_OWNERSHIP_TOKEN.getKey(), token);
        System.setProperty(apippiRelevantProperties.FILE_SYSTEM_CHECK_ENABLE.getKey(), "true");
    }
}