...
import org.apache.apippi.dht.OrderPreservingPartitioner.StringToken;
...
import org.apache.apippi.locator.PropertyFileSnitch;
...
import static org.apache.apippi.ServerTestUtils.cleanup;
import static org.apache.apippi.ServerTestUtils.mkdirs;
...
public class StorageServiceServerTest
{
    ...
    public void testGetNativeAddressIPV6() throws Exception
    {
        ...
        // See https://issues.apache.org/jira/browse/apippi-17945 for more context.
    ...
    public void isReplacingSameHostAddressAndHostIdTest() throws UnknownHostException
    {
        try
        {
            ...
            System.setProperty("apippi.replace_address", hostAddress);
            ...
            System.setProperty("apippi.replace_address", "unresolvable.host.local.");
            Assert.assertFalse(StorageService.instance.isReplacingSameHostAddressAndHostId(differentHostId));
        }
        finally
        {
            System.clearProperty("apippi.replace_address");
        }
    }
}