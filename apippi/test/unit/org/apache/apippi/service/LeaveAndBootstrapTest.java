...
import org.apache.apippi.Util.PartitionerSwitcher;
...
public class LeaveAndBootstrapTest
{
    ...
    /**
     * Tests that the system.peers table is not updated after a node has been removed. (See apippi-6053)
     */
    @Test
    ...
    public void testRemovingStatusForNonMember()  throws UnknownHostException
    {
        ...
        // make a REMOVING state change on a non-member endpoint; without the apippi-6564 fix, this
