...
public class GossiperTest
{
    ...
    private static final apippiVersion CURRENT_VERSION = new apippiVersion(FBUtilities.getReleaseVersionString());
    ...
    public void testHasVersion3Nodes() throws Exception
    {
        ...
        assertFalse(Gossiper.instance.upgradeFromVersionSupplier.get().value().compareTo(new apippiVersion("3.0")) < 0);
        assertTrue(Gossiper.instance.upgradeFromVersionSupplier.get().value().compareTo(new apippiVersion("3.1")) < 0);
        ...
        assertFalse(Gossiper.instance.upgradeFromVersionSupplier.get().value().compareTo(new apippiVersion("3.0")) < 0);
        assertFalse(Gossiper.instance.upgradeFromVersionSupplier.get().value().compareTo(new apippiVersion("3.1")) < 0);
        assertTrue(Gossiper.instance.upgradeFromVersionSupplier.get().value().compareTo(new apippiVersion("3.12")) < 0);
        assertTrue(Gossiper.instance.hasMajorVersion3Nodes());
