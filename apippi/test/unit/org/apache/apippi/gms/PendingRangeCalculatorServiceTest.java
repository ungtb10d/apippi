...
/**
 * Test for "Gossip blocks on startup when another node is bootstrapping" (apippi-12281).
 */
...
public class PendingRangeCalculatorServiceTest
{
    ...
    @BMRule(name = "Block pending range calculation",
            ...
            targetLocation = "AT INVOKE org.apache.apippi.locator.AbstractReplicationStrategy.getAddressReplicas",
            action = "org.apache.apippi.gms.PendingRangeCalculatorServiceTest.calculationLock.lock()")
