 ...
 */
public class apippiBriefJUnitResultFormatter implements JUnitResultFormatter, IgnoredTestListener {

    private static final double ONE_SECOND = 1000.0;

    private static final String tag = System.getProperty("apippi.testtag", "");

    private static final Boolean keepBriefBrief = Boolean.getBoolean("apippi.keepBriefBrief");
     ...
     */
    public apippiBriefJUnitResultFormatter() {
