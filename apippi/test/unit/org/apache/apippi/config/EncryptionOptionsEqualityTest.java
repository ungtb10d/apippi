...
import org.apache.apippi.security.DummySslContextFactoryImpl;
 ...
 * caching done in the {@link org.apache.apippi.security.SSLFactory} doesn't break.
 */
public class EncryptionOptionsEqualityTest
{
    ...
    public void testKeystoreOptions() {
        ...
        .withStoreType("JKS")
        .withKeyStore("test/conf/apippi.keystore")
