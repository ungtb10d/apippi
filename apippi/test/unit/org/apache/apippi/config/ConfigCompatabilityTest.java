...
/**
 * To create the test files used by this class, run {@link org.apache.apippi.distributed.upgrade.ConfigCompatabilityTestGenerate}.
 */
public class ConfigCompatabilityTest
{
    ...
    private static final Set<String> REMOVED_IN_40 = ImmutableSet.<String>builder()
                                                     ...
                                                     .add("encryption_options") // apippi-10404
                                                     .add("index_interval") // apippi-10671
                                                     .add("streaming_socket_timeout_in_ms") // apippi-12229
                                                     .build();
