...
import static org.apache.apippi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.all;
import static org.apache.apippi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.dc;
import static org.apache.apippi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.none;
import static org.apache.apippi.config.EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.rack;
import static org.apache.apippi.config.EncryptionOptions.TlsEncryptionPolicy.ENCRYPTED;
import static org.apache.apippi.config.EncryptionOptions.TlsEncryptionPolicy.OPTIONAL;
import static org.apache.apippi.config.EncryptionOptions.TlsEncryptionPolicy.UNENCRYPTED;
...
public class EncryptionOptionsTest
{
    static class EncryptionOptionsTestCase
    {
        ...
        {
            return new EncryptionOptionsTestCase(new EncryptionOptions(new ParameterizedClass("org.apache.apippi.security.DefaultSslContextFactory",
                                                                                              new HashMap<>()),
    ...
    static class ServerEncryptionOptionsTestCase
    {
        ...
        public static ServerEncryptionOptionsTestCase of(Boolean optional, String keystorePath,
                                                         ...
                                                         EncryptionOptions.TlsEncryptionPolicy expected)
        {
            return new ServerEncryptionOptionsTestCase(new EncryptionOptions.ServerEncryptionOptions(new ParameterizedClass("org.apache.apippi.security.DefaultSslContextFactory",
    ...
    public void isEnabledServer()
    {
        ...
        Assertions.assertThatThrownBy(() -> YamlConfigurationLoader.fromMap(yaml, Config.class))
                  ...
                  .hasMessage("Invalid yaml. Please remove properties [isEnabled] from your apippi.yaml");
    }
    ...
    public void isOptionalServer()
    {
        ...
        Assertions.assertThatThrownBy(() -> YamlConfigurationLoader.fromMap(yaml, Config.class))
                  .isInstanceOf(ConfigurationException.class)
                  .hasMessage("Invalid yaml. Please remove properties [isOptional] from your apippi.yaml");
    }
