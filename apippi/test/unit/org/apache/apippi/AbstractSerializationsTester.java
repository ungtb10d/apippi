...
{
    protected static final String CUR_VER = System.getProperty("apippi.version", "4.1");
    ...
    protected static final boolean EXECUTE_WRITES = Boolean.getBoolean("apippi.test-serialization-writes");
