 ...
 */
package org.apache.apippi.utils.bytecomparable;
...
import org.apache.apippi.dht.LengthPartitioner;
...
import org.apache.apippi.serializers.SimpleDateSerializer;
...
public class AbstractTypeByteSourceTest
{
    ...
    public void testDynamicCompositeType()
    {
        ...
        ImmutableList<String> allTypes = ImmutableList.of("org.apache.apippi.db.marshal.BytesType",
                                                          "org.apache.apippi.db.marshal.TimeUUIDType",
                                                          "org.apache.apippi.db.marshal.IntegerType");
    ...
    private static ByteBuffer createStringUuidVarintDynamicCompositeKey(String string, UUID uuid, int i, byte lastEocByte)
    {
        ...
        String bytesType = "org.apache.apippi.db.marshal.BytesType";
        String timeUuidType = "org.apache.apippi.db.marshal.TimeUUIDType";
        String varintType = "org.apache.apippi.db.marshal.IntegerType";
