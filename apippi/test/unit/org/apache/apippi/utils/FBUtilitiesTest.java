...
public class FBUtilitiesTest
{
    ...
    public void testNewPartitionerNoArgConstructors()
    {
        ...
        assertPartitioner("org.apache.apippi.dht.ByteOrderedPartitioner", ByteOrderedPartitioner.class);
        assertPartitioner("org.apache.apippi.dht.LengthPartitioner", LengthPartitioner.class);
        assertPartitioner("org.apache.apippi.dht.Murmur3Partitioner", Murmur3Partitioner.class);
        assertPartitioner("org.apache.apippi.dht.OrderPreservingPartitioner", OrderPreservingPartitioner.class);
        assertPartitioner("org.apache.apippi.dht.RandomPartitioner", RandomPartitioner.class);
    }
    ...
    {
        for (String name : new String[] {"LocalPartitioner", "org.apache.apippi.dht.LocalPartitioner"})
