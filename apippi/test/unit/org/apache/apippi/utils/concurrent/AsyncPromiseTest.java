...
public class AsyncPromiseTest extends AbstractTestAsyncPromise
{
    ...
    private static final class TestInExecutor implements ExecutorPlus
    {
        ...
        @Override
        public <T> org.apache.apippi.utils.concurrent.Future<T> submit(Callable<T> task)
        {
            throw new UnsupportedOperationException();
        }

        @Override
        public <T> org.apache.apippi.utils.concurrent.Future<T> submit(Runnable task, T result)
        {
            throw new UnsupportedOperationException();
        }

        @Override
        public org.apache.apippi.utils.concurrent.Future<?> submit(Runnable task)
        {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        public <T> org.apache.apippi.utils.concurrent.Future<T> submit(WithResources withResources, Callable<T> task)
        {
            throw new UnsupportedOperationException();
        }

        @Override
        public org.apache.apippi.utils.concurrent.Future<?> submit(WithResources withResources, Runnable task)
        {
            throw new UnsupportedOperationException();
        }

        @Override
        public <T> org.apache.apippi.utils.concurrent.Future<T> submit(WithResources withResources, Runnable task, T result)
        {
            throw new UnsupportedOperationException();
        }
