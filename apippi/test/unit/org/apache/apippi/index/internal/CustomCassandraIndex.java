...
import static org.apache.apippi.index.internal.apippiIndex.getFunctions;
import static org.apache.apippi.index.internal.apippiIndex.indexCfsMetadata;

/**
 * Clone of KeysIndex used in apippiIndexTest#testCustomIndexWithCFS to verify
 * behaviour of flushing CFS backed CUSTOM indexes
 */
public class CustomapippiIndex implements Index
{
    ...
    public CustomapippiIndex(ColumnFamilyStore baseCfs, IndexMetadata indexDef)
    {
