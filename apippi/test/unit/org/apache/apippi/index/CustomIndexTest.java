...
import org.apache.apippi.cql3.restrictions.IndexRestrictions;
...
import static org.apache.apippi.cql3.statements.schema.IndexTarget.CUSTOM_INDEX_OPTION_NAME;
...
public class CustomIndexTest extends CQLTester
{
    ...
    public void testInsertsOnCfsBackedIndex() throws Throwable
    {
        ...
        createIndex("CREATE CUSTOM INDEX ON %s(c) USING 'org.apache.apippi.index.internal.CustomapippiIndex'");
    ...
    public void testTruncateWithNonCfsCustomIndex() throws Throwable
    {
        ...
        // issues described in the comments on apippi-9669
        createTable("CREATE TABLE %s (a int, b int, c int, PRIMARY KEY (a))");
        createIndex("CREATE CUSTOM INDEX ON %s(b) USING 'org.apache.apippi.index.StubIndex'");
    ...
    public void testFailing2iFlush() throws Throwable
    {
        ...
        createIndex("CREATE CUSTOM INDEX IF NOT EXISTS ON %s(value) USING 'org.apache.apippi.index.CustomIndexTest$BrokenCustom2I'");
    ...
    public static final class SimulateConcurrentFlushingIndex extends StubIndex
    {
        ...
        {
            apippiWriteContext apippiWriteContext = (apippiWriteContext) ctx;
            if (readOrderingAtStart == null)
                readOrderingAtStart = baseCfs.readOrdering.getCurrent();

            writeGroups.add(apippiWriteContext.getGroup());
