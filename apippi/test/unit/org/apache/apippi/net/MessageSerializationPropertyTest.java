...
import org.apache.apippi.utils.apippiGenerators;
import org.apache.apippi.utils.FBUtilities;
import org.apache.apippi.utils.FixedMonotonicClock;
import org.assertj.core.api.Assertions;
import org.mockito.Mockito;

import static org.apache.apippi.net.Message.serializer;
import static org.apache.apippi.utils.apippiGenerators.MESSAGE_GEN;
import static org.apache.apippi.utils.FailingConsumer.orFail;
...
public class MessageSerializationPropertyTest implements Serializable
{
    ...
    public static void beforeClass()
    {
        ...
        System.setProperty("apippi.monotonic_clock.precise", FixedMonotonicClock.class.getName());
        System.setProperty("apippi.monotonic_clock.approx", FixedMonotonicClock.class.getName());
                    ...
                    for (MessagingService.Version version : MessagingService.Version.values())
                    {
                        ...
                        Assertions.assertThat(ByteBufferUtil.bytesToHex(second.buffer()))
                                  .as("Property serialize(deserialize(serialize(message))) == serialize(message) "
                                      ...
                                      new Object() { public String toString() { return apippiGenerators.toStringRecursive(message); } },
                                      new Object() { public String toString() { return apippiGenerators.toStringRecursive(read); } })
