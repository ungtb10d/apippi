...
import org.apache.apippi.config.EncryptionOptions.ServerEncryptionOptions;
import org.apache.apippi.config.ParameterizedClass;
import org.apache.apippi.gms.GossipDigestSyn;
import org.apache.apippi.security.DefaultSslContextFactory;
...
import static org.apache.apippi.net.MessagingService.VERSION_30;
import static org.apache.apippi.net.MessagingService.VERSION_3014;
import static org.apache.apippi.net.MessagingService.current_version;
import static org.apache.apippi.net.MessagingService.minimum_version;
import static org.apache.apippi.net.ConnectionType.SMALL_MESSAGES;
import static org.apache.apippi.net.OutboundConnectionInitiator.*;
...
public class HandshakeTest
{
    ...
    private ServerEncryptionOptions getServerEncryptionOptions(SslFallbackConnectionType sslConnectionType, boolean optional)
    {
        ServerEncryptionOptions serverEncryptionOptions = new ServerEncryptionOptions().withOptional(optional)
                                                                                       .withKeyStore("test/conf/apippi_ssl_test.keystore")
                                                                                       .withKeyStorePassword("apippi")
                                                                                       .withOutboundKeystore("test/conf/apippi_ssl_test_outbound.keystore")
                                                                                       .withOutboundKeystorePassword("apippi")
                                                                                       .withTrustStore("test/conf/apippi_ssl_test.truststore")
                                                                                       .withTrustStorePassword("apippi")
