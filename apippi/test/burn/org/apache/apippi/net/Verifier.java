...
import org.apache.apippi.net.Verifier.ExpiredMessageEvent.ExpirationType;
import org.apache.apippi.utils.concurrent.WaitQueue;

import static java.util.concurrent.TimeUnit.*;
import static org.apache.apippi.net.MessagingService.VERSION_40;
import static org.apache.apippi.net.MessagingService.current_version;
import static org.apache.apippi.net.ConnectionType.LARGE_MESSAGES;
import static org.apache.apippi.net.OutboundConnection.LargeMessageDelivery.DEFAULT_BUFFER_SIZE;
import static org.apache.apippi.net.OutboundConnections.LARGE_MESSAGE_THRESHOLD;
import static org.apache.apippi.net.Verifier.EventCategory.OTHER;
import static org.apache.apippi.net.Verifier.EventCategory.RECEIVE;
import static org.apache.apippi.net.Verifier.EventCategory.SEND;
import static org.apache.apippi.net.Verifier.EventType.ARRIVE;
import static org.apache.apippi.net.Verifier.EventType.CLOSED_BEFORE_ARRIVAL;
import static org.apache.apippi.net.Verifier.EventType.DESERIALIZE;
import static org.apache.apippi.net.Verifier.EventType.ENQUEUE;
import static org.apache.apippi.net.Verifier.EventType.FAILED_CLOSING;
import static org.apache.apippi.net.Verifier.EventType.FAILED_DESERIALIZE;
import static org.apache.apippi.net.Verifier.EventType.FAILED_EXPIRED_ON_SEND;
import static org.apache.apippi.net.Verifier.EventType.FAILED_EXPIRED_ON_RECEIVE;
import static org.apache.apippi.net.Verifier.EventType.FAILED_FRAME;
import static org.apache.apippi.net.Verifier.EventType.FAILED_OVERLOADED;
import static org.apache.apippi.net.Verifier.EventType.FAILED_SERIALIZE;
import static org.apache.apippi.net.Verifier.EventType.FINISH_SERIALIZE_LARGE;
import static org.apache.apippi.net.Verifier.EventType.PROCESS;
import static org.apache.apippi.net.Verifier.EventType.SEND_FRAME;
import static org.apache.apippi.net.Verifier.EventType.SENT_FRAME;
import static org.apache.apippi.net.Verifier.EventType.SERIALIZE;
import static org.apache.apippi.net.Verifier.ExpiredMessageEvent.ExpirationType.ON_SENT;
...
import static org.apache.apippi.utils.concurrent.WaitQueue.newWaitQueue;
