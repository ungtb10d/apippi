...
import org.apache.apippi.net.MessageGenerator.UniformPayloadGenerator;
...
//                                        try
//                                        {
//                                            ManagementFactory.getPlatformMXBean(HotSpotDiagnosticMXBean.class).dumpHeap("/Users/belliottsmith/code/apippi/apippi/leak.hprof", true);
//                                        }
//                                        catch (IOException e)
//                                        {
...
//            forId(header.id).verifier.logFailure("Unexpected failure", failure);
    ...
    {
        // since apippi-15295, commitlog needs to be manually started.
